// Generated from ./grammars-v4/support/bnf2antlr/src/main/antlr4/com/khubla/ebnf/ebnf.g4 by ANTLR 4.7
import Antlr4
...
open class ebnfParser: Parser {
	...
	public enum Tokens: Int {
		case EOF = -1, ID = 1, ASSIGN = 2, LPAREN = 3, RPAREN = 4, LBRACE = 5, 
                 RBRACE = 6, LEND = 7, REND = 8, BAR = 9, DOT = 10, STRINGLITERAL = 11, 
                 COMMENT = 12, WS = 13
	}
	...
	open class RulelistContext:ParserRuleContext {
		open func EOF() -> TerminalNode? { return getToken(ebnfParser.Tokens.EOF.rawValue, 0) }
	...
	open func rulelist() throws -> RulelistContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == ebnfParser.Tokens.ID.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(22)
		 		try rule_()
		 	...
		 	setState(28)
		 	try match(ebnfParser.Tokens.EOF.rawValue)
	...
	open class Rule_Context:ParserRuleContext {
		...
		open func ASSIGN() -> TerminalNode? { return getToken(ebnfParser.Tokens.ASSIGN.rawValue, 0) }
		open func rhs() -> RhsContext? {
			return getRuleContext(RhsContext.self,0)
		}
		open func DOT() -> TerminalNode? { return getToken(ebnfParser.Tokens.DOT.rawValue, 0) }
	...
	open func rule_() throws -> Rule_Context {
		...
		do {
		 	...
		 	try rulename()
		 	setState(31)
		 	try match(ebnfParser.Tokens.ASSIGN.rawValue)
		 	setState(32)
		 	try rhs()
		 	setState(34)
		 	try _errHandler.sync(self)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == ebnfParser.Tokens.DOT.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(33)
		 		try match(ebnfParser.Tokens.DOT.rawValue)
	...
	open class AlternationContext:ParserRuleContext {
		...
		open func BAR() -> Array<TerminalNode> { return getTokens(ebnfParser.Tokens.BAR.rawValue) }
		open func BAR(_ i:Int) -> TerminalNode?{
			return getToken(ebnfParser.Tokens.BAR.rawValue, i)
		}
	...
	open func alternation() throws -> AlternationContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == ebnfParser.Tokens.BAR.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(44)
		 		try match(ebnfParser.Tokens.BAR.rawValue)
		 		setState(46)
		 		try _errHandler.sync(self)
	...
	open func element() throws -> ElementContext {
		...
		do {
		 	setState(58)
		 	try _errHandler.sync(self)
		 	switch (ebnfParser.Tokens(rawValue: try _input.LA(1))!) {
		 	case .REND:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(53)
		 		try optional()
	...
	open class OptionalContext:ParserRuleContext {
		open func REND() -> TerminalNode? { return getToken(ebnfParser.Tokens.REND.rawValue, 0) }
		open func LEND() -> TerminalNode? { return getToken(ebnfParser.Tokens.LEND.rawValue, 0) }
		open func alternation() -> Array<AlternationContext> {
			return getRuleContexts(AlternationContext.self)
		}
		open func alternation(_ i: Int) -> AlternationContext? {
	...
	open func optional() throws -> OptionalContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(60)
		 	try match(ebnfParser.Tokens.REND.rawValue)
		 	setState(62) 
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	repeat {
		 	 ...
		 	 { () -> Bool in
		 	   ...
		 	   let testArray: [Int] = [_la, ebnfParser.Tokens.ID.rawValue,ebnfParser.Tokens.RPAREN.rawValue,ebnfParser.Tokens.RBRACE.rawValue,ebnfParser.Tokens.REND.rawValue,ebnfParser.Tokens.STRINGLITERAL.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	      return testSet
		 	 }())
		 	setState(66)
		 	try match(ebnfParser.Tokens.LEND.rawValue)
	...
	open class ZeroormoreContext:ParserRuleContext {
		open func RBRACE() -> TerminalNode? { return getToken(ebnfParser.Tokens.RBRACE.rawValue, 0) }
		open func LBRACE() -> TerminalNode? { return getToken(ebnfParser.Tokens.LBRACE.rawValue, 0) }
		open func alternation() -> Array<AlternationContext> {
			return getRuleContexts(AlternationContext.self)
		}
		open func alternation(_ i: Int) -> AlternationContext? {
	...
	open func zeroormore() throws -> ZeroormoreContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(68)
		 	try match(ebnfParser.Tokens.RBRACE.rawValue)
		 	setState(70) 
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	repeat {
		 	...
		 	setState(74)
		 	try match(ebnfParser.Tokens.LBRACE.rawValue)
	...
	open class OneormoreContext:ParserRuleContext {
		open func RPAREN() -> TerminalNode? { return getToken(ebnfParser.Tokens.RPAREN.rawValue, 0) }
		open func LPAREN() -> TerminalNode? { return getToken(ebnfParser.Tokens.LPAREN.rawValue, 0) }
		open func alternation() -> Array<AlternationContext> {
			return getRuleContexts(AlternationContext.self)
		}
		open func alternation(_ i: Int) -> AlternationContext? {
	...
	open func oneormore() throws -> OneormoreContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(76)
		 	try match(ebnfParser.Tokens.RPAREN.rawValue)
		 	setState(78) 
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	repeat {
		 	...
		 	setState(82)
		 	try match(ebnfParser.Tokens.LPAREN.rawValue)
	...
	open class StringliteralContext:ParserRuleContext {
		open func STRINGLITERAL() -> TerminalNode? { return getToken(ebnfParser.Tokens.STRINGLITERAL.rawValue, 0) }
	...
	open func stringliteral() throws -> StringliteralContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(84)
		 	try match(ebnfParser.Tokens.STRINGLITERAL.rawValue)
	...
	open class IdContext:ParserRuleContext {
		open func ID() -> TerminalNode? { return getToken(ebnfParser.Tokens.ID.rawValue, 0) }
	...
	open func id() throws -> IdContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(86)
		 	try match(ebnfParser.Tokens.ID.rawValue)
