...
open class WavefrontOBJLexer: Lexer {
	...
	public
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, GEOMETRIC_VERTEX=6, 
            TEXTURE_VERTEX=7, VERTEX_NORMAL=8, PARAMETER_SPACE_VERTEX=9, 
            DEGREE=10, BASIS_MATRIX=11, STEP_SIZE=12, CURVE_SURF_TYPE=13, 
            POINT=14, LINE=15, FACE=16, CURVE=17, CURVE2D=18, SURF=19, PARAM=20, 
	...
	override open
	func getRuleNames() -> [String] { return WavefrontOBJLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return WavefrontOBJLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return WavefrontOBJLexer.channelNames }

	override open
	func getModeNames() -> [String] { return WavefrontOBJLexer.modeNames }

	override open
	func getATN() -> ATN { return WavefrontOBJLexer._ATN }


	public
	static let _serializedATN: String = WavefrontOBJLexerATN().jsonString
