...
open class urlParser: Parser {
	...
	public enum Tokens: Int {
		case EOF = -1, T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, 
                 T__6 = 7, T__7 = 8, T__8 = 9, HEX = 10, STRING = 11, DIGITS = 12, 
                 WS = 13
	}
	...
	open class FragmentaddressContext:ParserRuleContext {
		...
		open func WS() -> TerminalNode? { return getToken(urlParser.Tokens.WS.rawValue, 0) }
	...
	open func fragmentaddress() throws -> FragmentaddressContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == urlParser.Tokens.T__0.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(31)
	...
	open func url() throws -> UrlContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == urlParser.Tokens.T__4.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(54)
	...
	open class AuthorityContext:ParserRuleContext {
		open func STRING() -> TerminalNode? { return getToken(urlParser.Tokens.STRING.rawValue, 0) }
	...
	open class HostnameContext:ParserRuleContext {
		open func STRING() -> Array<TerminalNode> { return getTokens(urlParser.Tokens.STRING.rawValue) }
		open func STRING(_ i:Int) -> TerminalNode?{
			return getToken(urlParser.Tokens.STRING.rawValue, i)
		}
	...
	open class HostnumberContext:ParserRuleContext {
		open func DIGITS() -> Array<TerminalNode> { return getTokens(urlParser.Tokens.DIGITS.rawValue) }
	...
	open class PortContext:ParserRuleContext {
		open func DIGITS() -> TerminalNode? { return getToken(urlParser.Tokens.DIGITS.rawValue, 0) }
	...
	open class SearchparameterContext:ParserRuleContext {
		...
		open func DIGITS() -> TerminalNode? { return getToken(urlParser.Tokens.DIGITS.rawValue, 0) }
		open func HEX() -> TerminalNode? { return getToken(urlParser.Tokens.HEX.rawValue, 0) }
		 	 ...
		 	 { () -> Bool in
		 		...
		 		if (!(//closure
		 		 { () -> Bool in
		 		   ...
		 		   let testArray: [Int] = [_la, urlParser.Tokens.HEX.rawValue,urlParser.Tokens.STRING.rawValue,urlParser.Tokens.DIGITS.rawValue]
