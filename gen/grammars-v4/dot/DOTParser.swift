...
open class DOTParser: Parser {
	...
	open class GraphContext:ParserRuleContext {
		...
		open func GRAPH() -> TerminalNode? { return getToken(DOTParser.Tokens.GRAPH.rawValue, 0) }
		open func DIGRAPH() -> TerminalNode? { return getToken(DOTParser.Tokens.DIGRAPH.rawValue, 0) }
		open func STRICT() -> TerminalNode? { return getToken(DOTParser.Tokens.STRICT.rawValue, 0) }
	...
	open class Attr_stmtContext:ParserRuleContext {
		...
		open func GRAPH() -> TerminalNode? { return getToken(DOTParser.Tokens.GRAPH.rawValue, 0) }
		open func NODE() -> TerminalNode? { return getToken(DOTParser.Tokens.NODE.rawValue, 0) }
		open func EDGE() -> TerminalNode? { return getToken(DOTParser.Tokens.EDGE.rawValue, 0) }
	...
	open class SubgraphContext:ParserRuleContext {
		...
		open func SUBGRAPH() -> TerminalNode? { return getToken(DOTParser.Tokens.SUBGRAPH.rawValue, 0) }
		open func id() -> IdContext? {
			return getRuleContext(IdContext.self,0)
		}
	...
	open class IdContext:ParserRuleContext {
		open func ID() -> TerminalNode? { return getToken(DOTParser.Tokens.ID.rawValue, 0) }
		open func STRING() -> TerminalNode? { return getToken(DOTParser.Tokens.STRING.rawValue, 0) }
		open func HTML_STRING() -> TerminalNode? { return getToken(DOTParser.Tokens.HTML_STRING.rawValue, 0) }
		open func NUMBER() -> TerminalNode? { return getToken(DOTParser.Tokens.NUMBER.rawValue, 0) }
