// Generated from ./grammars-v4/java8-js/Java8.JavaScriptTarget.g4 by ANTLR 4.7.1
import Antlr4
...
open class Java8Lexer: Lexer {
	...
	override open
	func getGrammarFileName() -> String { return "Java8.JavaScriptTarget.g4" }
	...
	private func JavaLetter_sempred(_ _localctx: RuleContext!,  _ predIndex: Int) throws -> Bool {
		switch (predIndex) {
		    case 0:return Character_isJavaIdentifierStart(this._input.LA(-1))
		    case 1:return Character_isJavaIdentifierStart(Character_toCodePoint(this._input.LA(-2), this._input.LA(-1)))
		    default: return true
		}
	}
	private func JavaLetterOrDigit_sempred(_ _localctx: RuleContext!,  _ predIndex: Int) throws -> Bool {
		switch (predIndex) {
		    case 2:return Character_isJavaIdentifierPart(this._input.LA(-1))
		    case 3:return Character_isJavaIdentifierPart(Character_toCodePoint(this._input.LA(-2), this._input.LA(-1)))
		    default: return true
		}
	}
