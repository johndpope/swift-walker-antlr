...
open class pdp7Lexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__93=94, LOC=95, RELOC=96, PLUS=97, MINUS=98, TIMES=99, DIV=100, 
            LABEL=101, IDENTIFIER=102, NUMERIC_LITERAL=103, DECIMAL=104, 
            OCTAL=105, DECIMAL_MINUS=106, STRING=107, CHAR=108, COMMENT=109, 
            EOL=110, WS=111
	...
	override open
	func getRuleNames() -> [String] { return pdp7Lexer.ruleNames }

	override open
	func getSerializedATN() -> String { return pdp7Lexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return pdp7Lexer.channelNames }

	override open
	func getModeNames() -> [String] { return pdp7Lexer.modeNames }

	override open
	func getATN() -> ATN { return pdp7Lexer._ATN }


	public
	static let _serializedATN: String = pdp7LexerATN().jsonString
