// Generated from ./grammars-v4/z/ZLexer.g4 by ANTLR 4.7
import Antlr4
...
open class ZLexer: Lexer {
	...
	private static let _LITERAL_NAMES: [String?] = [
		nil, "'\u{2500}'", "'\u{250C}'", nil, nil, nil, "'\u{0028}'", "'\u{0029}'", 
		"'\u{005B}'", "'\u{005D}'", "'\u{007B}'", "'\u{007D}'", "'\u{2989}'", 
		"'\u{298A}'", "'\u{27EA}'", "'\u{27EB}'", "'\u{2577}'", "'\u{2550}'", 
		...
		nil, nil, nil, nil, nil, nil, nil, nil, nil, "'\u{2029}'"
	]
	...
	override
	open func getChannelNames() -> [String] { return ZLexer.channelNames }
