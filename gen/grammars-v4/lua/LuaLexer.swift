...
open class LuaLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__51=52, T__52=53, T__53=54, T__54=55, NAME=56, NORMALSTRING=57, 
	...
	override open
	func getRuleNames() -> [String] { return LuaLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return LuaLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return LuaLexer.channelNames }

	override open
	func getModeNames() -> [String] { return LuaLexer.modeNames }

	override open
	func getATN() -> ATN { return LuaLexer._ATN }


	public
	static let _serializedATN: String = LuaLexerATN().jsonString
