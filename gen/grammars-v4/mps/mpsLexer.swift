...
open class mpsLexer: Lexer {
	...
	public
	static let NAMEINDICATORCARD=1, ROWINDICATORCARD=2, COLUMNINDICATORCARD=3, 
            RHSINDICATORCARD=4, RANGESINDICATORCARD=5, BOUNDSINDICATORCARD=6, 
            ENDATAINDICATORCARD=7, KEYWORDMARKER=8, STARTMARKER=9, ENDMARKER=10, 
            KEYWORDFREE=11, BOUNDKEY=12, ROWTYPE=13, IDENTIFIER=14, NUMERICALVALUE=15, 
	...
	override open
	func getRuleNames() -> [String] { return mpsLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return mpsLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return mpsLexer.channelNames }

	override open
	func getModeNames() -> [String] { return mpsLexer.modeNames }

	override open
	func getATN() -> ATN { return mpsLexer._ATN }


	public
	static let _serializedATN: String = mpsLexerATN().jsonString
