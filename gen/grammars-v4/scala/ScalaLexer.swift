...
open class ScalaLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__57=58, T__58=59, T__59=60, T__60=61, BooleanLiteral=62, CharacterLiteral=63, 
            StringLiteral=64, SymbolLiteral=65, IntegerLiteral=66, FloatingPointLiteral=67, 
            Id=68, Varid=69, WS=70, Semi=71, Paren=72, Delim=73, Comment=74
	...
	override open
	func getRuleNames() -> [String] { return ScalaLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return ScalaLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return ScalaLexer.channelNames }

	override open
	func getModeNames() -> [String] { return ScalaLexer.modeNames }

	override open
	func getATN() -> ATN { return ScalaLexer._ATN }


	public
	static let _serializedATN: String = ScalaLexerATN().jsonString
