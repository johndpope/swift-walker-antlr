...
open class Swift3Parser: Parser {
	...
	enum Tokens: Int {
		case EOF = -1, T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, 
                 ...
                 T__126 = 127, T__127 = 128, T__128 = 129, Platform_name_platform_version = 130, 
                 Identifier = 131, DOT = 132, LCURLY = 133, LPAREN = 134, 
                 LBRACK = 135, RCURLY = 136, RPAREN = 137, RBRACK = 138, 
                 COMMA = 139, COLON = 140, SEMI = 141, LT = 142, GT = 143, 
                 UNDERSCORE = 144, BANG = 145, QUESTION = 146, AT = 147, 
                 AND = 148, SUB = 149, EQUAL = 150, OR = 151, DIV = 152, 
                 ADD = 153, MUL = 154, MOD = 155, CARET = 156, TILDE = 157, 
                 Operator_head_other = 158, Operator_following_character = 159, 
                 ...
                 Floating_point_literal = 166, Static_string_literal = 167, 
                 Interpolated_string_literal = 168, WS = 169, Block_comment = 170, 
                 Line_comment = 171
	}
	...
	static let RULE_top_level = 0, RULE_statement = 1, RULE_statements = 2, 
            ...
            RULE_control_transfer_statement = 29, RULE_break_statement = 30, 
            RULE_continue_statement = 31, RULE_fallthrough_statement = 32, 
            RULE_return_statement = 33, RULE_throw_statement = 34, RULE_defer_statement = 35, 
            ...
            RULE_availability_argument = 59, RULE_generic_parameter_clause = 60, 
            RULE_generic_parameter_list = 61, RULE_generic_parameter = 62, 
            RULE_generic_where_clause = 63, RULE_requirement_list = 64, 
            RULE_requirement = 65, RULE_conformance_requirement = 66, RULE_same_type_requirement = 67, 
            RULE_generic_argument_clause = 68, RULE_generic_argument_list = 69, 
            RULE_generic_argument = 70, RULE_declaration = 71, RULE_declarations = 72, 
            RULE_top_level_declaration = 73, RULE_code_block = 74, RULE_import_declaration = 75, 
            RULE_import_kind = 76, RULE_import_path = 77, RULE_import_path_identifier = 78, 
            RULE_constant_declaration = 79, RULE_pattern_initializer_list = 80, 
            RULE_pattern_initializer = 81, RULE_initializer = 82, RULE_variable_declaration = 83, 
            RULE_variable_declaration_head = 84, RULE_variable_name = 85, 
            RULE_getter_setter_block = 86, RULE_getter_clause = 87, RULE_setter_clause = 88, 
            RULE_setter_name = 89, RULE_getter_setter_keyword_block = 90, 
            RULE_getter_keyword_clause = 91, RULE_setter_keyword_clause = 92, 
            RULE_willSet_didSet_block = 93, RULE_willSet_clause = 94, RULE_didSet_clause = 95, 
            RULE_typealias_declaration = 96, RULE_typealias_name = 97, RULE_typealias_assignment = 98, 
            RULE_function_declaration = 99, RULE_function_head = 100, RULE_function_name = 101, 
            RULE_function_signature = 102, RULE_function_result = 103, RULE_function_body = 104, 
            RULE_parameter_clause = 105, RULE_parameter_list = 106, RULE_parameter = 107, 
            RULE_external_parameter_name = 108, RULE_local_parameter_name = 109, 
            RULE_default_argument_clause = 110, RULE_enum_declaration = 111, 
            RULE_union_style_enum = 112, RULE_union_style_enum_members = 113, 
            RULE_union_style_enum_member = 114, RULE_union_style_enum_case_clause = 115, 
            RULE_union_style_enum_case_list = 116, RULE_union_style_enum_case = 117, 
            RULE_enum_name = 118, RULE_enum_case_name = 119, RULE_raw_value_style_enum = 120, 
            ...
            RULE_subscript_head = 154, RULE_subscript_result = 155, RULE_operator_declaration = 156, 
            RULE_prefix_operator_declaration = 157, RULE_postfix_operator_declaration = 158, 
            RULE_infix_operator_declaration = 159, RULE_infix_operator_group = 160, 
            RULE_precedence_group_declaration = 161, RULE_precedence_group_attribute = 162, 
            RULE_precedence_group_relation = 163, RULE_precedence_group_assignment = 164, 
            RULE_precedence_group_associativity = 165, RULE_associativity = 166, 
            RULE_precedence_group_names = 167, RULE_precedence_group_name = 168, 
            RULE_declaration_modifier = 169, RULE_declaration_modifiers = 170, 
            RULE_access_level_modifier = 171, RULE_mutation_modifier = 172, 
            RULE_pattern = 173, RULE_wildcard_pattern = 174, RULE_identifier_pattern = 175, 
            RULE_value_binding_pattern = 176, RULE_tuple_pattern = 177, 
            ...
            RULE_array_literal = 201, RULE_array_literal_items = 202, RULE_array_literal_item = 203, 
            RULE_dictionary_literal = 204, RULE_dictionary_literal_items = 205, 
            RULE_dictionary_literal_item = 206, RULE_playground_literal = 207, 
            RULE_self_expression = 208, RULE_superclass_expression = 209, 
            RULE_superclass_method_expression = 210, RULE_superclass_subscript_expression = 211, 
            RULE_superclass_initializer_expression = 212, RULE_closure_expression = 213, 
            RULE_closure_signature = 214, RULE_closure_parameter_clause = 215, 
            RULE_closure_parameter_clause_identifier_list = 216, RULE_closure_parameter_list = 217, 
            RULE_closure_parameter = 218, RULE_closure_parameter_name = 219, 
            RULE_capture_list = 220, RULE_capture_list_items = 221, RULE_capture_list_item = 222, 
            ...
            RULE_tuple_element = 227, RULE_wildcard_expression = 228, RULE_selector_expression = 229, 
            RULE_key_path_expression = 230, RULE_postfix_expression = 231, 
            RULE_function_call_argument_clause = 232, RULE_function_call_argument_list = 233, 
            RULE_function_call_argument = 234, RULE_trailing_closure = 235, 
            RULE_argument_names = 236, RULE_argument_name = 237, RULE_dynamic_type_expression = 238, 
            ...
            RULE_tuple_type_element = 245, RULE_element_name = 246, RULE_function_type = 247, 
            RULE_function_type_argument_clause = 248, RULE_function_type_argument_list = 249, 
            RULE_function_type_argument = 250, RULE_argument_label = 251, 
            RULE_array_type = 252, RULE_dictionary_type = 253, RULE_protocol_composition_type = 254, 
            RULE_protocol_identifier = 255, RULE_type_inheritance_clause = 256, 
            RULE_type_inheritance_list = 257, RULE_class_requirement = 258, 
            RULE_declaration_identifier = 259, RULE_label_identifier = 260, 
            RULE_keyword_as_identifier_in_declarations = 261, RULE_keyword_as_identifier_in_labels = 262, 
            RULE_assignment_operator = 263, RULE_negate_prefix_operator = 264, 
            RULE_compilation_condition_AND = 265, RULE_compilation_condition_OR = 266, 
            RULE_compilation_condition_GE = 267, RULE_arrow_operator = 268, 
            RULE_range_operator = 269, RULE_same_type_equals = 270, RULE_binary_operator = 271, 
            RULE_prefix_operator = 272, RULE_postfix_operator = 273, RULE_operator = 274, 
            RULE_operator_character = 275, RULE_operator_head = 276, RULE_dot_operator_head = 277, 
            RULE_dot_operator_character = 278, RULE_literal = 279, RULE_numeric_literal = 280, 
            RULE_boolean_literal = 281, RULE_nil_literal = 282, RULE_integer_literal = 283, 
	...
	override open
	func getGrammarFileName() -> String { return "Swift3.g4" }

	override open
	func getRuleNames() -> [String] { return Swift3Parser.ruleNames }

	override open
	func getSerializedATN() -> String { return Swift3Parser._serializedATN }

	override open
	func getATN() -> ATN { return Swift3Parser._ATN }
	...
	public class Top_levelContext: ParserRuleContext {
			...
			func EOF() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.EOF.rawValue, 0)
			}
			open
		...
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? Swift3Listener {
		...
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? Swift3Visitor {
			    return visitor.visitTop_level(self)
			}
			else if let visitor = visitor as? Swift3BaseVisitor {
			    return visitor.visitTop_level(self)
			}
			else {
	...
	@discardableResult
	 open func top_level() throws -> Top_levelContext {
		...
		do {
		 	...
		 	setState(573)
		 	try match(Swift3Parser.Tokens.EOF.rawValue)
	 ...
	 open func statement() throws -> StatementContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		case 1:
		 			setState(576)
		 			try match(Swift3Parser.Tokens.SEMI.rawValue)
	...
	public class StatementsContext: ParserRuleContext {
			open
			func statements_impl() -> Statements_implContext? {
	...
	public class Statements_implContext: ParserRuleContext {
		open var indexBefore: Int!
		open var indexAfter: Int = -1
			open
	 ...
	 open func statements_impl(_ indexBefore: Int!) throws -> Statements_implContext {
		...
		do {
		 	...
		 	if (!(SwiftSupport.isSeparatedStatement(_input, _localctx.indexBefore))) {
		 	    throw ANTLRException.recognition(e:FailedPredicateException(self, "SwiftSupport.isSeparatedStatement(_input, $indexBefore)"))
		 	}
		 	setState(616)
		 	try statement()
	 ...
	 open func for_statement() throws -> For_statementContext {
		...
		do {
		 	...
		 	case 1:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(627)
		 		try match(Swift3Parser.Tokens.T__0.rawValue)
		 		setState(629)
		 		try _errHandler.sync(self)
		 	...
		 	case 2:
		 		...
		 		try match(Swift3Parser.Tokens.T__0.rawValue)
		 		setState(641)
		 		try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 		setState(643)
		 		try _errHandler.sync(self)
		 		...
		 		setState(653)
		 		try match(Swift3Parser.Tokens.RPAREN.rawValue)
		 		setState(654)
		 		try code_block()
	...
	@discardableResult
	 open func for_in_statement() throws -> For_in_statementContext {
		...
		do {
		 	...
		 	case 1:
		 		setState(662)
		 		try match(Swift3Parser.Tokens.T__1.rawValue)
		 	...
		 	try pattern(0)
		 	setState(666)
		 	try match(Swift3Parser.Tokens.T__2.rawValue)
		 	setState(667)
		 	try expression()
		 	setState(669)
		 	try _errHandler.sync(self)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.T__12.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(668)
		 		try where_clause()
	...
	@discardableResult
	 open func while_statement() throws -> While_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(673)
		 	try match(Swift3Parser.Tokens.T__3.rawValue)
		 	setState(674)
		 	try condition_list()
		 	setState(675)
		 	try code_block()
	...
	@discardableResult
	 open func condition_list() throws -> Condition_listContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.COMMA.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(678)
		 		try match(Swift3Parser.Tokens.COMMA.rawValue)
		 		setState(679)
		 		try condition()
	...
	@discardableResult
	 open func optional_binding_condition() throws -> Optional_binding_conditionContext {
		...
		do {
		 	setState(705)
		 	try _errHandler.sync(self)
		 	switch (Swift3Parser.Tokens(rawValue: try _input.LA(1))!) {
		 	case .T__4:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(697)
		 		try match(Swift3Parser.Tokens.T__4.rawValue)
		 		setState(698)
		 		try pattern(0)
		 		setState(699)
		 		try initializer()
		 	...
		 	case .T__5:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(701)
		 		try match(Swift3Parser.Tokens.T__5.rawValue)
		 		setState(702)
		 		try pattern(0)
		 		setState(703)
		 		try initializer()
	...
	@discardableResult
	 open func repeat_while_statement() throws -> Repeat_while_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(707)
		 	try match(Swift3Parser.Tokens.T__6.rawValue)
		 	setState(708)
		 	try code_block()
		 	setState(709)
		 	try match(Swift3Parser.Tokens.T__3.rawValue)
	...
	@discardableResult
	 open func if_statement() throws -> If_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(717)
		 	try match(Swift3Parser.Tokens.T__7.rawValue)
		 	setState(718)
		 	try condition_list()
		 	setState(719)
		 	try code_block()
	 ...
	 open func else_clause() throws -> Else_clauseContext {
		...
		do {
		 	...
		 	case 1:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(723)
		 		try match(Swift3Parser.Tokens.T__8.rawValue)
		 		setState(724)
		 		try code_block()
	...
	@discardableResult
	 open func guard_statement() throws -> Guard_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(729)
		 	try match(Swift3Parser.Tokens.T__9.rawValue)
		 	setState(730)
		 	try condition_list()
		 	setState(731)
		 	try match(Swift3Parser.Tokens.T__8.rawValue)
	...
	@discardableResult
	 open func switch_statement() throws -> Switch_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(734)
		 	try match(Swift3Parser.Tokens.T__10.rawValue)
		 	setState(735)
		 	try expression()
		 	setState(736)
		 	try match(Swift3Parser.Tokens.LCURLY.rawValue)
		 	setState(738)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.T__1.rawValue || _la == Swift3Parser.Tokens.T__11.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(737)
		 		try switch_cases()
		 	...
		 	setState(740)
		 	try match(Swift3Parser.Tokens.RCURLY.rawValue)
	...
	@discardableResult
	 open func case_label() throws -> Case_labelContext {
		...
		do {
		 	...
		 	try case_item_list()
		 	setState(756)
		 	try match(Swift3Parser.Tokens.COLON.rawValue)
	...
	@discardableResult
	 open func default_label() throws -> Default_labelContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(771)
		 	try match(Swift3Parser.Tokens.T__11.rawValue)
		 	setState(772)
		 	try match(Swift3Parser.Tokens.COLON.rawValue)
	...
	@discardableResult
	 open func where_clause() throws -> Where_clauseContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(774)
		 	try match(Swift3Parser.Tokens.T__12.rawValue)
		 	setState(775)
	...
	public class Label_nameContext: ParserRuleContext {
			open
			func declaration_identifier() -> Declaration_identifierContext? {
	...
	@discardableResult
	 open func break_statement() throws -> Break_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(805)
		 	try match(Swift3Parser.Tokens.T__13.rawValue)
		 	setState(807)
		 	try _errHandler.sync(self)
	...
	@discardableResult
	 open func continue_statement() throws -> Continue_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(809)
		 	try match(Swift3Parser.Tokens.T__14.rawValue)
		 	setState(811)
		 	try _errHandler.sync(self)
	...
	@discardableResult
	 open func fallthrough_statement() throws -> Fallthrough_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(813)
		 	try match(Swift3Parser.Tokens.T__15.rawValue)
	...
	@discardableResult
	 open func return_statement() throws -> Return_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(815)
		 	try match(Swift3Parser.Tokens.T__16.rawValue)
		 	setState(817)
		 	try _errHandler.sync(self)
	...
	@discardableResult
	 open func throw_statement() throws -> Throw_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(819)
		 	try match(Swift3Parser.Tokens.T__17.rawValue)
		 	setState(820)
		 	try expression()
	...
	@discardableResult
	 open func defer_statement() throws -> Defer_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(822)
		 	try match(Swift3Parser.Tokens.T__18.rawValue)
		 	setState(823)
		 	try code_block()
	...
	@discardableResult
	 open func do_statement() throws -> Do_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(825)
		 	try match(Swift3Parser.Tokens.T__19.rawValue)
		 	setState(826)
		 	try code_block()
		 	setState(828)
		 	try _errHandler.sync(self)
	...
	@discardableResult
	 open func catch_clause() throws -> Catch_clauseContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(834)
		 	try match(Swift3Parser.Tokens.T__20.rawValue)
		 	setState(836)
		 	try _errHandler.sync(self)
	...
	public class Compiler_control_statementContext: ParserRuleContext {
			open
			func conditional_compilation_block() -> Conditional_compilation_blockContext? {
	...
	public class Conditional_compilation_blockContext: ParserRuleContext {
			open
			func if_directive_clause() -> If_directive_clauseContext? {
				return getRuleContext(If_directive_clauseContext.self, 0)
			}
			open
			func endif_directive() -> Endif_directiveContext? {
				return getRuleContext(Endif_directiveContext.self, 0)
			}
			open
			func elseif_directive_clauses() -> Elseif_directive_clausesContext? {
				return getRuleContext(Elseif_directive_clausesContext.self, 0)
			}
			open
			func else_directive_clause() -> Else_directive_clauseContext? {
	...
	@discardableResult
	 open func conditional_compilation_block() throws -> Conditional_compilation_blockContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.T__22.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(848)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.T__23.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(851)
	...
	public class If_directive_clauseContext: ParserRuleContext {
			open
			func if_directive() -> If_directiveContext? {
				return getRuleContext(If_directiveContext.self, 0)
			}
			open
			func compilation_condition() -> Compilation_conditionContext? {
	...
	public class Elseif_directive_clausesContext: ParserRuleContext {
			open
			func elseif_directive_clause() -> [Elseif_directive_clauseContext] {
				return getRuleContexts(Elseif_directive_clauseContext.self)
			}
			open
			func elseif_directive_clause(_ i: Int) -> Elseif_directive_clauseContext? {
	...
	public class Elseif_directive_clauseContext: ParserRuleContext {
			open
			func elseif_directive() -> Elseif_directiveContext? {
	...
	public class Else_directive_clauseContext: ParserRuleContext {
			open
			func else_directive() -> Else_directiveContext? {
	...
	public class If_directiveContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
	...
	@discardableResult
	 open func if_directive() throws -> If_directiveContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(875)
		 	try match(Swift3Parser.Tokens.T__21.rawValue)
	...
	public class Elseif_directiveContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
	...
	@discardableResult
	 open func elseif_directive() throws -> Elseif_directiveContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(877)
		 	try match(Swift3Parser.Tokens.T__22.rawValue)
	...
	public class Else_directiveContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
	...
	@discardableResult
	 open func else_directive() throws -> Else_directiveContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(879)
		 	try match(Swift3Parser.Tokens.T__23.rawValue)
	...
	public class Endif_directiveContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
	...
	@discardableResult
	 open func endif_directive() throws -> Endif_directiveContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(881)
		 	try match(Swift3Parser.Tokens.T__24.rawValue)
	...
	public class Compilation_conditionContext: ParserRuleContext {
			open
			func platform_condition() -> Platform_conditionContext? {
				return getRuleContext(Platform_conditionContext.self, 0)
			}
			open
			func label_identifier() -> Label_identifierContext? {
			...
			open
			func compilation_condition(_ i: Int) -> Compilation_conditionContext? {
				return getRuleContext(Compilation_conditionContext.self, i)
			}
			open
			func compilation_condition_AND() -> Compilation_condition_ANDContext? {
				return getRuleContext(Compilation_condition_ANDContext.self, 0)
			}
			open
			func compilation_condition_OR() -> Compilation_condition_ORContext? {
	...
	private func compilation_condition(_ _p: Int) throws -> Compilation_conditionContext   {
		...
		do {
			...
			case 5:
				setState(891)
				try match(Swift3Parser.Tokens.BANG.rawValue)
				setState(892)
	...
	public class Platform_conditionContext: ParserRuleContext {
			open
			...
			open
			func compilation_condition_GE() -> Compilation_condition_GEContext? {
				return getRuleContext(Compilation_condition_GEContext.self, 0)
			}
			open
			func swift_version() -> Swift_versionContext? {
	 ...
	 open func platform_condition() throws -> Platform_conditionContext {
		...
		do {
		 	...
		 	case .T__25:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(908)
		 		try match(Swift3Parser.Tokens.T__25.rawValue)
		 		setState(909)
		 		try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 		setState(910)
		 	...
		 	case .T__26:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(913)
		 		try match(Swift3Parser.Tokens.T__26.rawValue)
		 		setState(914)
		 		try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 		setState(915)
		 		try architecture()
		 	...
		 	case .T__27:
		 		try enterOuterAlt(_localctx, 3)
		 		setState(918)
		 		try match(Swift3Parser.Tokens.T__27.rawValue)
		 		setState(919)
		 		try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 		setState(920)
	...
	public class Swift_versionContext: ParserRuleContext {
			...
			func Pure_decimal_digits() -> [TerminalNode] {
				return getTokens(Swift3Parser.Tokens.Pure_decimal_digits.rawValue)
			}
			open
			func Pure_decimal_digits(_ i:Int) -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Pure_decimal_digits.rawValue, i)
			}
		override open
		func getRuleIndex() -> Int {
	...
	@discardableResult
	 open func swift_version() throws -> Swift_versionContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(926)
		 	try match(Swift3Parser.Tokens.Pure_decimal_digits.rawValue)
		 	setState(927)
		 	try match(Swift3Parser.Tokens.DOT.rawValue)
		 	setState(928)
		 	try match(Swift3Parser.Tokens.Pure_decimal_digits.rawValue)
	 ...
	 open func line_control_statement() throws -> Line_control_statementContext {
		...
		do {
		 	...
		 	case 1:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(934)
		 		try match(Swift3Parser.Tokens.T__28.rawValue)
		 		setState(935)
		 		try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 		setState(936)
		 		try match(Swift3Parser.Tokens.T__29.rawValue)
		 		setState(937)
		 		try match(Swift3Parser.Tokens.COLON.rawValue)
		 		setState(938)
		 		try file_name()
		 		...
		 		try match(Swift3Parser.Tokens.COMMA.rawValue)
		 		setState(940)
		 		try match(Swift3Parser.Tokens.T__30.rawValue)
		 		setState(941)
		 		try match(Swift3Parser.Tokens.COLON.rawValue)
		 		setState(942)
		 		try line_number()
	...
	public class File_nameContext: ParserRuleContext {
			...
			func Static_string_literal() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Static_string_literal.rawValue, 0)
			}
		override open
		func getRuleIndex() -> Int {
	...
	@discardableResult
	 open func file_name() throws -> File_nameContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(952)
		 	try match(Swift3Parser.Tokens.Static_string_literal.rawValue)
	...
	@discardableResult
	 open func availability_condition() throws -> Availability_conditionContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(954)
		 	try match(Swift3Parser.Tokens.T__31.rawValue)
		 	setState(955)
		 	try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 	setState(956)
	...
	public class Availability_argumentContext: ParserRuleContext {
			open
			func Platform_name_platform_version() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Platform_name_platform_version.rawValue, 0)
			}
		override open
		func getRuleIndex() -> Int {
	...
	@discardableResult
	 open func availability_argument() throws -> Availability_argumentContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.Platform_name_platform_version.rawValue || _la == Swift3Parser.Tokens.MUL.rawValue
		 	      return testSet
		 	 }())) {
	...
	@discardableResult
	 open func generic_parameter_clause() throws -> Generic_parameter_clauseContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(969)
		 	try match(Swift3Parser.Tokens.LT.rawValue)
		 	setState(970)
		 	try generic_parameter_list()
		 	setState(971)
		 	try match(Swift3Parser.Tokens.GT.rawValue)
	...
	public class Generic_where_clauseContext: ParserRuleContext {
			open
	...
	public class DeclarationContext: ParserRuleContext {
			...
			open
			func precedence_group_declaration() -> Precedence_group_declarationContext? {
		...
		do {
		 	...
		 	repeat {
		 	 ...
		 	 { () -> Bool in
		 	   ...
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__4.rawValue,Swift3Parser.Tokens.T__5.rawValue,Swift3Parser.Tokens.T__32.rawValue,Swift3Parser.Tokens.T__33.rawValue,Swift3Parser.Tokens.T__34.rawValue,Swift3Parser.Tokens.T__35.rawValue,Swift3Parser.Tokens.T__36.rawValue,Swift3Parser.Tokens.T__37.rawValue,Swift3Parser.Tokens.T__38.rawValue,Swift3Parser.Tokens.T__45.rawValue,Swift3Parser.Tokens.T__46.rawValue,Swift3Parser.Tokens.T__48.rawValue,Swift3Parser.Tokens.T__49.rawValue,Swift3Parser.Tokens.T__50.rawValue,Swift3Parser.Tokens.T__51.rawValue,Swift3Parser.Tokens.T__52.rawValue,Swift3Parser.Tokens.T__54.rawValue,Swift3Parser.Tokens.T__55.rawValue,Swift3Parser.Tokens.T__56.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift3Parser.Tokens.T__64.rawValue,Swift3Parser.Tokens.T__65.rawValue,Swift3Parser.Tokens.T__66.rawValue,Swift3Parser.Tokens.T__67.rawValue,Swift3Parser.Tokens.T__68.rawValue,Swift3Parser.Tokens.T__69.rawValue,Swift3Parser.Tokens.T__70.rawValue,Swift3Parser.Tokens.T__71.rawValue,Swift3Parser.Tokens.T__74.rawValue,Swift3Parser.Tokens.T__75.rawValue,Swift3Parser.Tokens.T__76.rawValue,Swift3Parser.Tokens.T__77.rawValue,Swift3Parser.Tokens.T__78.rawValue,Swift3Parser.Tokens.T__79.rawValue,Swift3Parser.Tokens.T__80.rawValue,Swift3Parser.Tokens.T__81.rawValue]
		 	              return  Utils.testBitLeftShiftArray(testArray, 65)
		 	          }()
		 	          testSet = testSet || _la == Swift3Parser.Tokens.AT.rawValue
		 	      return testSet
		 	 }())
	...
	@discardableResult
	 open func import_declaration() throws -> Import_declarationContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.AT.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(1067)
		 		try attributes()
		 	...
		 	setState(1070)
		 	try match(Swift3Parser.Tokens.T__32.rawValue)
		 	setState(1072)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
		 	 { () -> Bool in
		 	   ...
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__5.rawValue,Swift3Parser.Tokens.T__33.rawValue,Swift3Parser.Tokens.T__34.rawValue,Swift3Parser.Tokens.T__35.rawValue,Swift3Parser.Tokens.T__36.rawValue,Swift3Parser.Tokens.T__37.rawValue,Swift3Parser.Tokens.T__38.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	      return testSet
		 	 }()) {
	...
	public class Import_pathContext: ParserRuleContext {
			...
			open
			func import_path_identifier(_ i: Int) -> Import_path_identifierContext? {
	 ...
	 open func constant_declaration() throws -> Constant_declarationContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__35.rawValue,Swift3Parser.Tokens.T__46.rawValue,Swift3Parser.Tokens.T__52.rawValue,Swift3Parser.Tokens.T__54.rawValue,Swift3Parser.Tokens.T__55.rawValue,Swift3Parser.Tokens.T__64.rawValue,Swift3Parser.Tokens.T__65.rawValue,Swift3Parser.Tokens.T__66.rawValue,Swift3Parser.Tokens.T__67.rawValue,Swift3Parser.Tokens.T__68.rawValue,Swift3Parser.Tokens.T__69.rawValue,Swift3Parser.Tokens.T__70.rawValue,Swift3Parser.Tokens.T__71.rawValue,Swift3Parser.Tokens.T__74.rawValue,Swift3Parser.Tokens.T__75.rawValue,Swift3Parser.Tokens.T__76.rawValue,Swift3Parser.Tokens.T__77.rawValue,Swift3Parser.Tokens.T__78.rawValue,Swift3Parser.Tokens.T__79.rawValue,Swift3Parser.Tokens.T__80.rawValue,Swift3Parser.Tokens.T__81.rawValue]
		...
		do {
		 	...
		 	case 1:
		 		...
		 		if (//closure
		 		 { () -> Bool in
		 		      var testSet: Bool = {  () -> Bool in
		 		   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__40.rawValue,Swift3Parser.Tokens.T__80.rawValue,Swift3Parser.Tokens.T__81.rawValue]
	...
	public class Getter_clauseContext: ParserRuleContext {
			...
			open
			func mutation_modifier() -> Mutation_modifierContext? {
	...
	@discardableResult
	 open func getter_clause() throws -> Getter_clauseContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.T__80.rawValue || _la == Swift3Parser.Tokens.T__81.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(1178)
		 	...
		 	setState(1181)
		 	try match(Swift3Parser.Tokens.T__39.rawValue)
		 	setState(1182)
		 	try code_block()
	...
	@discardableResult
	 open func setter_clause() throws -> Setter_clauseContext {
		...
		do {
		 	...
		 	setState(1190)
		 	try match(Swift3Parser.Tokens.T__40.rawValue)
		 	setState(1192)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.LPAREN.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(1191)
		 		try setter_name()
	 ...
	 open func willSet_didSet_block() throws -> WillSet_didSet_blockContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		if (//closure
		 		 { () -> Bool in
		 		      var testSet: Bool = _la == Swift3Parser.Tokens.T__42.rawValue
		 		          testSet = testSet || _la == Swift3Parser.Tokens.AT.rawValue
		 		      return testSet
		 		 }()) {
		 			setState(1232)
	...
	@discardableResult
	 open func willSet_clause() throws -> WillSet_clauseContext {
		...
		do {
		 	...
		 	setState(1247)
		 	try match(Swift3Parser.Tokens.T__41.rawValue)
		 	setState(1249)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
	...
	@discardableResult
	 open func didSet_clause() throws -> DidSet_clauseContext {
		...
		do {
		 	...
		 	setState(1256)
		 	try match(Swift3Parser.Tokens.T__42.rawValue)
		 	setState(1258)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
	 ...
	 open func typealias_declaration() throws -> Typealias_declarationContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__75.rawValue,Swift3Parser.Tokens.T__76.rawValue,Swift3Parser.Tokens.T__77.rawValue,Swift3Parser.Tokens.T__78.rawValue,Swift3Parser.Tokens.T__79.rawValue]
		 	...
		 	setState(1268)
		 	try match(Swift3Parser.Tokens.T__33.rawValue)
		 	setState(1269)
		 	try typealias_name()
		 	setState(1271)
		 	try _errHandler.sync(self)
	...
	public class Function_declarationContext: ParserRuleContext {
			...
			open
			func generic_where_clause() -> Generic_where_clauseContext? {
	...
	@discardableResult
	 open func function_declaration() throws -> Function_declarationContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.LT.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(1282)
		 		try generic_parameter_clause()
	...
	@discardableResult
	 open func function_head() throws -> Function_headContext {
		...
		do {
		 	...
		 	setState(1298)
		 	try match(Swift3Parser.Tokens.T__38.rawValue)
	 ...
	 open func function_signature() throws -> Function_signatureContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		case 1:
		 			setState(1305)
		 			try match(Swift3Parser.Tokens.T__43.rawValue)
		 	...
		 	case 2:
		 		...
		 		try parameter_clause()
		 		setState(1312)
		 		try match(Swift3Parser.Tokens.T__44.rawValue)
		 		setState(1314)
		 		try _errHandler.sync(self)
	...
	@discardableResult
	 open func union_style_enum() throws -> Union_style_enumContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.T__45.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(1388)
		 		try match(Swift3Parser.Tokens.T__45.rawValue)

		 	}

		 	setState(1391)
		 	try match(Swift3Parser.Tokens.T__36.rawValue)
		 	setState(1392)
		 	try enum_name()
		 	setState(1394)
		 	try _errHandler.sync(self)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.COLON.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(1396)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__1.rawValue,Swift3Parser.Tokens.T__4.rawValue,Swift3Parser.Tokens.T__5.rawValue,Swift3Parser.Tokens.T__21.rawValue,Swift3Parser.Tokens.T__28.rawValue,Swift3Parser.Tokens.T__32.rawValue,Swift3Parser.Tokens.T__33.rawValue,Swift3Parser.Tokens.T__34.rawValue,Swift3Parser.Tokens.T__35.rawValue,Swift3Parser.Tokens.T__36.rawValue,Swift3Parser.Tokens.T__37.rawValue,Swift3Parser.Tokens.T__38.rawValue,Swift3Parser.Tokens.T__45.rawValue,Swift3Parser.Tokens.T__46.rawValue,Swift3Parser.Tokens.T__48.rawValue,Swift3Parser.Tokens.T__49.rawValue,Swift3Parser.Tokens.T__50.rawValue,Swift3Parser.Tokens.T__51.rawValue,Swift3Parser.Tokens.T__52.rawValue,Swift3Parser.Tokens.T__54.rawValue,Swift3Parser.Tokens.T__55.rawValue,Swift3Parser.Tokens.T__56.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift3Parser.Tokens.T__64.rawValue,Swift3Parser.Tokens.T__65.rawValue,Swift3Parser.Tokens.T__66.rawValue,Swift3Parser.Tokens.T__67.rawValue,Swift3Parser.Tokens.T__68.rawValue,Swift3Parser.Tokens.T__69.rawValue,Swift3Parser.Tokens.T__70.rawValue,Swift3Parser.Tokens.T__71.rawValue,Swift3Parser.Tokens.T__74.rawValue,Swift3Parser.Tokens.T__75.rawValue,Swift3Parser.Tokens.T__76.rawValue,Swift3Parser.Tokens.T__77.rawValue,Swift3Parser.Tokens.T__78.rawValue,Swift3Parser.Tokens.T__79.rawValue,Swift3Parser.Tokens.T__80.rawValue,Swift3Parser.Tokens.T__81.rawValue]
	...
	@discardableResult
	 open func struct_declaration() throws -> Struct_declarationContext {
		...
		do {
		 	...
		 	setState(1494)
		 	try match(Swift3Parser.Tokens.T__34.rawValue)
		 	setState(1495)
		 	try struct_name()
		 	setState(1497)
		 	try _errHandler.sync(self)
	 ...
	 open func struct_body() throws -> Struct_bodyContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__4.rawValue,Swift3Parser.Tokens.T__5.rawValue,Swift3Parser.Tokens.T__21.rawValue,Swift3Parser.Tokens.T__28.rawValue,Swift3Parser.Tokens.T__32.rawValue,Swift3Parser.Tokens.T__33.rawValue,Swift3Parser.Tokens.T__34.rawValue,Swift3Parser.Tokens.T__35.rawValue,Swift3Parser.Tokens.T__36.rawValue,Swift3Parser.Tokens.T__37.rawValue,Swift3Parser.Tokens.T__38.rawValue,Swift3Parser.Tokens.T__45.rawValue,Swift3Parser.Tokens.T__46.rawValue,Swift3Parser.Tokens.T__48.rawValue,Swift3Parser.Tokens.T__49.rawValue,Swift3Parser.Tokens.T__50.rawValue,Swift3Parser.Tokens.T__51.rawValue,Swift3Parser.Tokens.T__52.rawValue,Swift3Parser.Tokens.T__54.rawValue,Swift3Parser.Tokens.T__55.rawValue,Swift3Parser.Tokens.T__56.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift3Parser.Tokens.T__64.rawValue,Swift3Parser.Tokens.T__65.rawValue,Swift3Parser.Tokens.T__66.rawValue,Swift3Parser.Tokens.T__67.rawValue,Swift3Parser.Tokens.T__68.rawValue,Swift3Parser.Tokens.T__69.rawValue,Swift3Parser.Tokens.T__70.rawValue,Swift3Parser.Tokens.T__71.rawValue,Swift3Parser.Tokens.T__74.rawValue,Swift3Parser.Tokens.T__75.rawValue,Swift3Parser.Tokens.T__76.rawValue,Swift3Parser.Tokens.T__77.rawValue,Swift3Parser.Tokens.T__78.rawValue,Swift3Parser.Tokens.T__79.rawValue,Swift3Parser.Tokens.T__80.rawValue,Swift3Parser.Tokens.T__81.rawValue]
	...
	public class Class_declarationContext: ParserRuleContext {
			...
			open
			func access_level_modifier(_ i: Int) -> Access_level_modifierContext? {
	 ...
	 open func class_declaration() throws -> Class_declarationContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		if (//closure
		 		 { () -> Bool in
		 		      let testSet: Bool = _la == Swift3Parser.Tokens.T__46.rawValue
		 		      return testSet
		 		 }()) {
		 			setState(1528)
		 			try match(Swift3Parser.Tokens.T__46.rawValue)

		 		}

		 		setState(1531)
		 		try match(Swift3Parser.Tokens.T__35.rawValue)
		 		setState(1532)
		 		try class_name()
		 		setState(1534)
		 		try _errHandler.sync(self)
	...
	public class Class_bodyContext: ParserRuleContext {
			open
			func class_member() -> [Class_memberContext] {
				return getRuleContexts(Class_memberContext.self)
			}
			open
			func class_member(_ i: Int) -> Class_memberContext? {
	...
	public class Class_memberContext: ParserRuleContext {
			open
			func declaration() -> DeclarationContext? {
				return getRuleContext(DeclarationContext.self, 0)
			}
	...
	@discardableResult
	 open func protocol_declaration() throws -> Protocol_declarationContext {
		...
		do {
		 	...
		 	setState(1590)
		 	try match(Swift3Parser.Tokens.T__37.rawValue)
		 	setState(1591)
		 	try protocol_name()
		 	setState(1593)
		 	try _errHandler.sync(self)
	...
	public class Protocol_bodyContext: ParserRuleContext {
			open
			func protocol_member() -> [Protocol_memberContext] {
				return getRuleContexts(Protocol_memberContext.self)
			}
			open
			func protocol_member(_ i: Int) -> Protocol_memberContext? {
	 ...
	 open func protocol_body() throws -> Protocol_bodyContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__5.rawValue,Swift3Parser.Tokens.T__21.rawValue,Swift3Parser.Tokens.T__28.rawValue,Swift3Parser.Tokens.T__33.rawValue,Swift3Parser.Tokens.T__35.rawValue,Swift3Parser.Tokens.T__38.rawValue,Swift3Parser.Tokens.T__46.rawValue,Swift3Parser.Tokens.T__47.rawValue,Swift3Parser.Tokens.T__48.rawValue,Swift3Parser.Tokens.T__51.rawValue,Swift3Parser.Tokens.T__52.rawValue,Swift3Parser.Tokens.T__54.rawValue,Swift3Parser.Tokens.T__55.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift3Parser.Tokens.T__64.rawValue,Swift3Parser.Tokens.T__65.rawValue,Swift3Parser.Tokens.T__66.rawValue,Swift3Parser.Tokens.T__67.rawValue,Swift3Parser.Tokens.T__68.rawValue,Swift3Parser.Tokens.T__69.rawValue,Swift3Parser.Tokens.T__70.rawValue,Swift3Parser.Tokens.T__71.rawValue,Swift3Parser.Tokens.T__74.rawValue,Swift3Parser.Tokens.T__75.rawValue,Swift3Parser.Tokens.T__76.rawValue,Swift3Parser.Tokens.T__77.rawValue,Swift3Parser.Tokens.T__78.rawValue,Swift3Parser.Tokens.T__79.rawValue,Swift3Parser.Tokens.T__80.rawValue,Swift3Parser.Tokens.T__81.rawValue]
	...
	public class Protocol_memberContext: ParserRuleContext {
			open
	 ...
	 open func protocol_initializer_declaration() throws -> Protocol_initializer_declarationContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		if (//closure
		 		 { () -> Bool in
		 		      let testSet: Bool = _la == Swift3Parser.Tokens.T__43.rawValue
		 		      return testSet
		 		 }()) {
		 			setState(1639)
		 			try match(Swift3Parser.Tokens.T__43.rawValue)
	...
	@discardableResult
	 open func protocol_associated_type_declaration() throws -> Protocol_associated_type_declarationContext {
		...
		do {
		 	...
		 	setState(1666)
		 	try match(Swift3Parser.Tokens.T__47.rawValue)
		 	setState(1667)
		 	try typealias_name()
		 	setState(1669)
		 	try _errHandler.sync(self)
	 ...
	 open func initializer_head() throws -> Initializer_headContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		setState(1706)
		 		try match(Swift3Parser.Tokens.T__48.rawValue)
		 	...
		 	case 2:
		 		...
		 		try match(Swift3Parser.Tokens.T__48.rawValue)
		 		setState(1714)
		 		try match(Swift3Parser.Tokens.QUESTION.rawValue)
	...
	@discardableResult
	 open func deinitializer_declaration() throws -> Deinitializer_declarationContext {
		...
		do {
		 	...
		 	setState(1730)
		 	try match(Swift3Parser.Tokens.T__49.rawValue)
		 	setState(1731)
		 	try code_block()
	 ...
	 open func extension_declaration() throws -> Extension_declarationContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		setState(1739)
		 		try match(Swift3Parser.Tokens.T__50.rawValue)
		 		setState(1740)
		 		try type_identifier()
		 		setState(1742)
		 		try _errHandler.sync(self)
	...
	public class Extension_bodyContext: ParserRuleContext {
			open
			func extension_member() -> [Extension_memberContext] {
				return getRuleContexts(Extension_memberContext.self)
			}
			open
			func extension_member(_ i: Int) -> Extension_memberContext? {
	...
	public class Extension_memberContext: ParserRuleContext {
			open
			func declaration() -> DeclarationContext? {
				return getRuleContext(DeclarationContext.self, 0)
			}
	...
	@discardableResult
	 open func subscript_head() throws -> Subscript_headContext {
		...
		do {
		 	...
		 	setState(1792)
		 	try match(Swift3Parser.Tokens.T__51.rawValue)
		 	setState(1793)
		 	try parameter_clause()
	...
	@discardableResult
	 open func prefix_operator_declaration() throws -> Prefix_operator_declarationContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(1806)
		 	try match(Swift3Parser.Tokens.T__52.rawValue)
		 	setState(1807)
		 	try match(Swift3Parser.Tokens.T__53.rawValue)
		 	setState(1808)
		 	try operator()
	...
	@discardableResult
	 open func postfix_operator_declaration() throws -> Postfix_operator_declarationContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(1810)
		 	try match(Swift3Parser.Tokens.T__54.rawValue)
		 	setState(1811)
		 	try match(Swift3Parser.Tokens.T__53.rawValue)
		 	setState(1812)
		 	try operator()
	...
	public class Infix_operator_declarationContext: ParserRuleContext {
			...
			open
			func infix_operator_group() -> Infix_operator_groupContext? {
	...
	@discardableResult
	 open func infix_operator_declaration() throws -> Infix_operator_declarationContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(1814)
		 	try match(Swift3Parser.Tokens.T__55.rawValue)
		 	setState(1815)
		 	try match(Swift3Parser.Tokens.T__53.rawValue)
		 	setState(1816)
		 	try operator()
	...
	public class Infix_operator_groupContext: ParserRuleContext {
			open
			func precedence_group_name() -> Precedence_group_nameContext? {
	...
	public class Precedence_group_declarationContext: ParserRuleContext {
			open
			func precedence_group_name() -> Precedence_group_nameContext? {
				return getRuleContext(Precedence_group_nameContext.self, 0)
			}
			open
			func precedence_group_attribute() -> [Precedence_group_attributeContext] {
				return getRuleContexts(Precedence_group_attributeContext.self)
			}
			open
			func precedence_group_attribute(_ i: Int) -> Precedence_group_attributeContext? {
	...
	@discardableResult
	 open func precedence_group_declaration() throws -> Precedence_group_declarationContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(1823)
		 	try match(Swift3Parser.Tokens.T__56.rawValue)
		 	setState(1824)
		 	try precedence_group_name()
		 	setState(1825)
		 	try match(Swift3Parser.Tokens.LCURLY.rawValue)
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__57.rawValue,Swift3Parser.Tokens.T__58.rawValue,Swift3Parser.Tokens.T__59.rawValue,Swift3Parser.Tokens.T__60.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	      return testSet
		 	 }()) {
	...
	public class Precedence_group_attributeContext: ParserRuleContext {
			open
			func precedence_group_relation() -> Precedence_group_relationContext? {
				return getRuleContext(Precedence_group_relationContext.self, 0)
			}
			open
			func precedence_group_assignment() -> Precedence_group_assignmentContext? {
				return getRuleContext(Precedence_group_assignmentContext.self, 0)
			}
			open
			func precedence_group_associativity() -> Precedence_group_associativityContext? {
	...
	public class Precedence_group_relationContext: ParserRuleContext {
			open
			func precedence_group_names() -> Precedence_group_namesContext? {
	 ...
	 open func precedence_group_relation() throws -> Precedence_group_relationContext {
		...
		do {
		 	...
		 	case .T__57:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(1839)
		 		try match(Swift3Parser.Tokens.T__57.rawValue)
		 		setState(1840)
		 		try match(Swift3Parser.Tokens.COLON.rawValue)
		 		setState(1841)
		 	...
		 	case .T__58:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(1842)
		 		try match(Swift3Parser.Tokens.T__58.rawValue)
		 		setState(1843)
		 		try match(Swift3Parser.Tokens.COLON.rawValue)
		 		setState(1844)
		 		try precedence_group_names()
	...
	public class Precedence_group_assignmentContext: ParserRuleContext {
			open
			func boolean_literal() -> Boolean_literalContext? {
				return getRuleContext(Boolean_literalContext.self, 0)
			}
	...
	@discardableResult
	 open func precedence_group_assignment() throws -> Precedence_group_assignmentContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(1847)
		 	try match(Swift3Parser.Tokens.T__59.rawValue)
		 	setState(1848)
		 	try match(Swift3Parser.Tokens.COLON.rawValue)
		 	setState(1849)
		 	try boolean_literal()
	...
	public class Precedence_group_associativityContext: ParserRuleContext {
			open
	...
	@discardableResult
	 open func precedence_group_associativity() throws -> Precedence_group_associativityContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(1851)
		 	try match(Swift3Parser.Tokens.T__60.rawValue)
		 	setState(1852)
		 	try match(Swift3Parser.Tokens.COLON.rawValue)
		 	setState(1853)
		 	try associativity()
	 ...
	 open func associativity() throws -> AssociativityContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__61.rawValue,Swift3Parser.Tokens.T__62.rawValue,Swift3Parser.Tokens.T__63.rawValue]
	...
	public class Precedence_group_namesContext: ParserRuleContext {
			open
			func precedence_group_name() -> [Precedence_group_nameContext] {
				return getRuleContexts(Precedence_group_nameContext.self)
			}
			open
			func precedence_group_name(_ i: Int) -> Precedence_group_nameContext? {
	...
	public class Precedence_group_nameContext: ParserRuleContext {
			open
			func declaration_identifier() -> Declaration_identifierContext? {
				return getRuleContext(Declaration_identifierContext.self, 0)
			}
	 ...
	 open func declaration_modifier() throws -> Declaration_modifierContext {
		...
		do {
		 	...
		 	case 2:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(1868)
		 		try match(Swift3Parser.Tokens.T__64.rawValue)

		 		break
		 	case 3:
		 		try enterOuterAlt(_localctx, 3)
		 		setState(1869)
		 		try match(Swift3Parser.Tokens.T__65.rawValue)
		 	...
		 	case 6:
		 		try enterOuterAlt(_localctx, 6)
		 		setState(1872)
		 		try match(Swift3Parser.Tokens.T__66.rawValue)

		 		break
		 	case 7:
		 		try enterOuterAlt(_localctx, 7)
		 		setState(1873)
		 		try match(Swift3Parser.Tokens.T__67.rawValue)

		 		break
		 	case 8:
		 		try enterOuterAlt(_localctx, 8)
		 		setState(1874)
		 		try match(Swift3Parser.Tokens.T__68.rawValue)
		 	...
		 	case 11:
		 		try enterOuterAlt(_localctx, 11)
		 		setState(1877)
		 		try match(Swift3Parser.Tokens.T__69.rawValue)

		 		break
		 	case 12:
		 		try enterOuterAlt(_localctx, 12)
		 		setState(1878)
		 		try match(Swift3Parser.Tokens.T__70.rawValue)

		 		break
		 	case 13:
		 		try enterOuterAlt(_localctx, 13)
		 		setState(1879)
		 		try match(Swift3Parser.Tokens.T__71.rawValue)
		 	...
		 	case 14:
		 		...
		 		try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 		setState(1882)
		 		try match(Swift3Parser.Tokens.T__72.rawValue)
		 		setState(1883)
		 		try match(Swift3Parser.Tokens.RPAREN.rawValue)
		 	...
		 	case 15:
		 		...
		 		try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 		setState(1886)
		 		try match(Swift3Parser.Tokens.T__73.rawValue)
		 		setState(1887)
		 		try match(Swift3Parser.Tokens.RPAREN.rawValue)
		 	...
		 	case 16:
		 		try enterOuterAlt(_localctx, 16)
		 		setState(1888)
		 		try match(Swift3Parser.Tokens.T__74.rawValue)
	...
	public class Declaration_modifiersContext: ParserRuleContext {
			...
			open
			func declaration_modifier(_ i: Int) -> Declaration_modifierContext? {
	 ...
	 open func access_level_modifier() throws -> Access_level_modifierContext {
		...
		do {
		 	...
		 	case 1:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(1898)
		 		try match(Swift3Parser.Tokens.T__75.rawValue)
		 	...
		 	case 3:
		 		try enterOuterAlt(_localctx, 3)
		 		setState(1903)
		 		try match(Swift3Parser.Tokens.T__76.rawValue)
		 	...
		 	case 5:
		 		try enterOuterAlt(_localctx, 5)
		 		setState(1908)
		 		try match(Swift3Parser.Tokens.T__77.rawValue)
		 	...
		 	case 7:
		 		try enterOuterAlt(_localctx, 7)
		 		setState(1913)
		 		try match(Swift3Parser.Tokens.T__78.rawValue)
		 	...
		 	case 9:
		 		try enterOuterAlt(_localctx, 9)
		 		setState(1918)
		 		try match(Swift3Parser.Tokens.T__79.rawValue)
	...
	public class Mutation_modifierContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
	...
	private func pattern(_ _p: Int) throws -> PatternContext   {
		...
		do {
			...
			case 7:
				setState(1943)
				try match(Swift3Parser.Tokens.T__82.rawValue)
				setState(1944)
				try type(0)
			...
			while (_alt != 2 && _alt != ATN.INVALID_ALT_NUMBER) {
				if ( _alt==1 ) {
					...
					setState(1949)
					try match(Swift3Parser.Tokens.T__83.rawValue)
					setState(1950)
					try type(0)
	...
	@discardableResult
	 open func wildcard_pattern() throws -> Wildcard_patternContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(1956)
		 	try match(Swift3Parser.Tokens.UNDERSCORE.rawValue)
	 ...
	 open func enum_case_pattern() throws -> Enum_case_patternContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__25.rawValue,Swift3Parser.Tokens.T__26.rawValue,Swift3Parser.Tokens.T__27.rawValue,Swift3Parser.Tokens.T__29.rawValue,Swift3Parser.Tokens.T__30.rawValue,Swift3Parser.Tokens.T__39.rawValue,Swift3Parser.Tokens.T__40.rawValue,Swift3Parser.Tokens.T__41.rawValue,Swift3Parser.Tokens.T__42.rawValue,Swift3Parser.Tokens.T__45.rawValue,Swift3Parser.Tokens.T__46.rawValue,Swift3Parser.Tokens.T__52.rawValue,Swift3Parser.Tokens.T__54.rawValue,Swift3Parser.Tokens.T__55.rawValue,Swift3Parser.Tokens.T__57.rawValue,Swift3Parser.Tokens.T__58.rawValue,Swift3Parser.Tokens.T__59.rawValue,Swift3Parser.Tokens.T__60.rawValue,Swift3Parser.Tokens.T__61.rawValue,Swift3Parser.Tokens.T__62.rawValue,Swift3Parser.Tokens.T__63.rawValue,Swift3Parser.Tokens.T__64.rawValue,Swift3Parser.Tokens.T__65.rawValue,Swift3Parser.Tokens.T__66.rawValue,Swift3Parser.Tokens.T__67.rawValue,Swift3Parser.Tokens.T__68.rawValue,Swift3Parser.Tokens.T__69.rawValue,Swift3Parser.Tokens.T__71.rawValue,Swift3Parser.Tokens.T__72.rawValue,Swift3Parser.Tokens.T__73.rawValue,Swift3Parser.Tokens.T__74.rawValue,Swift3Parser.Tokens.T__79.rawValue,Swift3Parser.Tokens.T__80.rawValue,Swift3Parser.Tokens.T__81.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 26)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift3Parser.Tokens.T__93.rawValue,Swift3Parser.Tokens.T__94.rawValue,Swift3Parser.Tokens.T__95.rawValue,Swift3Parser.Tokens.T__96.rawValue,Swift3Parser.Tokens.T__98.rawValue,Swift3Parser.Tokens.T__109.rawValue,Swift3Parser.Tokens.T__110.rawValue,Swift3Parser.Tokens.T__111.rawValue,Swift3Parser.Tokens.T__112.rawValue,Swift3Parser.Tokens.T__115.rawValue,Swift3Parser.Tokens.T__116.rawValue,Swift3Parser.Tokens.T__117.rawValue,Swift3Parser.Tokens.T__118.rawValue,Swift3Parser.Tokens.T__119.rawValue,Swift3Parser.Tokens.T__120.rawValue,Swift3Parser.Tokens.T__121.rawValue,Swift3Parser.Tokens.T__122.rawValue,Swift3Parser.Tokens.T__123.rawValue,Swift3Parser.Tokens.T__124.rawValue,Swift3Parser.Tokens.T__125.rawValue,Swift3Parser.Tokens.Identifier.rawValue]
	...
	@discardableResult
	 open func attribute() throws -> AttributeContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(1995)
		 	try match(Swift3Parser.Tokens.AT.rawValue)
		 	setState(1996)
		 	try attribute_name()
		 	setState(1998)
		 	try _errHandler.sync(self)
	...
	public class Balanced_tokenContext: ParserRuleContext {
			...
			open
			func any_punctuation_for_balanced_token() -> Any_punctuation_for_balanced_tokenContext? {
	 ...
	 open func balanced_token() throws -> Balanced_tokenContext {
		...
		do {
		 	...
		 	case 2:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(2021)
		 		try match(Swift3Parser.Tokens.LBRACK.rawValue)
		 		setState(2022)
		 		try balanced_tokens()
		 		setState(2023)
		 		try match(Swift3Parser.Tokens.RBRACK.rawValue)
		 	...
		 	case 7:
		 		try enterOuterAlt(_localctx, 7)
		 		setState(2032)
		 		try match(Swift3Parser.Tokens.Platform_name_platform_version.rawValue)
	...
	public class Any_punctuation_for_balanced_tokenContext: ParserRuleContext {
			open
			func arrow_operator() -> Arrow_operatorContext? {
				return getRuleContext(Arrow_operatorContext.self, 0)
			}
		...
		do {
		 	...
		 	case 1:
		 		...
		 		if (!(//closure
		 		 { () -> Bool in
		 		      var testSet: Bool = {  () -> Bool in
		 		   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__84.rawValue,Swift3Parser.Tokens.T__85.rawValue,Swift3Parser.Tokens.DOT.rawValue,Swift3Parser.Tokens.COMMA.rawValue,Swift3Parser.Tokens.COLON.rawValue,Swift3Parser.Tokens.SEMI.rawValue,Swift3Parser.Tokens.QUESTION.rawValue,Swift3Parser.Tokens.AT.rawValue]
		 		    return  Utils.testBitLeftShiftArray(testArray, 85)
		 		}()
		 		          testSet = testSet || _la == Swift3Parser.Tokens.EQUAL.rawValue
		 		      return testSet
		 		 }())) {
		 		try _errHandler.recoverInline(self)
		 		}
		 	...
		 	case 3:
		 		...
		 		setState(2039)
		 		try match(Swift3Parser.Tokens.AND.rawValue)
	 ...
	 open func try_operator() throws -> Try_operatorContext {
		...
		do {
		 	...
		 	case 1:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(2069)
		 		try match(Swift3Parser.Tokens.T__86.rawValue)
		 		setState(2070)
		 		try match(Swift3Parser.Tokens.QUESTION.rawValue)
	...
	public class Primary_expressionContext: ParserRuleContext {
			...
			open
			func tuple_expression() -> Tuple_expressionContext? {
			...
			open
			func key_path_expression() -> Key_path_expressionContext? {
	 ...
	 open func literal_expression() throws -> Literal_expressionContext {
		...
		do {
		 	...
		 	case 4:
		 		try enterOuterAlt(_localctx, 4)
		 		setState(2137)
		 		try match(Swift3Parser.Tokens.T__87.rawValue)

		 		break
		 	case 5:
		 		try enterOuterAlt(_localctx, 5)
		 		setState(2138)
		 		try match(Swift3Parser.Tokens.T__88.rawValue)

		 		break
		 	case 6:
		 		try enterOuterAlt(_localctx, 6)
		 		setState(2139)
		 		try match(Swift3Parser.Tokens.T__89.rawValue)

		 		break
		 	case 7:
		 		try enterOuterAlt(_localctx, 7)
		 		setState(2140)
		 		try match(Swift3Parser.Tokens.T__90.rawValue)

		 		break
		 	case 8:
		 		try enterOuterAlt(_localctx, 8)
		 		setState(2141)
		 		try match(Swift3Parser.Tokens.T__91.rawValue)
	...
	public class Playground_literalContext: ParserRuleContext {
			open
			func expression() -> [ExpressionContext] {
				return getRuleContexts(ExpressionContext.self)
			}
	 ...
	 open func playground_literal() throws -> Playground_literalContext {
		...
		do {
		 	...
		 	case .T__92:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(2185)
		 		try match(Swift3Parser.Tokens.T__92.rawValue)
		 		setState(2186)
		 		try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 		setState(2187)
		 		try match(Swift3Parser.Tokens.T__93.rawValue)
		 		setState(2188)
		 		try match(Swift3Parser.Tokens.COLON.rawValue)
		 		setState(2189)
		 		try expression()
		 		...
		 		try match(Swift3Parser.Tokens.COMMA.rawValue)
		 		setState(2191)
		 		try match(Swift3Parser.Tokens.T__94.rawValue)
		 		setState(2192)
		 		try match(Swift3Parser.Tokens.COLON.rawValue)
		 		setState(2193)
		 		try expression()
		 		...
		 		try match(Swift3Parser.Tokens.COMMA.rawValue)
		 		setState(2195)
		 		try match(Swift3Parser.Tokens.T__95.rawValue)
		 		setState(2196)
		 		try match(Swift3Parser.Tokens.COLON.rawValue)
		 		setState(2197)
		 		try expression()
		 		...
		 		try match(Swift3Parser.Tokens.COMMA.rawValue)
		 		setState(2199)
		 		try match(Swift3Parser.Tokens.T__96.rawValue)
		 		setState(2200)
		 		try match(Swift3Parser.Tokens.COLON.rawValue)
		 		setState(2201)
		 		try expression()
		 	...
		 	case .T__97:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(2204)
		 		try match(Swift3Parser.Tokens.T__97.rawValue)
		 		setState(2205)
		 		try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 		setState(2206)
		 		try match(Swift3Parser.Tokens.T__98.rawValue)
		 		setState(2207)
		 		try match(Swift3Parser.Tokens.COLON.rawValue)
		 		setState(2208)
		 		try expression()
		 	...
		 	case .T__99:
		 		try enterOuterAlt(_localctx, 3)
		 		setState(2211)
		 		try match(Swift3Parser.Tokens.T__99.rawValue)
		 		setState(2212)
		 		try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 		setState(2213)
		 		try match(Swift3Parser.Tokens.T__98.rawValue)
	 ...
	 open func self_expression() throws -> Self_expressionContext {
		...
		do {
		 	...
		 	case 1:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(2220)
		 		try match(Swift3Parser.Tokens.T__100.rawValue)
		 	...
		 	case 5:
		 		try enterOuterAlt(_localctx, 5)
		 		setState(2232)
		 		try match(Swift3Parser.Tokens.T__101.rawValue)
	...
	@discardableResult
	 open func superclass_method_expression() throws -> Superclass_method_expressionContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(2246)
		 	try match(Swift3Parser.Tokens.T__102.rawValue)
		 	setState(2247)
		 	try match(Swift3Parser.Tokens.DOT.rawValue)
		 	setState(2248)
		 	try declaration_identifier()
	...
	public class Closure_signatureContext: ParserRuleContext {
			open
			func closure_parameter_clause() -> Closure_parameter_clauseContext? {
	 ...
	 open func closure_signature() throws -> Closure_signatureContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		if (//closure
		 		 { () -> Bool in
		 		      let testSet: Bool = _la == Swift3Parser.Tokens.LBRACK.rawValue
		 		      return testSet
		 		 }()) {
		 			setState(2268)
		 			try capture_list()
	...
	public class Closure_parameter_clauseContext: ParserRuleContext {
			open
			func closure_parameter_list() -> Closure_parameter_listContext? {
				return getRuleContext(Closure_parameter_listContext.self, 0)
			}
			open
			func closure_parameter_clause_identifier_list() -> Closure_parameter_clause_identifier_listContext? {
	...
	public class Closure_parameter_clause_identifier_listContext: ParserRuleContext {
			open
			func declaration_identifier() -> [Declaration_identifierContext] {
				return getRuleContexts(Declaration_identifierContext.self)
			}
			open
			func declaration_identifier(_ i: Int) -> Declaration_identifierContext? {
	...
	public class Closure_parameter_listContext: ParserRuleContext {
			open
			func closure_parameter() -> [Closure_parameterContext] {
				return getRuleContexts(Closure_parameterContext.self)
			}
			open
			func closure_parameter(_ i: Int) -> Closure_parameterContext? {
	...
	public class Closure_parameterContext: ParserRuleContext {
			open
			func closure_parameter_name() -> Closure_parameter_nameContext? {
	...
	public class Closure_parameter_nameContext: ParserRuleContext {
			open
			func label_identifier() -> Label_identifierContext? {
				return getRuleContext(Label_identifierContext.self, 0)
			}
	 ...
	 open func capture_specifier() throws -> Capture_specifierContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__71.rawValue,Swift3Parser.Tokens.T__74.rawValue,Swift3Parser.Tokens.T__103.rawValue,Swift3Parser.Tokens.T__104.rawValue]
	...
	public class Tuple_expressionContext: ParserRuleContext {
			open
			func tuple_element() -> [Tuple_elementContext] {
				return getRuleContexts(Tuple_elementContext.self)
			}
			open
			func tuple_element(_ i: Int) -> Tuple_elementContext? {
	...
	public class Tuple_elementContext: ParserRuleContext {
			open
			func expression() -> ExpressionContext? {
				return getRuleContext(ExpressionContext.self, 0)
			}
	 ...
	 open func selector_expression() throws -> Selector_expressionContext {
		...
		do {
		 	...
		 	case 1:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(2371)
		 		try match(Swift3Parser.Tokens.T__105.rawValue)
		 		setState(2372)
		 		try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 		setState(2373)
		 		try expression()
		 	...
		 	case 2:
		 		...
		 		try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 		setState(2378)
		 		try match(Swift3Parser.Tokens.T__106.rawValue)
		 		setState(2379)
		 		try expression()
		 		setState(2380)
		 		try match(Swift3Parser.Tokens.RPAREN.rawValue)
		 	...
		 	case 3:
		 		...
		 		try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 		setState(2384)
		 		try match(Swift3Parser.Tokens.T__107.rawValue)
		 		setState(2385)
		 		try expression()
		 		setState(2386)
		 		try match(Swift3Parser.Tokens.RPAREN.rawValue)
	...
	public class Key_path_expressionContext: ParserRuleContext {
			open
			func expression() -> ExpressionContext? {
				return getRuleContext(ExpressionContext.self, 0)
			}
	...
	@discardableResult
	 open func key_path_expression() throws -> Key_path_expressionContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(2390)
		 	try match(Swift3Parser.Tokens.T__108.rawValue)
		 	setState(2391)
		 	try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 	setState(2392)
		 	try expression()
	...
	public class Function_call_expression_with_closureContext: Postfix_expressionContext {
			open
			func postfix_expression() -> Postfix_expressionContext? {
				return getRuleContext(Postfix_expressionContext.self, 0)
			}
			...
			open
			func function_call_argument_clause() -> Function_call_argument_clauseContext? {
	...
	public class Explicit_member_expression1Context: Postfix_expressionContext {
			...
			open
			func Pure_decimal_digits() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Pure_decimal_digits.rawValue, 0)
			}
	...
	public class Dynamic_typeContext: Postfix_expressionContext {
			open
			func dynamic_type_expression() -> Dynamic_type_expressionContext? {
	...
	public class Function_call_argument_clauseContext: ParserRuleContext {
			open
			func function_call_argument_list() -> Function_call_argument_listContext? {
	...
	public class Function_call_argument_listContext: ParserRuleContext {
			open
			func function_call_argument() -> [Function_call_argumentContext] {
				return getRuleContexts(Function_call_argumentContext.self)
			}
			open
			func function_call_argument(_ i: Int) -> Function_call_argumentContext? {
	...
	public class Function_call_argumentContext: ParserRuleContext {
			open
			func expression() -> ExpressionContext? {
				return getRuleContext(ExpressionContext.self, 0)
			}
	...
	public class Argument_namesContext: ParserRuleContext {
			...
			open
			func argument_name(_ i: Int) -> Argument_nameContext? {
	 ...
	 open func argument_names() throws -> Argument_namesContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__0.rawValue,Swift3Parser.Tokens.T__1.rawValue,Swift3Parser.Tokens.T__2.rawValue,Swift3Parser.Tokens.T__3.rawValue,Swift3Parser.Tokens.T__6.rawValue,Swift3Parser.Tokens.T__7.rawValue,Swift3Parser.Tokens.T__8.rawValue,Swift3Parser.Tokens.T__9.rawValue,Swift3Parser.Tokens.T__10.rawValue,Swift3Parser.Tokens.T__11.rawValue,Swift3Parser.Tokens.T__12.rawValue,Swift3Parser.Tokens.T__13.rawValue,Swift3Parser.Tokens.T__14.rawValue,Swift3Parser.Tokens.T__15.rawValue,Swift3Parser.Tokens.T__16.rawValue,Swift3Parser.Tokens.T__17.rawValue,Swift3Parser.Tokens.T__18.rawValue,Swift3Parser.Tokens.T__19.rawValue,Swift3Parser.Tokens.T__20.rawValue,Swift3Parser.Tokens.T__25.rawValue,Swift3Parser.Tokens.T__26.rawValue,Swift3Parser.Tokens.T__27.rawValue,Swift3Parser.Tokens.T__29.rawValue,Swift3Parser.Tokens.T__30.rawValue,Swift3Parser.Tokens.T__32.rawValue,Swift3Parser.Tokens.T__33.rawValue,Swift3Parser.Tokens.T__34.rawValue,Swift3Parser.Tokens.T__35.rawValue,Swift3Parser.Tokens.T__36.rawValue,Swift3Parser.Tokens.T__37.rawValue,Swift3Parser.Tokens.T__38.rawValue,Swift3Parser.Tokens.T__39.rawValue,Swift3Parser.Tokens.T__40.rawValue,Swift3Parser.Tokens.T__41.rawValue,Swift3Parser.Tokens.T__42.rawValue,Swift3Parser.Tokens.T__43.rawValue,Swift3Parser.Tokens.T__44.rawValue,Swift3Parser.Tokens.T__45.rawValue,Swift3Parser.Tokens.T__46.rawValue,Swift3Parser.Tokens.T__47.rawValue,Swift3Parser.Tokens.T__48.rawValue,Swift3Parser.Tokens.T__49.rawValue,Swift3Parser.Tokens.T__50.rawValue,Swift3Parser.Tokens.T__51.rawValue,Swift3Parser.Tokens.T__52.rawValue,Swift3Parser.Tokens.T__53.rawValue,Swift3Parser.Tokens.T__54.rawValue,Swift3Parser.Tokens.T__55.rawValue,Swift3Parser.Tokens.T__56.rawValue,Swift3Parser.Tokens.T__57.rawValue,Swift3Parser.Tokens.T__58.rawValue,Swift3Parser.Tokens.T__59.rawValue,Swift3Parser.Tokens.T__60.rawValue,Swift3Parser.Tokens.T__61.rawValue,Swift3Parser.Tokens.T__62.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift3Parser.Tokens.T__63.rawValue,Swift3Parser.Tokens.T__64.rawValue,Swift3Parser.Tokens.T__65.rawValue,Swift3Parser.Tokens.T__66.rawValue,Swift3Parser.Tokens.T__67.rawValue,Swift3Parser.Tokens.T__68.rawValue,Swift3Parser.Tokens.T__69.rawValue,Swift3Parser.Tokens.T__70.rawValue,Swift3Parser.Tokens.T__71.rawValue,Swift3Parser.Tokens.T__72.rawValue,Swift3Parser.Tokens.T__73.rawValue,Swift3Parser.Tokens.T__74.rawValue,Swift3Parser.Tokens.T__75.rawValue,Swift3Parser.Tokens.T__76.rawValue,Swift3Parser.Tokens.T__77.rawValue,Swift3Parser.Tokens.T__78.rawValue,Swift3Parser.Tokens.T__79.rawValue,Swift3Parser.Tokens.T__80.rawValue,Swift3Parser.Tokens.T__81.rawValue,Swift3Parser.Tokens.T__82.rawValue,Swift3Parser.Tokens.T__83.rawValue,Swift3Parser.Tokens.T__86.rawValue,Swift3Parser.Tokens.T__93.rawValue,Swift3Parser.Tokens.T__94.rawValue,Swift3Parser.Tokens.T__95.rawValue,Swift3Parser.Tokens.T__96.rawValue,Swift3Parser.Tokens.T__98.rawValue,Swift3Parser.Tokens.T__100.rawValue,Swift3Parser.Tokens.T__101.rawValue,Swift3Parser.Tokens.T__102.rawValue,Swift3Parser.Tokens.T__109.rawValue,Swift3Parser.Tokens.T__110.rawValue,Swift3Parser.Tokens.T__111.rawValue,Swift3Parser.Tokens.T__112.rawValue,Swift3Parser.Tokens.T__113.rawValue,Swift3Parser.Tokens.T__115.rawValue,Swift3Parser.Tokens.T__116.rawValue,Swift3Parser.Tokens.T__117.rawValue,Swift3Parser.Tokens.T__118.rawValue,Swift3Parser.Tokens.T__119.rawValue,Swift3Parser.Tokens.T__120.rawValue,Swift3Parser.Tokens.T__121.rawValue,Swift3Parser.Tokens.T__122.rawValue,Swift3Parser.Tokens.T__123.rawValue,Swift3Parser.Tokens.T__124.rawValue,Swift3Parser.Tokens.T__125.rawValue,Swift3Parser.Tokens.T__126.rawValue]
		 	              return  Utils.testBitLeftShiftArray(testArray, 64)
		 	          }()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift3Parser.Tokens.T__127.rawValue,Swift3Parser.Tokens.T__128.rawValue,Swift3Parser.Tokens.Identifier.rawValue]
	...
	public class Dynamic_type_expressionContext: ParserRuleContext {
			open
			func expression() -> ExpressionContext? {
				return getRuleContext(ExpressionContext.self, 0)
			}
	...
	@discardableResult
	 open func dynamic_type_expression() throws -> Dynamic_type_expressionContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(2493)
		 	try match(Swift3Parser.Tokens.T__109.rawValue)
		 	setState(2494)
		 	try match(Swift3Parser.Tokens.LPAREN.rawValue)
		 	setState(2495)
		 	try match(Swift3Parser.Tokens.T__110.rawValue)
		 	setState(2496)
		 	try match(Swift3Parser.Tokens.COLON.rawValue)
		 	setState(2497)
		 	try expression()
	...
	public class TypeContext: ParserRuleContext {
		...
		open
		func copyFrom(_ ctx: TypeContext) {
			super.copyFrom(ctx)
		}
	}
	public class The_metatype_protocol_typeContext: TypeContext {
			open
			func type() -> TypeContext? {
				return getRuleContext(TypeContext.self, 0)
			}
	...
	public class The_function_typeContext: TypeContext {
			open
			func function_type() -> Function_typeContext? {
	...
	public class The_implicitly_unwrapped_optional_typeContext: TypeContext {
			open
			func type() -> TypeContext? {
				return getRuleContext(TypeContext.self, 0)
			}
	...
	public class The_dictionary_typeContext: TypeContext {
			open
			func dictionary_type() -> Dictionary_typeContext? {
	...
	public class The_optional_typeContext: TypeContext {
			open
			func type() -> TypeContext? {
				return getRuleContext(TypeContext.self, 0)
			}
	...
	public class The_tuple_typeContext: TypeContext {
			open
			func tuple_type() -> Tuple_typeContext? {
				return getRuleContext(Tuple_typeContext.self, 0)
			}
	...
	public class The_self_typeContext: TypeContext {
	...
	public class The_array_typeContext: TypeContext {
			open
	...
	public class The_metatype_type_typeContext: TypeContext {
			open
			func type() -> TypeContext? {
				return getRuleContext(TypeContext.self, 0)
			}
	...
	public class The_protocol_composition_typeContext: TypeContext {
			open
			func protocol_composition_type() -> Protocol_composition_typeContext? {
				return getRuleContext(Protocol_composition_typeContext.self, 0)
			}
	...
	public class The_any_typeContext: TypeContext {
	...
	public class The_type_identifierContext: TypeContext {
			open
			func type_identifier() -> Type_identifierContext? {
				return getRuleContext(Type_identifierContext.self, 0)
			}
	...
	private func type(_ _p: Int) throws -> TypeContext   {
		...
		do {
			...
			case 7:
				...
				_prevctx = _localctx
				setState(2507)
				try match(Swift3Parser.Tokens.T__113.rawValue)
			...
			while (_alt != 2 && _alt != ATN.INVALID_ALT_NUMBER) {
				if ( _alt==1 ) {
					...
					case 3:
						...
						try match(Swift3Parser.Tokens.DOT.rawValue)
						setState(2517)
						try match(Swift3Parser.Tokens.T__111.rawValue)
					...
					case 4:
						...
						try match(Swift3Parser.Tokens.DOT.rawValue)
						setState(2520)
						try match(Swift3Parser.Tokens.T__112.rawValue)
	...
	@discardableResult
	 open func type_annotation() throws -> Type_annotationContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.T__114.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(2530)
		 		try match(Swift3Parser.Tokens.T__114.rawValue)
		 	 ...
		 	 { () -> Bool in
		 	   ...
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__0.rawValue,Swift3Parser.Tokens.T__1.rawValue,Swift3Parser.Tokens.T__2.rawValue,Swift3Parser.Tokens.T__3.rawValue,Swift3Parser.Tokens.T__6.rawValue,Swift3Parser.Tokens.T__7.rawValue,Swift3Parser.Tokens.T__8.rawValue,Swift3Parser.Tokens.T__9.rawValue,Swift3Parser.Tokens.T__10.rawValue,Swift3Parser.Tokens.T__11.rawValue,Swift3Parser.Tokens.T__12.rawValue,Swift3Parser.Tokens.T__13.rawValue,Swift3Parser.Tokens.T__14.rawValue,Swift3Parser.Tokens.T__15.rawValue,Swift3Parser.Tokens.T__16.rawValue,Swift3Parser.Tokens.T__17.rawValue,Swift3Parser.Tokens.T__18.rawValue,Swift3Parser.Tokens.T__19.rawValue,Swift3Parser.Tokens.T__20.rawValue,Swift3Parser.Tokens.T__25.rawValue,Swift3Parser.Tokens.T__26.rawValue,Swift3Parser.Tokens.T__27.rawValue,Swift3Parser.Tokens.T__29.rawValue,Swift3Parser.Tokens.T__30.rawValue,Swift3Parser.Tokens.T__32.rawValue,Swift3Parser.Tokens.T__33.rawValue,Swift3Parser.Tokens.T__34.rawValue,Swift3Parser.Tokens.T__35.rawValue,Swift3Parser.Tokens.T__36.rawValue,Swift3Parser.Tokens.T__37.rawValue,Swift3Parser.Tokens.T__38.rawValue,Swift3Parser.Tokens.T__39.rawValue,Swift3Parser.Tokens.T__40.rawValue,Swift3Parser.Tokens.T__41.rawValue,Swift3Parser.Tokens.T__42.rawValue,Swift3Parser.Tokens.T__43.rawValue,Swift3Parser.Tokens.T__44.rawValue,Swift3Parser.Tokens.T__45.rawValue,Swift3Parser.Tokens.T__46.rawValue,Swift3Parser.Tokens.T__47.rawValue,Swift3Parser.Tokens.T__48.rawValue,Swift3Parser.Tokens.T__49.rawValue,Swift3Parser.Tokens.T__50.rawValue,Swift3Parser.Tokens.T__51.rawValue,Swift3Parser.Tokens.T__52.rawValue,Swift3Parser.Tokens.T__53.rawValue,Swift3Parser.Tokens.T__54.rawValue,Swift3Parser.Tokens.T__55.rawValue,Swift3Parser.Tokens.T__56.rawValue,Swift3Parser.Tokens.T__57.rawValue,Swift3Parser.Tokens.T__58.rawValue,Swift3Parser.Tokens.T__59.rawValue,Swift3Parser.Tokens.T__60.rawValue,Swift3Parser.Tokens.T__61.rawValue,Swift3Parser.Tokens.T__62.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	          ...
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift3Parser.Tokens.T__127.rawValue,Swift3Parser.Tokens.T__128.rawValue,Swift3Parser.Tokens.Identifier.rawValue,Swift3Parser.Tokens.LPAREN.rawValue,Swift3Parser.Tokens.LBRACK.rawValue,Swift3Parser.Tokens.AT.rawValue]
		 	              return  Utils.testBitLeftShiftArray(testArray, 128)
		 	          }()
		 	      return testSet
		 	 }()) {
	...
	public class Function_typeContext: ParserRuleContext {
			open
			func function_type_argument_clause() -> Function_type_argument_clauseContext? {
	...
	public class Function_type_argument_clauseContext: ParserRuleContext {
			open
			func function_type_argument_list() -> Function_type_argument_listContext? {
	...
	public class Function_type_argument_listContext: ParserRuleContext {
			open
			func function_type_argument() -> Function_type_argumentContext? {
	...
	public class Function_type_argumentContext: ParserRuleContext {
			open
			func type() -> TypeContext? {
				return getRuleContext(TypeContext.self, 0)
			}
			...
			open
			func argument_label() -> Argument_labelContext? {
	...
	public class Argument_labelContext: ParserRuleContext {
			open
			func label_identifier() -> Label_identifierContext? {
				return getRuleContext(Label_identifierContext.self, 0)
			}
	...
	public class Dictionary_typeContext: ParserRuleContext {
			open
			func type() -> [TypeContext] {
	...
	public class Declaration_identifierContext: ParserRuleContext {
			open
			func Identifier() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Identifier.rawValue, 0)
			}
			open
			func keyword_as_identifier_in_declarations() -> Keyword_as_identifier_in_declarationsContext? {
	 ...
	 open func declaration_identifier() throws -> Declaration_identifierContext {
		...
		do {
		 	...
		 	case .Identifier:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(2657)
		 		try match(Swift3Parser.Tokens.Identifier.rawValue)
	...
	public class Label_identifierContext: ParserRuleContext {
			open
			func Identifier() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Identifier.rawValue, 0)
			}
			open
			func keyword_as_identifier_in_labels() -> Keyword_as_identifier_in_labelsContext? {
	...
	public class Keyword_as_identifier_in_declarationsContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
	 ...
	 open func keyword_as_identifier_in_declarations() throws -> Keyword_as_identifier_in_declarationsContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__25.rawValue,Swift3Parser.Tokens.T__26.rawValue,Swift3Parser.Tokens.T__27.rawValue,Swift3Parser.Tokens.T__29.rawValue,Swift3Parser.Tokens.T__30.rawValue,Swift3Parser.Tokens.T__39.rawValue,Swift3Parser.Tokens.T__40.rawValue,Swift3Parser.Tokens.T__41.rawValue,Swift3Parser.Tokens.T__42.rawValue,Swift3Parser.Tokens.T__45.rawValue,Swift3Parser.Tokens.T__46.rawValue,Swift3Parser.Tokens.T__52.rawValue,Swift3Parser.Tokens.T__54.rawValue,Swift3Parser.Tokens.T__55.rawValue,Swift3Parser.Tokens.T__57.rawValue,Swift3Parser.Tokens.T__58.rawValue,Swift3Parser.Tokens.T__59.rawValue,Swift3Parser.Tokens.T__60.rawValue,Swift3Parser.Tokens.T__61.rawValue,Swift3Parser.Tokens.T__62.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift3Parser.Tokens.T__63.rawValue,Swift3Parser.Tokens.T__64.rawValue,Swift3Parser.Tokens.T__65.rawValue,Swift3Parser.Tokens.T__66.rawValue,Swift3Parser.Tokens.T__67.rawValue,Swift3Parser.Tokens.T__68.rawValue,Swift3Parser.Tokens.T__69.rawValue,Swift3Parser.Tokens.T__71.rawValue,Swift3Parser.Tokens.T__72.rawValue,Swift3Parser.Tokens.T__73.rawValue,Swift3Parser.Tokens.T__74.rawValue,Swift3Parser.Tokens.T__79.rawValue,Swift3Parser.Tokens.T__80.rawValue,Swift3Parser.Tokens.T__81.rawValue,Swift3Parser.Tokens.T__93.rawValue,Swift3Parser.Tokens.T__94.rawValue,Swift3Parser.Tokens.T__95.rawValue,Swift3Parser.Tokens.T__96.rawValue,Swift3Parser.Tokens.T__98.rawValue,Swift3Parser.Tokens.T__109.rawValue,Swift3Parser.Tokens.T__110.rawValue,Swift3Parser.Tokens.T__111.rawValue,Swift3Parser.Tokens.T__112.rawValue,Swift3Parser.Tokens.T__115.rawValue,Swift3Parser.Tokens.T__116.rawValue,Swift3Parser.Tokens.T__117.rawValue,Swift3Parser.Tokens.T__118.rawValue,Swift3Parser.Tokens.T__119.rawValue,Swift3Parser.Tokens.T__120.rawValue,Swift3Parser.Tokens.T__121.rawValue,Swift3Parser.Tokens.T__122.rawValue,Swift3Parser.Tokens.T__123.rawValue,Swift3Parser.Tokens.T__124.rawValue,Swift3Parser.Tokens.T__125.rawValue]
		 	              return  Utils.testBitLeftShiftArray(testArray, 64)
		 	          }()
		 	      return testSet
		 	 }())) {
	...
	public class Keyword_as_identifier_in_labelsContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
		 	 ...
		 	 { () -> Bool in
		 	   ...
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.T__0.rawValue,Swift3Parser.Tokens.T__1.rawValue,Swift3Parser.Tokens.T__2.rawValue,Swift3Parser.Tokens.T__3.rawValue,Swift3Parser.Tokens.T__6.rawValue,Swift3Parser.Tokens.T__7.rawValue,Swift3Parser.Tokens.T__8.rawValue,Swift3Parser.Tokens.T__9.rawValue,Swift3Parser.Tokens.T__10.rawValue,Swift3Parser.Tokens.T__11.rawValue,Swift3Parser.Tokens.T__12.rawValue,Swift3Parser.Tokens.T__13.rawValue,Swift3Parser.Tokens.T__14.rawValue,Swift3Parser.Tokens.T__15.rawValue,Swift3Parser.Tokens.T__16.rawValue,Swift3Parser.Tokens.T__17.rawValue,Swift3Parser.Tokens.T__18.rawValue,Swift3Parser.Tokens.T__19.rawValue,Swift3Parser.Tokens.T__20.rawValue,Swift3Parser.Tokens.T__25.rawValue,Swift3Parser.Tokens.T__26.rawValue,Swift3Parser.Tokens.T__27.rawValue,Swift3Parser.Tokens.T__29.rawValue,Swift3Parser.Tokens.T__30.rawValue,Swift3Parser.Tokens.T__32.rawValue,Swift3Parser.Tokens.T__33.rawValue,Swift3Parser.Tokens.T__34.rawValue,Swift3Parser.Tokens.T__35.rawValue,Swift3Parser.Tokens.T__36.rawValue,Swift3Parser.Tokens.T__37.rawValue,Swift3Parser.Tokens.T__38.rawValue,Swift3Parser.Tokens.T__39.rawValue,Swift3Parser.Tokens.T__40.rawValue,Swift3Parser.Tokens.T__41.rawValue,Swift3Parser.Tokens.T__42.rawValue,Swift3Parser.Tokens.T__43.rawValue,Swift3Parser.Tokens.T__44.rawValue,Swift3Parser.Tokens.T__45.rawValue,Swift3Parser.Tokens.T__46.rawValue,Swift3Parser.Tokens.T__47.rawValue,Swift3Parser.Tokens.T__48.rawValue,Swift3Parser.Tokens.T__49.rawValue,Swift3Parser.Tokens.T__50.rawValue,Swift3Parser.Tokens.T__51.rawValue,Swift3Parser.Tokens.T__52.rawValue,Swift3Parser.Tokens.T__53.rawValue,Swift3Parser.Tokens.T__54.rawValue,Swift3Parser.Tokens.T__55.rawValue,Swift3Parser.Tokens.T__56.rawValue,Swift3Parser.Tokens.T__57.rawValue,Swift3Parser.Tokens.T__58.rawValue,Swift3Parser.Tokens.T__59.rawValue,Swift3Parser.Tokens.T__60.rawValue,Swift3Parser.Tokens.T__61.rawValue,Swift3Parser.Tokens.T__62.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	          ...
		 	          testSet = testSet || _la == Swift3Parser.Tokens.T__127.rawValue || _la == Swift3Parser.Tokens.T__128.rawValue
		 	      return testSet
		 	 }())) {
		 	try _errHandler.recoverInline(self)
		 	}
	...
	@discardableResult
	 open func assignment_operator() throws -> Assignment_operatorContext {
		...
		do {
		 	...
		 	setState(2670)
		 	try match(Swift3Parser.Tokens.EQUAL.rawValue)
	...
	@discardableResult
	 open func negate_prefix_operator() throws -> Negate_prefix_operatorContext {
		...
		do {
		 	...
		 	setState(2673)
		 	try match(Swift3Parser.Tokens.SUB.rawValue)
	...
	public class Compilation_condition_ANDContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
	...
	public class Compilation_condition_ORContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
	...
	@discardableResult
	 open func compilation_condition_OR() throws -> Compilation_condition_ORContext {
		...
		do {
		 	...
		 	setState(2680)
		 	try match(Swift3Parser.Tokens.OR.rawValue)
		 	setState(2681)
		 	try match(Swift3Parser.Tokens.OR.rawValue)
	...
	public class Compilation_condition_GEContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
	...
	public class Operator_characterContext: ParserRuleContext {
			...
			func Operator_following_character() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Operator_following_character.rawValue, 0)
			}
		override open
		func getRuleIndex() -> Int {
	 ...
	 open func operator_character() throws -> Operator_characterContext {
		...
		do {
		 	...
		 	case .Operator_following_character:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(2728)
		 		try match(Swift3Parser.Tokens.Operator_following_character.rawValue)
	...
	public class Operator_headContext: ParserRuleContext {
			...
			func Operator_head_other() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Operator_head_other.rawValue, 0)
			}
		override open
		func getRuleIndex() -> Int {
		...
		do {
		 	...
		 	case .TILDE:
		 		...
		 		if (!(//closure
		 		 { () -> Bool in
		 		      let testSet: Bool = {  () -> Bool in
		 		   let testArray: [Int] = [_la, Swift3Parser.Tokens.LT.rawValue,Swift3Parser.Tokens.GT.rawValue,Swift3Parser.Tokens.BANG.rawValue,Swift3Parser.Tokens.QUESTION.rawValue,Swift3Parser.Tokens.AND.rawValue,Swift3Parser.Tokens.SUB.rawValue,Swift3Parser.Tokens.EQUAL.rawValue,Swift3Parser.Tokens.OR.rawValue,Swift3Parser.Tokens.DIV.rawValue,Swift3Parser.Tokens.ADD.rawValue,Swift3Parser.Tokens.MUL.rawValue,Swift3Parser.Tokens.MOD.rawValue,Swift3Parser.Tokens.CARET.rawValue,Swift3Parser.Tokens.TILDE.rawValue]
		 	...
		 	case .Operator_head_other:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(2732)
		 		try match(Swift3Parser.Tokens.Operator_head_other.rawValue)
	...
	public class Numeric_literalContext: ParserRuleContext {
			...
			func Floating_point_literal() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Floating_point_literal.rawValue, 0)
			}
		override open
		func getRuleIndex() -> Int {
	 ...
	 open func numeric_literal() throws -> Numeric_literalContext {
		...
		do {
		 	...
		 	case 2:
		 		...
		 		setState(2754)
		 		try match(Swift3Parser.Tokens.Floating_point_literal.rawValue)
	...
	@discardableResult
	 open func boolean_literal() throws -> Boolean_literalContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.T__126.rawValue || _la == Swift3Parser.Tokens.T__128.rawValue
		 	      return testSet
		 	 }())) {
		 	try _errHandler.recoverInline(self)
		 	}
	...
	@discardableResult
	 open func nil_literal() throws -> Nil_literalContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(2759)
		 	try match(Swift3Parser.Tokens.T__127.rawValue)
	...
	public class Integer_literalContext: ParserRuleContext {
			...
			func Binary_literal() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Binary_literal.rawValue, 0)
			}
			open
			func Octal_literal() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Octal_literal.rawValue, 0)
			}
			open
			func Decimal_literal() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Decimal_literal.rawValue, 0)
			}
			open
			func Pure_decimal_digits() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Pure_decimal_digits.rawValue, 0)
			...
			func Hexadecimal_literal() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Hexadecimal_literal.rawValue, 0)
			}
		override open
		func getRuleIndex() -> Int {
	 ...
	 open func integer_literal() throws -> Integer_literalContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift3Parser.Tokens.Binary_literal.rawValue,Swift3Parser.Tokens.Octal_literal.rawValue,Swift3Parser.Tokens.Decimal_literal.rawValue,Swift3Parser.Tokens.Pure_decimal_digits.rawValue,Swift3Parser.Tokens.Hexadecimal_literal.rawValue]
	...
	public class String_literalContext: ParserRuleContext {
			...
			func Interpolated_string_literal() -> TerminalNode? {
				return getToken(Swift3Parser.Tokens.Interpolated_string_literal.rawValue, 0)
			}
		override open
		func getRuleIndex() -> Int {
	...
	@discardableResult
	 open func string_literal() throws -> String_literalContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift3Parser.Tokens.Static_string_literal.rawValue || _la == Swift3Parser.Tokens.Interpolated_string_literal.rawValue
		 	      return testSet
		 	 }())) {
		 	try _errHandler.recoverInline(self)
		 	}
	...
	public
	static let _serializedATN = Swift3ParserATN().jsonString
