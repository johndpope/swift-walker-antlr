...
open class tntLexer: Lexer {
	...
	public
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, ZERO=8, 
            SUCCESSOR=9, A=10, B=11, C=12, D=13, E=14, PRIME=15, FOREVERY=16, 
            EXISTS=17, WS=18
	...
	override open
	func getRuleNames() -> [String] { return tntLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return tntLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return tntLexer.channelNames }

	override open
	func getModeNames() -> [String] { return tntLexer.modeNames }

	override open
	func getATN() -> ATN { return tntLexer._ATN }


	public
	static let _serializedATN: String = tntLexerATN().jsonString
