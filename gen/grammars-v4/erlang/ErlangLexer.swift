...
open class ErlangLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            TokAtom=64, TokVar=65, TokFloat=66, TokInteger=67, TokChar=68, 
            TokString=69, AttrName=70, Comment=71, WS=72
	...
	override open
	func getRuleNames() -> [String] { return ErlangLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return ErlangLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return ErlangLexer.channelNames }

	override open
	func getModeNames() -> [String] { return ErlangLexer.modeNames }

	override open
	func getATN() -> ATN { return ErlangLexer._ATN }


	public
	static let _serializedATN: String = ErlangLexerATN().jsonString
