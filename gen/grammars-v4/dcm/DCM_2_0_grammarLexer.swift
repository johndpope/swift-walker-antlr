...
open class DCM_2_0_grammarLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            NAME=34, TEXT=35, INT=36, FLOAT=37, MINUS=38, WS=39, COMMENT=40
	...
	override open
	func getRuleNames() -> [String] { return DCM_2_0_grammarLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return DCM_2_0_grammarLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return DCM_2_0_grammarLexer.channelNames }

	override open
	func getModeNames() -> [String] { return DCM_2_0_grammarLexer.modeNames }

	override open
	func getATN() -> ATN { return DCM_2_0_grammarLexer._ATN }


	public
	static let _serializedATN: String = DCM_2_0_grammarLexerATN().jsonString
