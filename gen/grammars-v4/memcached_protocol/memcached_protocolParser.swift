...
open class memcached_protocolParser: Parser {
	...
	enum Tokens: Int {
		case EOF = -1, T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, 
                 ...
                 T__27 = 28, T__28 = 29, T__29 = 30, T__30 = 31, INTEGER = 32, 
                 WORD = 33, WHITESPACE = 34
	}

	public
	static let RULE_command_line = 0, RULE_storage_command = 1, RULE_storage_command_name = 2, 
            ...
            RULE_statistics_response = 17, RULE_error_response = 18, RULE_general_statistic = 19, 
            RULE_size_statistic = 20, RULE_general_error = 21, RULE_client_error_message = 22, 
            RULE_server_error_message = 23, RULE_end = 24, RULE_noreply = 25, 
            RULE_key = 26, RULE_flags = 27, RULE_exptime = 28, RULE_bytes = 29, 
            RULE_cas_unique = 30, RULE_value = 31, RULE_time = 32, RULE_delay = 33, 
            RULE_verbosity_level = 34, RULE_statistic_name = 35, RULE_statistic_value = 36, 
            RULE_size = 37, RULE_count = 38
	...
	override open
	func getGrammarFileName() -> String { return "memcached_protocol.g4" }

	override open
	func getRuleNames() -> [String] { return memcached_protocolParser.ruleNames }

	override open
	func getSerializedATN() -> String { return memcached_protocolParser._serializedATN }

	override open
	func getATN() -> ATN { return memcached_protocolParser._ATN }
	...
	public class Command_lineContext: ParserRuleContext {
			open
			func storage_command() -> [Storage_commandContext] {
				return getRuleContexts(Storage_commandContext.self)
			}
			open
			func storage_command(_ i: Int) -> Storage_commandContext? {
				return getRuleContext(Storage_commandContext.self, i)
			}
			open
			func retrieval_command() -> [Retrieval_commandContext] {
				return getRuleContexts(Retrieval_commandContext.self)
			}
			open
			func retrieval_command(_ i: Int) -> Retrieval_commandContext? {
				return getRuleContext(Retrieval_commandContext.self, i)
			}
			open
			func delete_command() -> [Delete_commandContext] {
				return getRuleContexts(Delete_commandContext.self)
			}
			open
			func delete_command(_ i: Int) -> Delete_commandContext? {
				return getRuleContext(Delete_commandContext.self, i)
			}
			open
			func increment_command() -> [Increment_commandContext] {
				return getRuleContexts(Increment_commandContext.self)
			}
			open
			func increment_command(_ i: Int) -> Increment_commandContext? {
				return getRuleContext(Increment_commandContext.self, i)
			}
			open
			func decrement_command() -> [Decrement_commandContext] {
				return getRuleContexts(Decrement_commandContext.self)
			}
			open
			func decrement_command(_ i: Int) -> Decrement_commandContext? {
				return getRuleContext(Decrement_commandContext.self, i)
			}
			open
			func statistics_command() -> [Statistics_commandContext] {
				return getRuleContexts(Statistics_commandContext.self)
			}
			open
			func statistics_command(_ i: Int) -> Statistics_commandContext? {
				return getRuleContext(Statistics_commandContext.self, i)
			}
			open
			func flush_command() -> [Flush_commandContext] {
				return getRuleContexts(Flush_commandContext.self)
			}
			open
			func flush_command(_ i: Int) -> Flush_commandContext? {
				return getRuleContext(Flush_commandContext.self, i)
			}
			open
			func version_command() -> [Version_commandContext] {
				return getRuleContexts(Version_commandContext.self)
			}
			open
			func version_command(_ i: Int) -> Version_commandContext? {
				return getRuleContext(Version_commandContext.self, i)
			}
			open
			func verbosity_command() -> [Verbosity_commandContext] {
				return getRuleContexts(Verbosity_commandContext.self)
			}
			open
			func verbosity_command(_ i: Int) -> Verbosity_commandContext? {
				return getRuleContext(Verbosity_commandContext.self, i)
			}
			open
			func quit_command() -> [Quit_commandContext] {
				return getRuleContexts(Quit_commandContext.self)
			}
			open
			func quit_command(_ i: Int) -> Quit_commandContext? {
				return getRuleContext(Quit_commandContext.self, i)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_command_line
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterCommand_line(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitCommand_line(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitCommand_line(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitCommand_line(self)
			}
			else {
	 ...
	 open func command_line() throws -> Command_lineContext {
		...
		do {
		 	...
		 	repeat {
		 		setState(88)
		 		try _errHandler.sync(self)
		 		switch (memcached_protocolParser.Tokens(rawValue: try _input.LA(1))!) {
		 	 ...
		 	 { () -> Bool in
		 	   ...
		 	   let testArray: [Int] = [_la, memcached_protocolParser.Tokens.T__0.rawValue,memcached_protocolParser.Tokens.T__1.rawValue,memcached_protocolParser.Tokens.T__2.rawValue,memcached_protocolParser.Tokens.T__3.rawValue,memcached_protocolParser.Tokens.T__4.rawValue,memcached_protocolParser.Tokens.T__5.rawValue,memcached_protocolParser.Tokens.T__6.rawValue,memcached_protocolParser.Tokens.T__7.rawValue,memcached_protocolParser.Tokens.T__8.rawValue,memcached_protocolParser.Tokens.T__9.rawValue,memcached_protocolParser.Tokens.T__10.rawValue,memcached_protocolParser.Tokens.T__11.rawValue,memcached_protocolParser.Tokens.T__15.rawValue,memcached_protocolParser.Tokens.T__16.rawValue,memcached_protocolParser.Tokens.T__17.rawValue,memcached_protocolParser.Tokens.T__18.rawValue]
	...
	public class Storage_commandContext: ParserRuleContext {
			open
			func noreply() -> NoreplyContext? {
				return getRuleContext(NoreplyContext.self, 0)
			}
			open
			func storage_command_name() -> Storage_command_nameContext? {
			...
			open
			func flags() -> FlagsContext? {
				return getRuleContext(FlagsContext.self, 0)
			}
			open
			func exptime() -> ExptimeContext? {
			...
			open
			func cas_unique() -> Cas_uniqueContext? {
				return getRuleContext(Cas_uniqueContext.self, 0)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_storage_command
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterStorage_command(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitStorage_command(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitStorage_command(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitStorage_command(self)
			}
	...
	@discardableResult
	 open func storage_command() throws -> Storage_commandContext {
		...
		do {
		 	...
		 	case .T__0:
		 		setState(98)
		 		try match(memcached_protocolParser.Tokens.T__0.rawValue)
		 		setState(99)
		 		try key()
		 		setState(100)
		 		try flags()
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == memcached_protocolParser.Tokens.T__30.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(107)
		 		try noreply()
	...
	public class Storage_command_nameContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_storage_command_name
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterStorage_command_name(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitStorage_command_name(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitStorage_command_name(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitStorage_command_name(self)
			}
	 ...
	 open func storage_command_name() throws -> Storage_command_nameContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, memcached_protocolParser.Tokens.T__1.rawValue,memcached_protocolParser.Tokens.T__2.rawValue,memcached_protocolParser.Tokens.T__3.rawValue,memcached_protocolParser.Tokens.T__4.rawValue,memcached_protocolParser.Tokens.T__5.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	      return testSet
		 	 }())) {
	...
	public class Retrieval_commandContext: ParserRuleContext {
			open
			func key() -> [KeyContext] {
				return getRuleContexts(KeyContext.self)
			}
			open
			func key(_ i: Int) -> KeyContext? {
				return getRuleContext(KeyContext.self, i)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_retrieval_command
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterRetrieval_command(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitRetrieval_command(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitRetrieval_command(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitRetrieval_command(self)
			}
	 ...
	 open func retrieval_command() throws -> Retrieval_commandContext {
		...
		do {
			var _alt:Int
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == memcached_protocolParser.Tokens.T__6.rawValue || _la == memcached_protocolParser.Tokens.T__7.rawValue
		 	      return testSet
		 	 }())) {
		 	try _errHandler.recoverInline(self)
		 	}
	...
	public class Delete_commandContext: ParserRuleContext {
			open
			func key() -> KeyContext? {
				return getRuleContext(KeyContext.self, 0)
			}
		...
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_delete_command
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterDelete_command(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitDelete_command(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitDelete_command(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitDelete_command(self)
			}
	...
	@discardableResult
	 open func delete_command() throws -> Delete_commandContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(118)
		 	try match(memcached_protocolParser.Tokens.T__8.rawValue)
		 	setState(119)
		 	try key()
		 	setState(121)
		 	try _errHandler.sync(self)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == memcached_protocolParser.Tokens.INTEGER.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(120)
		 		try time()
	...
	public class Increment_commandContext: ParserRuleContext {
			open
			func key() -> KeyContext? {
				return getRuleContext(KeyContext.self, 0)
			}
		...
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_increment_command
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterIncrement_command(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitIncrement_command(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitIncrement_command(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitIncrement_command(self)
			}
	...
	@discardableResult
	 open func increment_command() throws -> Increment_commandContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(126)
		 	try match(memcached_protocolParser.Tokens.T__9.rawValue)
		 	setState(127)
		 	try key()
		 	setState(128)
		 	try value()
	...
	public class Decrement_commandContext: ParserRuleContext {
			open
			func key() -> KeyContext? {
				return getRuleContext(KeyContext.self, 0)
			}
		...
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_decrement_command
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterDecrement_command(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitDecrement_command(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitDecrement_command(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitDecrement_command(self)
			}
	...
	@discardableResult
	 open func decrement_command() throws -> Decrement_commandContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(132)
		 	try match(memcached_protocolParser.Tokens.T__10.rawValue)
		 	setState(133)
		 	try key()
		 	setState(134)
		 	try value()
	...
	public class Statistics_commandContext: ParserRuleContext {
			open
			func statistics_option() -> Statistics_optionContext? {
				return getRuleContext(Statistics_optionContext.self, 0)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_statistics_command
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterStatistics_command(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitStatistics_command(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitStatistics_command(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitStatistics_command(self)
			}
	...
	@discardableResult
	 open func statistics_command() throws -> Statistics_commandContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(138)
		 	try match(memcached_protocolParser.Tokens.T__11.rawValue)
		 	setState(140)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, memcached_protocolParser.Tokens.T__12.rawValue,memcached_protocolParser.Tokens.T__13.rawValue,memcached_protocolParser.Tokens.T__14.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	      return testSet
		 	 }()) {
	...
	public class Statistics_optionContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_statistics_option
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterStatistics_option(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitStatistics_option(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitStatistics_option(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitStatistics_option(self)
			}
	...
	public class Flush_commandContext: ParserRuleContext {
			open
		...
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_flush_command
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterFlush_command(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitFlush_command(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitFlush_command(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitFlush_command(self)
			}
	...
	@discardableResult
	 open func flush_command() throws -> Flush_commandContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(144)
		 	try match(memcached_protocolParser.Tokens.T__15.rawValue)
		 	setState(146)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
	...
	public class Version_commandContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_version_command
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterVersion_command(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitVersion_command(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitVersion_command(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitVersion_command(self)
			}
	...
	@discardableResult
	 open func version_command() throws -> Version_commandContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(151)
		 	try match(memcached_protocolParser.Tokens.T__16.rawValue)
	...
	public class Verbosity_commandContext: ParserRuleContext {
			open
			func verbosity_level() -> Verbosity_levelContext? {
				return getRuleContext(Verbosity_levelContext.self, 0)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_verbosity_command
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterVerbosity_command(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitVerbosity_command(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitVerbosity_command(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitVerbosity_command(self)
			}
	...
	@discardableResult
	 open func verbosity_command() throws -> Verbosity_commandContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(153)
		 	try match(memcached_protocolParser.Tokens.T__17.rawValue)
		 	setState(154)
		 	try verbosity_level()
	...
	public class Quit_commandContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_quit_command
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterQuit_command(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitQuit_command(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitQuit_command(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitQuit_command(self)
			}
	...
	@discardableResult
	 open func quit_command() throws -> Quit_commandContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(156)
		 	try match(memcached_protocolParser.Tokens.T__18.rawValue)
	...
	public class Storage_responseContext: ParserRuleContext {
			open
			func error_response() -> Error_responseContext? {
				return getRuleContext(Error_responseContext.self, 0)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_storage_response
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterStorage_response(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitStorage_response(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitStorage_response(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitStorage_response(self)
			}
	 ...
	 open func storage_response() throws -> Storage_responseContext {
		...
		do {
		 	...
		 	case .T__19:
		 		...
		 		setState(159)
		 		try match(memcached_protocolParser.Tokens.T__19.rawValue)
		 	...
		 	case .T__20:
		 		...
		 		setState(160)
		 		try match(memcached_protocolParser.Tokens.T__20.rawValue)
		 	...
		 	case .T__21:
		 		...
		 		setState(161)
		 		try match(memcached_protocolParser.Tokens.T__21.rawValue)
		 	...
		 	case .T__22:
		 		...
		 		setState(162)
		 		try match(memcached_protocolParser.Tokens.T__22.rawValue)
	...
	public class Retrieval_responseContext: ParserRuleContext {
			open
			func error_response() -> Error_responseContext? {
				return getRuleContext(Error_responseContext.self, 0)
			}
		...
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_retrieval_response
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterRetrieval_response(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitRetrieval_response(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitRetrieval_response(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitRetrieval_response(self)
			}
	 ...
	 open func retrieval_response() throws -> Retrieval_responseContext {
		...
		do {
		 	...
		 	case .T__23:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(166)
		 		try match(memcached_protocolParser.Tokens.T__23.rawValue)
		 		setState(167)
		 		try key()
		 		setState(168)
		 		try flags()
	...
	public class Deletion_responseContext: ParserRuleContext {
			open
			func error_response() -> Error_responseContext? {
				return getRuleContext(Error_responseContext.self, 0)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_deletion_response
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterDeletion_response(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitDeletion_response(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitDeletion_response(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitDeletion_response(self)
			}
	 ...
	 open func deletion_response() throws -> Deletion_responseContext {
		...
		do {
		 	...
		 	case .T__24:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(177)
		 		try match(memcached_protocolParser.Tokens.T__24.rawValue)
	...
	public class Incr_or_decr_responseContext: ParserRuleContext {
			open
			func error_response() -> Error_responseContext? {
				return getRuleContext(Error_responseContext.self, 0)
			}
			...
			func INTEGER() -> TerminalNode? {
				return getToken(memcached_protocolParser.Tokens.INTEGER.rawValue, 0)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_incr_or_decr_response
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterIncr_or_decr_response(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitIncr_or_decr_response(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitIncr_or_decr_response(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitIncr_or_decr_response(self)
			}
	 ...
	 open func incr_or_decr_response() throws -> Incr_or_decr_responseContext {
		...
		do {
		 	...
		 	case .INTEGER:
		 		try enterOuterAlt(_localctx, 3)
		 		setState(183)
		 		try match(memcached_protocolParser.Tokens.INTEGER.rawValue)
	...
	public class Statistics_responseContext: ParserRuleContext {
			open
			func error_response() -> Error_responseContext? {
				return getRuleContext(Error_responseContext.self, 0)
			}
			open
			func general_statistic() -> General_statisticContext? {
				return getRuleContext(General_statisticContext.self, 0)
			}
			open
			func size_statistic() -> Size_statisticContext? {
		...
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_statistics_response
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterStatistics_response(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitStatistics_response(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitStatistics_response(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitStatistics_response(self)
			}
	...
	public class Error_responseContext: ParserRuleContext {
			open
			func general_error() -> General_errorContext? {
				return getRuleContext(General_errorContext.self, 0)
			}
			open
			func client_error_message() -> Client_error_messageContext? {
				return getRuleContext(Client_error_messageContext.self, 0)
			}
			open
			func server_error_message() -> Server_error_messageContext? {
				return getRuleContext(Server_error_messageContext.self, 0)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_error_response
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
	...
	public class General_statisticContext: ParserRuleContext {
			open
			func statistic_name() -> Statistic_nameContext? {
				return getRuleContext(Statistic_nameContext.self, 0)
			}
			open
			func statistic_value() -> Statistic_valueContext? {
				return getRuleContext(Statistic_valueContext.self, 0)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_general_statistic
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterGeneral_statistic(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitGeneral_statistic(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitGeneral_statistic(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitGeneral_statistic(self)
			}
	...
	@discardableResult
	 open func general_statistic() throws -> General_statisticContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(197)
		 	try match(memcached_protocolParser.Tokens.T__25.rawValue)
		 	setState(198)
		 	try statistic_name()
		 	setState(199)
		 	try statistic_value()
	...
	public class Size_statisticContext: ParserRuleContext {
			open
		...
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_size_statistic
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterSize_statistic(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitSize_statistic(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitSize_statistic(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitSize_statistic(self)
			}
	...
	public class General_errorContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_general_error
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterGeneral_error(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitGeneral_error(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitGeneral_error(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitGeneral_error(self)
			}
	...
	@discardableResult
	 open func general_error() throws -> General_errorContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(204)
		 	try match(memcached_protocolParser.Tokens.T__26.rawValue)
	...
	public class Client_error_messageContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_client_error_message
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterClient_error_message(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitClient_error_message(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitClient_error_message(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitClient_error_message(self)
			}
	 ...
	 open func client_error_message() throws -> Client_error_messageContext {
		...
		do {
			var _alt:Int
		 	try enterOuterAlt(_localctx, 1)
		 	setState(206)
		 	try match(memcached_protocolParser.Tokens.T__27.rawValue)
		 	setState(208); 
		 	try _errHandler.sync(self)
		 	_alt = 1+1;
		 	repeat {
	...
	public class Server_error_messageContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_server_error_message
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterServer_error_message(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitServer_error_message(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitServer_error_message(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitServer_error_message(self)
			}
	 ...
	 open func server_error_message() throws -> Server_error_messageContext {
		...
		do {
			var _alt:Int
		 	try enterOuterAlt(_localctx, 1)
		 	setState(212)
		 	try match(memcached_protocolParser.Tokens.T__28.rawValue)
		 	setState(214); 
		 	try _errHandler.sync(self)
		 	_alt = 1+1;
		 	repeat {
	...
	public class EndContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_end
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
	...
	@discardableResult
	 open func end() throws -> EndContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(218)
		 	try match(memcached_protocolParser.Tokens.T__29.rawValue)
	...
	public class NoreplyContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_noreply
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterNoreply(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitNoreply(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitNoreply(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitNoreply(self)
			}
	...
	@discardableResult
	 open func noreply() throws -> NoreplyContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(220)
		 	try match(memcached_protocolParser.Tokens.T__30.rawValue)
	...
	public class KeyContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_key
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
	...
	public class FlagsContext: ParserRuleContext {
			open
			func INTEGER() -> TerminalNode? {
				return getToken(memcached_protocolParser.Tokens.INTEGER.rawValue, 0)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_flags
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
	...
	public class ExptimeContext: ParserRuleContext {
			open
			func INTEGER() -> TerminalNode? {
				return getToken(memcached_protocolParser.Tokens.INTEGER.rawValue, 0)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_exptime
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterExptime(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitExptime(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitExptime(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitExptime(self)
			}
	...
	public class BytesContext: ParserRuleContext {
		...
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_bytes
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
	...
	public class Cas_uniqueContext: ParserRuleContext {
			open
			func INTEGER() -> TerminalNode? {
				return getToken(memcached_protocolParser.Tokens.INTEGER.rawValue, 0)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_cas_unique
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterCas_unique(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitCas_unique(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitCas_unique(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitCas_unique(self)
			}
	...
	public class ValueContext: ParserRuleContext {
		...
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_value
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
	...
	public class TimeContext: ParserRuleContext {
		...
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_time
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
	...
	public class DelayContext: ParserRuleContext {
		...
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_delay
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
	...
	public class Verbosity_levelContext: ParserRuleContext {
			open
			func INTEGER() -> TerminalNode? {
				return getToken(memcached_protocolParser.Tokens.INTEGER.rawValue, 0)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_verbosity_level
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterVerbosity_level(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitVerbosity_level(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitVerbosity_level(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitVerbosity_level(self)
			}
	...
	public class Statistic_nameContext: ParserRuleContext {
			open
			func WORD() -> TerminalNode? {
				return getToken(memcached_protocolParser.Tokens.WORD.rawValue, 0)
			}
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_statistic_name
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterStatistic_name(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitStatistic_name(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitStatistic_name(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitStatistic_name(self)
			}
	...
	@discardableResult
	 open func statistic_name() throws -> Statistic_nameContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(240)
		 	try match(memcached_protocolParser.Tokens.WORD.rawValue)
	...
	public class Statistic_valueContext: ParserRuleContext {
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_statistic_value
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.enterStatistic_value(self)
			}
		}
		override open
		func exitRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
				listener.exitStatistic_value(self)
			}
		}
		override open
		func accept<T>(_ visitor: ParseTreeVisitor<T>) -> T? {
			if let visitor = visitor as? memcached_protocolVisitor {
			    return visitor.visitStatistic_value(self)
			}
			else if let visitor = visitor as? memcached_protocolBaseVisitor {
			    return visitor.visitStatistic_value(self)
			}
	...
	public class SizeContext: ParserRuleContext {
		...
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_size
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
	...
	public class CountContext: ParserRuleContext {
		...
		override open
		func getRuleIndex() -> Int {
			return memcached_protocolParser.RULE_count
		}
		override open
		func enterRule(_ listener: ParseTreeListener) {
			if let listener = listener as? memcached_protocolListener {
	...
	public
	static let _serializedATN = memcached_protocolParserATN().jsonString
