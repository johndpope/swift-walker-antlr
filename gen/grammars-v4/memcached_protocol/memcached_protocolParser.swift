...
open class memcached_protocolParser: Parser {
	...
	open class Incr_or_decr_responseContext:ParserRuleContext {
		...
		open func INTEGER() -> TerminalNode? { return getToken(memcached_protocolParser.Tokens.INTEGER.rawValue, 0) }
	...
	open class Statistic_nameContext:ParserRuleContext {
		open func WORD() -> TerminalNode? { return getToken(memcached_protocolParser.Tokens.WORD.rawValue, 0) }
