...
open class emailaddressParser: Parser {
	...
	public enum Tokens: Int {
		case EOF = -1, T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, 
                 ...
                 QTEXT = 24, DTEXT = 25, CTEXT = 26, TAB = 27
	}
	...
	open class LwspcharContext:ParserRuleContext {
		open func SPACE() -> TerminalNode? { return getToken(emailaddressParser.Tokens.SPACE.rawValue, 0) }
		open func TAB() -> TerminalNode? { return getToken(emailaddressParser.Tokens.TAB.rawValue, 0) }
	...
	open func lwspchar() throws -> LwspcharContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == emailaddressParser.Tokens.SPACE.rawValue || _la == emailaddressParser.Tokens.TAB.rawValue
		 	      return testSet
		 	 }())) {
	...
	open class LwspContext:ParserRuleContext {
		...
		open func CRLF() -> Array<TerminalNode> { return getTokens(emailaddressParser.Tokens.CRLF.rawValue) }
		...
		do {
		 	...
		 	repeat {
		 	 ...
		 	 { () -> Bool in
		 	   ...
		 	   let testArray: [Int] = [_la, emailaddressParser.Tokens.SPACE.rawValue,emailaddressParser.Tokens.CRLF.rawValue,emailaddressParser.Tokens.TAB.rawValue]
	...
	open class DelimetersContext:ParserRuleContext {
		open func SPECIALS() -> TerminalNode? { return getToken(emailaddressParser.Tokens.SPECIALS.rawValue, 0) }
	...
	open class AtomContext:ParserRuleContext {
		open func CHAR() -> Array<TerminalNode> { return getTokens(emailaddressParser.Tokens.CHAR.rawValue) }
	...
	open class QuotedpairContext:ParserRuleContext {
		open func CHAR() -> TerminalNode? { return getToken(emailaddressParser.Tokens.CHAR.rawValue, 0) }
	...
	open class DomainliteralContext:ParserRuleContext {
		open func DTEXT() -> Array<TerminalNode> { return getTokens(emailaddressParser.Tokens.DTEXT.rawValue) }
	...
	open class QuotedstringContext:ParserRuleContext {
		open func QTEXT() -> Array<TerminalNode> { return getTokens(emailaddressParser.Tokens.QTEXT.rawValue) }
	...
	open class CommentContext:ParserRuleContext {
		open func CTEXT() -> Array<TerminalNode> { return getTokens(emailaddressParser.Tokens.CTEXT.rawValue) }
