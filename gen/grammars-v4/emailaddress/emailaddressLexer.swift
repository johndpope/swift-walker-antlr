...
open class emailaddressLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            T__8=9, T__9=10, T__10=11, T__11=12, CHAR=13, ALPHA=14, DIGIT=15, 
            CTL=16, CR=17, LF=18, SPACE=19, HTAB=20, CRLF=21, SPECIALS=22, 
            QUOTE=23, QTEXT=24, DTEXT=25, CTEXT=26
	...
	override open
	func getRuleNames() -> [String] { return emailaddressLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return emailaddressLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return emailaddressLexer.channelNames }

	override open
	func getModeNames() -> [String] { return emailaddressLexer.modeNames }

	override open
	func getATN() -> ATN { return emailaddressLexer._ATN }


	public
	static let _serializedATN: String = emailaddressLexerATN().jsonString
