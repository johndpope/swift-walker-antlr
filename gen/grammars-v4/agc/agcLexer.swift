...
open class agcLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__180=181, T__181=182, T__182=183, LABEL=184, INTE=185, DECIMAL=186, 
            COMMENT=187, PLUS=188, MINUS=189, TIMES=190, DIV=191, COMMA=192, 
	...
	override open
	func getRuleNames() -> [String] { return agcLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return agcLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return agcLexer.channelNames }

	override open
	func getModeNames() -> [String] { return agcLexer.modeNames }

	override open
	func getATN() -> ATN { return agcLexer._ATN }


	public
	static let _serializedATN: String = agcLexerATN().jsonString
