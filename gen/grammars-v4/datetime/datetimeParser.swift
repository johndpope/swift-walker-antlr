...
open class datetimeParser: Parser {
	...
	open class ZoneContext:ParserRuleContext {
		open func ALPHA() -> TerminalNode? { return getToken(datetimeParser.Tokens.ALPHA.rawValue, 0) }
	...
	open class AlphanumericContext:ParserRuleContext {
		open func ALPHA() -> TerminalNode? { return getToken(datetimeParser.Tokens.ALPHA.rawValue, 0) }
		open func DIGIT() -> TerminalNode? { return getToken(datetimeParser.Tokens.DIGIT.rawValue, 0) }
