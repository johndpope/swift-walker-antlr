...
open class datetimeLexer: Lexer {
	...
	override open
	func getRuleNames() -> [String] { return datetimeLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return datetimeLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return datetimeLexer.channelNames }

	override open
	func getModeNames() -> [String] { return datetimeLexer.modeNames }

	override open
	func getATN() -> ATN { return datetimeLexer._ATN }


	public
	static let _serializedATN: String = datetimeLexerATN().jsonString
