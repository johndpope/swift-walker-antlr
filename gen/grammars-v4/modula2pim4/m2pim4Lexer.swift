...
open class m2pim4Lexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            AND=28, ARRAY=29, BEGIN=30, BY=31, CASE=32, CONST=33, DEFINITION=34, 
            DIV=35, DO=36, ELSE=37, ELSIF=38, END=39, EXIT=40, EXPORT=41, 
            FOR=42, FROM=43, IF=44, IMPLEMENTATION=45, IMPORT=46, IN=47, 
            LOOP=48, MOD=49, MODULE=50, NOT=51, OF=52, OR=53, POINTER=54, 
            ...
            OCTAL_DIGIT=73, HEX_DIGIT=74, SCALE_FACTOR=75, COMMENT=76, WS=77
	...
	override open
	func getRuleNames() -> [String] { return m2pim4Lexer.ruleNames }

	override open
	func getSerializedATN() -> String { return m2pim4Lexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return m2pim4Lexer.channelNames }

	override open
	func getModeNames() -> [String] { return m2pim4Lexer.modeNames }

	override open
	func getATN() -> ATN { return m2pim4Lexer._ATN }


	public
	static let _serializedATN: String = m2pim4LexerATN().jsonString
