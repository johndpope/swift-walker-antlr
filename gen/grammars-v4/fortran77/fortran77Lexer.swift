...
open class fortran77Lexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__69=70, DOLLAR=71, COMMA=72, LPAREN=73, RPAREN=74, COLON=75, 
            ASSIGN=76, MINUS=77, PLUS=78, DIV=79, STAR=80, POWER=81, LNOT=82, 
            LAND=83, LOR=84, EQV=85, NEQV=86, XOR=87, EOR=88, LT=89, LE=90, 
            GT=91, GE=92, NE=93, EQ=94, TRUE=95, FALSE=96, XCON=97, PCON=98, 
            FCON=99, RCON=100, CCON=101, HOLLERITH=102, CONCATOP=103, CTRLDIRECT=104, 
            CTRLREC=105, TO=106, SUBPROGRAMBLOCK=107, DOBLOCK=108, AIF=109, 
            THENBLOCK=110, ELSEIF=111, ELSEBLOCK=112, CODEROOT=113, CONTINUATION=114, 
            EOS=115, WS=116, COMMENT=117, SCON=118, ZCON=119, NAME=120, 
            WHITE=121, ALPHA=122, NUM=123, ALNUM=124, HEX=125, SIGN=126, 
            NOTNL=127, INTVAL=128, FDESC=129, EXPON=130
	...
	override open
	func getRuleNames() -> [String] { return fortran77Lexer.ruleNames }

	override open
	func getSerializedATN() -> String { return fortran77Lexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return fortran77Lexer.channelNames }

	override open
	func getModeNames() -> [String] { return fortran77Lexer.modeNames }

	override open
	func getATN() -> ATN { return fortran77Lexer._ATN }


	public
	static let _serializedATN: String = fortran77LexerATN().jsonString
