...
open class ASNLexer: Lexer {
	...
	public
	static let A_ROND=1, STAR=2, ASSIGN_OP=3, BOOLEAN_LITERAL=4, TRUE_LITERAL=5, 
            ...
            STRING_LITERAL=30, CONTAINING_LITERAL=31, OCTET_LITERAL=32, 
            NULL_LITERAL=33, SEQUENCE_LITERAL=34, OPTIONAL_LITERAL=35, DEFAULT_LITERAL=36, 
            ...
            CLASS_LITERAL=59, UNIQUE_LITERAL=60, SYNTAX_LITERAL=61, L_BRACKET=62, 
            R_BRACKET=63, INSTANCE_LITERAL=64, SEMI_COLON=65, IMPORTS_LITERAL=66, 
            EXPORTS_LITERAL=67, EXTENSIBILITY_LITERAL=68, IMPLIED_LITERAL=69, 
            EXPLICIT_LITERAL=70, TAGS_LITERAL=71, IMPLICIT_LITERAL=72, AUTOMATIC_LITERAL=73, 
            DEFINITIONS_LITERAL=74, BEGIN_LITERAL=75, END_LITERAL=76, DOUBLE_L_BRACKET=77, 
            ...
            BY_LITERAL=92, A_ROND_DOT=93, ENCODED_LITERAL=94, COMMENT=95, 
            UNRESTRICTEDCHARACTERSTRINGTYPE=96, EXTENSTIONENDMARKER=97, 
            NUMBER=98, WS=99, LINE_COMMENT=100, BSTRING=101, HSTRING=102, 
            CSTRING=103, IDENTIFIER=104
	...
	override open
	func getRuleNames() -> [String] { return ASNLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return ASNLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return ASNLexer.channelNames }

	override open
	func getModeNames() -> [String] { return ASNLexer.modeNames }

	override open
	func getATN() -> ATN { return ASNLexer._ATN }


	public
	static let _serializedATN: String = ASNLexerATN().jsonString
