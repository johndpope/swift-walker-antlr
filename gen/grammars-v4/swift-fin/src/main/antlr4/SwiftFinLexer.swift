// Generated from ./grammars-v4/swift-fin/src/main/antlr4/SwiftFinLexer.g4 by ANTLR 4.7
import Antlr4
...
open class SwiftFinLexer: Lexer {
	...
	public static let BLOCK1=1, BLOCK2=2, BLOCK3=3, BLOCK4_A=4, BLOCK4_B=5, 
                   ...
                   V_END=17, V_VALUE=18
	public static let InsideMaps=1, InsideB4=2, InsideValue=3
	...
	override
	open func getChannelNames() -> [String] { return SwiftFinLexer.channelNames }
