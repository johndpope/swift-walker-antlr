...
open class SmalltalkLexer: Lexer {
	...
	public
	static let SEPARATOR=1, STRING=2, COMMENT=3, BLOCK_START=4, BLOCK_END=5, 
            ...
            DYNARR_END=26, DYNARR_START=27, DIGIT=28, HEXDIGIT=29, KEYWORD=30, 
	...
	override open
	func getRuleNames() -> [String] { return SmalltalkLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return SmalltalkLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return SmalltalkLexer.channelNames }

	override open
	func getModeNames() -> [String] { return SmalltalkLexer.modeNames }

	override open
	func getATN() -> ATN { return SmalltalkLexer._ATN }


	public
	static let _serializedATN: String = SmalltalkLexerATN().jsonString
