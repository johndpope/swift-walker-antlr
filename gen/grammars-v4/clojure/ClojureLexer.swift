...
open class ClojureLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__15=16, T__16=17, T__17=18, T__18=19, T__19=20, STRING=21, 
            FLOAT=22, HEX=23, BIN=24, LONG=25, BIGN=26, CHAR_U=27, CHAR_NAMED=28, 
            CHAR_ANY=29, NIL=30, BOOLEAN=31, SYMBOL=32, NS_SYMBOL=33, PARAM_NAME=34, 
            TRASH=35
	...
	override open
	func getRuleNames() -> [String] { return ClojureLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return ClojureLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return ClojureLexer.channelNames }

	override open
	func getModeNames() -> [String] { return ClojureLexer.modeNames }

	override open
	func getATN() -> ATN { return ClojureLexer._ATN }


	public
	static let _serializedATN: String = ClojureLexerATN().jsonString
