// Generated from ./grammars-v4/xml/XMLLexer.g4 by ANTLR 4.7
import Antlr4
...
open class XMLLexer: Lexer {
	...
	public static let COMMENT=1, CDATA=2, DTD=3, EntityRef=4, CharRef=5, SEA_WS=6, 
                   ...
                   S=17, PI=18
	public static let INSIDE=1, PROC_INSTR=2
	...
	override
	open func getChannelNames() -> [String] { return XMLLexer.channelNames }
