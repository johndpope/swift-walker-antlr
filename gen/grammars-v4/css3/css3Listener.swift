...
public protocol css3Listener: ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link css3Parser#namespace}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func enterNamespace(_ ctx: css3Parser.NamespaceContext)
	/**
	 * Exit a parse tree produced by {@link css3Parser#namespace}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func exitNamespace(_ ctx: css3Parser.NamespaceContext)
	/**
	 * Enter a parse tree produced by {@link css3Parser#charset}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func enterCharset(_ ctx: css3Parser.CharsetContext)
	/**
	 * Exit a parse tree produced by {@link css3Parser#charset}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func exitCharset(_ ctx: css3Parser.CharsetContext)
	/**
	...
	/**
	 * Enter a parse tree produced by {@link css3Parser#idSelector}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func enterIdSelector(_ ctx: css3Parser.IdSelectorContext)
	/**
	 * Exit a parse tree produced by {@link css3Parser#idSelector}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func exitIdSelector(_ ctx: css3Parser.IdSelectorContext)
	/**
	 * Enter a parse tree produced by {@link css3Parser#classSelector}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func enterClassSelector(_ ctx: css3Parser.ClassSelectorContext)
	/**
	 * Exit a parse tree produced by {@link css3Parser#classSelector}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func exitClassSelector(_ ctx: css3Parser.ClassSelectorContext)
	/**
