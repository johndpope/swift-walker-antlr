...
open class css3Visitor<T>: ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link css3Parser#namespace}.
	- Parameters:
	  - ctx: the parse tree
	- returns: the visitor result
	 */
	open func visitNamespace(_ ctx: css3Parser.NamespaceContext) -> T{
	 	fatalError(#function + " must be overridden")
	}

	/**
	 * Visit a parse tree produced by {@link css3Parser#charset}.
	- Parameters:
	  - ctx: the parse tree
	- returns: the visitor result
	 */
	open func visitCharset(_ ctx: css3Parser.CharsetContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	/**
	 * Visit a parse tree produced by {@link css3Parser#idSelector}.
	- Parameters:
	  - ctx: the parse tree
	- returns: the visitor result
	 */
	open func visitIdSelector(_ ctx: css3Parser.IdSelectorContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitClassSelector(_ ctx: css3Parser.ClassSelectorContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
