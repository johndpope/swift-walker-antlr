// Generated from ./grammars-v4/javadoc/JavadocLexer.g4 by ANTLR 4.7.1
import Antlr4
...
open class JavadocLexer: Lexer {
	...
	public
	static let NAME=1, NEWLINE=2, SPACE=3, TEXT_CONTENT=4, AT=5, STAR=6, SLASH=7, 
            JAVADOC_START=8, JAVADOC_END=9, INLINE_TAG_START=10, BRACE_OPEN=11, 
            BRACE_CLOSE=12
	...
	override open
	func getGrammarFileName() -> String { return "JavadocLexer.g4" }

	override open
	func getRuleNames() -> [String] { return JavadocLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return JavadocLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return JavadocLexer.channelNames }

	override open
	func getModeNames() -> [String] { return JavadocLexer.modeNames }

	override open
	func getATN() -> ATN { return JavadocLexer._ATN }
	...
	public
	static let _serializedATN: String = JavadocLexerATN().jsonString
