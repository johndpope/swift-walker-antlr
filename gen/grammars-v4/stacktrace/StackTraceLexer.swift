...
open class StackTraceLexer: Lexer {
	...
	public
	static let T__0=1, T__1=2, T__2=3, T__3=4, Number=5, JavaWord=6, DOT=7, 
            AT=8, CAUSED_BY=9, MORE_=10, ELLIPSIS=11, COLON=12, NATIVE_METHOD=13, 
            UNKNOWN_SOURCE=14, INIT=15, NonCapitalLetter=16, CapitalLetter=17, 
            Symbol=18, Digit=19, WS=20
	...
	override open
	func getRuleNames() -> [String] { return StackTraceLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return StackTraceLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return StackTraceLexer.channelNames }

	override open
	func getModeNames() -> [String] { return StackTraceLexer.modeNames }

	override open
	func getATN() -> ATN { return StackTraceLexer._ATN }


	public
	static let _serializedATN: String = StackTraceLexerATN().jsonString
