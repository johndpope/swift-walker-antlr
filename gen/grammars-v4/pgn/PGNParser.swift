...
open class PGNParser: Parser {
	...
	open class ParseContext:ParserRuleContext {
		...
		open func EOF() -> TerminalNode? { return getToken(PGNParser.Tokens.EOF.rawValue, 0) }
	...
	open class Tag_pairContext:ParserRuleContext {
		open func LEFT_BRACKET() -> TerminalNode? { return getToken(PGNParser.Tokens.LEFT_BRACKET.rawValue, 0) }
		...
		open func RIGHT_BRACKET() -> TerminalNode? { return getToken(PGNParser.Tokens.RIGHT_BRACKET.rawValue, 0) }
	...
	open class Tag_nameContext:ParserRuleContext {
		open func SYMBOL() -> TerminalNode? { return getToken(PGNParser.Tokens.SYMBOL.rawValue, 0) }
	...
	open class Tag_valueContext:ParserRuleContext {
		open func STRING() -> TerminalNode? { return getToken(PGNParser.Tokens.STRING.rawValue, 0) }
	...
	open class ElementContext:ParserRuleContext {
		...
		open func NUMERIC_ANNOTATION_GLYPH() -> TerminalNode? { return getToken(PGNParser.Tokens.NUMERIC_ANNOTATION_GLYPH.rawValue, 0) }
	...
	open class Move_number_indicationContext:ParserRuleContext {
		open func INTEGER() -> TerminalNode? { return getToken(PGNParser.Tokens.INTEGER.rawValue, 0) }
		open func PERIOD() -> TerminalNode? { return getToken(PGNParser.Tokens.PERIOD.rawValue, 0) }
	...
	open class Recursive_variationContext:ParserRuleContext {
		open func LEFT_PARENTHESIS() -> TerminalNode? { return getToken(PGNParser.Tokens.LEFT_PARENTHESIS.rawValue, 0) }
		open func element_sequence() -> Element_sequenceContext? {
			return getRuleContext(Element_sequenceContext.self,0)
		}
		open func RIGHT_PARENTHESIS() -> TerminalNode? { return getToken(PGNParser.Tokens.RIGHT_PARENTHESIS.rawValue, 0) }
	...
	open class Game_terminationContext:ParserRuleContext {
		open func WHITE_WINS() -> TerminalNode? { return getToken(PGNParser.Tokens.WHITE_WINS.rawValue, 0) }
		open func BLACK_WINS() -> TerminalNode? { return getToken(PGNParser.Tokens.BLACK_WINS.rawValue, 0) }
		open func DRAWN_GAME() -> TerminalNode? { return getToken(PGNParser.Tokens.DRAWN_GAME.rawValue, 0) }
		open func ASTERISK() -> TerminalNode? { return getToken(PGNParser.Tokens.ASTERISK.rawValue, 0) }
