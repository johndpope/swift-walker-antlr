...
open class JPALexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__75=76, T__76=77, IDENTIFICATION_VARIABLE=78, CHARACTER=79, 
	...
	override open
	func getRuleNames() -> [String] { return JPALexer.ruleNames }

	override open
	func getSerializedATN() -> String { return JPALexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return JPALexer.channelNames }

	override open
	func getModeNames() -> [String] { return JPALexer.modeNames }

	override open
	func getATN() -> ATN { return JPALexer._ATN }


	public
	static let _serializedATN: String = JPALexerATN().jsonString
