...
open class logoLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__39=40, T__40=41, STRINGLITERAL=42, STRING=43, NUMBER=44, 
	...
	override open
	func getRuleNames() -> [String] { return logoLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return logoLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return logoLexer.channelNames }

	override open
	func getModeNames() -> [String] { return logoLexer.modeNames }

	override open
	func getATN() -> ATN { return logoLexer._ATN }


	public
	static let _serializedATN: String = logoLexerATN().jsonString
