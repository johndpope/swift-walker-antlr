// Generated from ./grammars-v4/html/HTMLLexer.g4 by ANTLR 4.7.1
import Antlr4
...
open class HTMLLexer: Lexer {
	...
	public
	static let HTML_COMMENT=1, HTML_CONDITIONAL_COMMENT=2, XML_DECLARATION=3, 
	...
	public
	static let TAG=1, SCRIPT=2, STYLE=3, ATTVALUE=4
	public
	...
	override open
	func getGrammarFileName() -> String { return "HTMLLexer.g4" }

	override open
	func getRuleNames() -> [String] { return HTMLLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return HTMLLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return HTMLLexer.channelNames }

	override open
	func getModeNames() -> [String] { return HTMLLexer.modeNames }

	override open
	func getATN() -> ATN { return HTMLLexer._ATN }


	public
	static let _serializedATN: String = HTMLLexerATN().jsonString
