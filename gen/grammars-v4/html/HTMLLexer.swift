// Generated from ./grammars-v4/html/HTMLLexer.g4 by ANTLR 4.7
import Antlr4
...
open class HTMLLexer: Lexer {
	...
	public static let HTML_COMMENT=1, HTML_CONDITIONAL_COMMENT=2, XML_DECLARATION=3, 
                   ...
                   ATTRIBUTE=23
	public static let TAG=1, SCRIPT=2, STYLE=3, ATTVALUE=4
	...
	override
	open func getChannelNames() -> [String] { return HTMLLexer.channelNames }
