...
open class propcalcParser: Parser {
	...
	open class PropositionContext:ParserRuleContext {
		...
		open func THEREFORE() -> TerminalNode? { return getToken(propcalcParser.Tokens.THEREFORE.rawValue, 0) }
	...
	open class ExpressionContext:ParserRuleContext {
		...
		open func AND() -> Array<TerminalNode> { return getTokens(propcalcParser.Tokens.AND.rawValue) }
		open func AND(_ i:Int) -> TerminalNode?{
			return getToken(propcalcParser.Tokens.AND.rawValue, i)
		}
		open func OR() -> Array<TerminalNode> { return getTokens(propcalcParser.Tokens.OR.rawValue) }
	...
	open class AtomContext:ParserRuleContext {
		...
		open func NOT() -> TerminalNode? { return getToken(propcalcParser.Tokens.NOT.rawValue, 0) }
		open func atom() -> AtomContext? {
			return getRuleContext(AtomContext.self,0)
		}
		open func LPAREN() -> TerminalNode? { return getToken(propcalcParser.Tokens.LPAREN.rawValue, 0) }
		open func expression() -> ExpressionContext? {
			return getRuleContext(ExpressionContext.self,0)
		}
		open func RPAREN() -> TerminalNode? { return getToken(propcalcParser.Tokens.RPAREN.rawValue, 0) }
	...
	open class EquivContext:ParserRuleContext {
		...
		open func EQUIV() -> TerminalNode? { return getToken(propcalcParser.Tokens.EQUIV.rawValue, 0) }
	...
	open class ImpliesContext:ParserRuleContext {
		...
		open func IMPLIES() -> TerminalNode? { return getToken(propcalcParser.Tokens.IMPLIES.rawValue, 0) }
	...
	open class VariableContext:ParserRuleContext {
		open func LETTER() -> Array<TerminalNode> { return getTokens(propcalcParser.Tokens.LETTER.rawValue) }
