...
open class Verilog2001Lexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__165=166, Real_number=167, Decimal_number=168, Binary_number=169, 
	...
	override open
	func getRuleNames() -> [String] { return Verilog2001Lexer.ruleNames }

	override open
	func getSerializedATN() -> String { return Verilog2001Lexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return Verilog2001Lexer.channelNames }

	override open
	func getModeNames() -> [String] { return Verilog2001Lexer.modeNames }

	override open
	func getATN() -> ATN { return Verilog2001Lexer._ATN }


	public
	static let _serializedATN: String = Verilog2001LexerATN().jsonString
