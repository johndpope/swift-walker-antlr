...
open class lolcodeLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__39=40, LABEL=41, ATOM=42, STRING=43, WS=44
	...
	override open
	func getRuleNames() -> [String] { return lolcodeLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return lolcodeLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return lolcodeLexer.channelNames }

	override open
	func getModeNames() -> [String] { return lolcodeLexer.modeNames }

	override open
	func getATN() -> ATN { return lolcodeLexer._ATN }


	public
	static let _serializedATN: String = lolcodeLexerATN().jsonString
