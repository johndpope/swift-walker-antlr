...
open class RCSLexer: Lexer {
	...
	public
	static let COMMA=1, BRANCH=2, LOGS=3, ADMIN=4, DELTAS=5, LITERAL_HEAD=6, 
            LITERAL_BRANCH=7, LITERAL_ACCESS=8, LITERAL_SYMBOLS=9, LITERAL_LOCKS=10, 
            LITERAL_STRICT=11, LITERAL_COMMENT=12, LITERAL_EXPAND=13, LITERAL_DATE=14, 
            LITERAL_AUTHOR=15, LITERAL_STATE=16, LITERAL_BRANCHES=17, LITERAL_NEXT=18, 
	...
	override open
	func getRuleNames() -> [String] { return RCSLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return RCSLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return RCSLexer.channelNames }

	override open
	func getModeNames() -> [String] { return RCSLexer.modeNames }

	override open
	func getATN() -> ATN { return RCSLexer._ATN }


	public
	static let _serializedATN: String = RCSLexerATN().jsonString
