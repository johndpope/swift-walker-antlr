...
open class Python3Parser: Parser {
	...
	public class AtomContext: ParserRuleContext {
			...
			open
			func strr() -> [StrrContext] {
				return getRuleContexts(StrrContext.self)
			}
			open
			func strr(_ i: Int) -> StrrContext? {
				return getRuleContext(StrrContext.self, i)
			}
			open
	...
	public class StrrContext: ParserRuleContext {
			open
	...
	@discardableResult
	 open func strr() throws -> StrrContext {
		var _localctx: StrrContext = StrrContext(_ctx, getState())
		try enterRule(_localctx, 162, Python3Parser.RULE_strr)
		var _la: Int = 0
		defer {
	    		try! exitRule()
	    }
