...
open class IRILexer: Lexer {
	...
	public
	static let UCSCHAR=1, IPRIVATE=2, D0=3, D1=4, D2=5, D3=6, D4=7, D5=8, D6=9, 
            D7=10, D8=11, D9=12, A=13, B=14, C=15, D=16, E=17, F=18, G=19, 
            H=20, I=21, J=22, K=23, L=24, M=25, N=26, O=27, P=28, Q=29, 
            R=30, S=31, T=32, U=33, V=34, W=35, X=36, Y=37, Z=38, COL2=39, 
            COL=40, DOT=41, PERCENT=42, HYPHEN=43, TILDE=44, USCORE=45, 
            EXCL=46, DOLLAR=47, AMP=48, SQUOTE=49, OPAREN=50, CPAREN=51, 
            STAR=52, PLUS=53, COMMA=54, SCOL=55, EQUALS=56, FSLASH2=57, 
	...
	override open
	func getRuleNames() -> [String] { return IRILexer.ruleNames }

	override open
	func getSerializedATN() -> String { return IRILexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return IRILexer.channelNames }

	override open
	func getModeNames() -> [String] { return IRILexer.modeNames }

	override open
	func getATN() -> ATN { return IRILexer._ATN }


	public
	static let _serializedATN: String = IRILexerATN().jsonString
