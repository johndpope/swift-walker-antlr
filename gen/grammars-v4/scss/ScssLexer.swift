// Generated from ./grammars-v4/scss/ScssLexer.g4 by ANTLR 4.7.1
import Antlr4
...
open class ScssLexer: Lexer {
	...
	public
	static let NULL=1, IN=2, Unit=3, COMBINE_COMPARE=4, Ellipsis=5, InterpolationStart=6, 
            LPAREN=7, RPAREN=8, BlockStart=9, BlockEnd=10, LBRACK=11, RBRACK=12, 
            GT=13, TIL=14, LT=15, COLON=16, SEMI=17, COMMA=18, DOT=19, DOLLAR=20, 
            AT=21, AND=22, HASH=23, COLONCOLON=24, PLUS=25, TIMES=26, DIV=27, 
            MINUS=28, PERC=29, UrlStart=30, EQEQ=31, NOTEQ=32, EQ=33, PIPE_EQ=34, 
            TILD_EQ=35, MIXIN=36, FUNCTION=37, AT_ELSE=38, IF=39, AT_IF=40, 
            AT_FOR=41, AT_WHILE=42, AT_EACH=43, INCLUDE=44, IMPORT=45, RETURN=46, 
            FROM=47, THROUGH=48, POUND_DEFAULT=49, Identifier=50, StringLiteral=51, 
            Number=52, Color=53, WS=54, SL_COMMENT=55, COMMENT=56, UrlEnd=57, 
	...
	override open
	func getGrammarFileName() -> String { return "ScssLexer.g4" }

	override open
	func getRuleNames() -> [String] { return ScssLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return ScssLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return ScssLexer.channelNames }

	override open
	func getModeNames() -> [String] { return ScssLexer.modeNames }

	override open
	func getATN() -> ATN { return ScssLexer._ATN }


	public
	static let _serializedATN: String = ScssLexerATN().jsonString
