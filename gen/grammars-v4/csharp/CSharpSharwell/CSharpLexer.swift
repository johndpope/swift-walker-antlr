// Generated from ./grammars-v4/csharp/CSharpSharwell/CSharpLexer.g4 by ANTLR 4.7
...
open class CSharpLexer: Lexer {
	...
	public static let COMMENTS_CHANNEL=2, DIRECTIVE=3
	public static let INTERPOLATION_STRING=1, INTERPOLATION_FORMAT=2, DIRECTIVE_MODE=3, 
                   DIRECTIVE_TEXT=4
	...
	override
	open func getChannelNames() -> [String] { return CSharpLexer.channelNames }
