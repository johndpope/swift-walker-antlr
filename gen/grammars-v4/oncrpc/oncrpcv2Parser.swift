	...
	@discardableResult
	 open func programDef() throws -> ProgramDefContext {
		...
		do {
		 	...
		 	setState(42)
		 	try match(oncrpcv2Parser.Tokens.T__0.rawValue)
		 	setState(43)
		 	try match(oncrpcv2Parser.Tokens.IDENTIFIER.rawValue)
		 	setState(44)
		 	try match(oncrpcv2Parser.Tokens.T__1.rawValue)
		 	setState(45)
		 	try versionDef()
		 	setState(49)
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == oncrpcv2Parser.Tokens.T__5.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(46)
		 		try versionDef()
		 	...
		 	setState(52)
		 	try match(oncrpcv2Parser.Tokens.T__2.rawValue)
		 	setState(53)
		 	try match(oncrpcv2Parser.Tokens.T__3.rawValue)
		 	setState(54)
		 	try constant()
		 	setState(55)
		 	try match(oncrpcv2Parser.Tokens.T__4.rawValue)
	...
	@discardableResult
	 open func versionDef() throws -> VersionDefContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(57)
		 	try match(oncrpcv2Parser.Tokens.T__5.rawValue)
		 	setState(58)
		 	try match(oncrpcv2Parser.Tokens.IDENTIFIER.rawValue)
		 	setState(59)
		 	try match(oncrpcv2Parser.Tokens.T__1.rawValue)
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	   ...
		 	   let testArray: [Int] = [_la, oncrpcv2Parser.Tokens.T__9.rawValue,oncrpcv2Parser.Tokens.T__17.rawValue,oncrpcv2Parser.Tokens.T__18.rawValue,oncrpcv2Parser.Tokens.T__19.rawValue,oncrpcv2Parser.Tokens.T__20.rawValue,oncrpcv2Parser.Tokens.T__21.rawValue,oncrpcv2Parser.Tokens.T__22.rawValue,oncrpcv2Parser.Tokens.T__23.rawValue,oncrpcv2Parser.Tokens.T__24.rawValue,oncrpcv2Parser.Tokens.T__25.rawValue,oncrpcv2Parser.Tokens.T__26.rawValue,oncrpcv2Parser.Tokens.IDENTIFIER.rawValue]
	...
	@discardableResult
	 open func procedureDef() throws -> ProcedureDefContext {
		...
		do {
		 	...
		 	try match(oncrpcv2Parser.Tokens.IDENTIFIER.rawValue)
		 	setState(74)
		 	try match(oncrpcv2Parser.Tokens.T__6.rawValue)
		 	setState(75)
		 	try procFirstArg()
		 	setState(80)
		 	try _errHandler.sync(self)
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == oncrpcv2Parser.Tokens.T__7.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(76)
		 		try match(oncrpcv2Parser.Tokens.T__7.rawValue)
		 		setState(77)
		 		try typeSpecifier()
		 	...
		 	setState(83)
		 	try match(oncrpcv2Parser.Tokens.T__8.rawValue)
		 	setState(84)
		 	try match(oncrpcv2Parser.Tokens.T__3.rawValue)
		 	setState(85)
		 	try constant()
	...
	@discardableResult
	 open func procReturn() throws -> ProcReturnContext {
		...
		do {
		 	setState(90)
		 	try _errHandler.sync(self)
		 	switch (oncrpcv2Parser.Tokens(rawValue: try _input.LA(1))!) {
		 	case .T__9:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(88)
		 		try match(oncrpcv2Parser.Tokens.T__9.rawValue)
	 ...
	 open func oncrpcv2Specification() throws -> Oncrpcv2SpecificationContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, oncrpcv2Parser.Tokens.T__0.rawValue,oncrpcv2Parser.Tokens.T__24.rawValue,oncrpcv2Parser.Tokens.T__25.rawValue,oncrpcv2Parser.Tokens.T__26.rawValue,oncrpcv2Parser.Tokens.T__31.rawValue,oncrpcv2Parser.Tokens.T__32.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	      return testSet
		 	 }()) {
	 ...
	 open func declaration() throws -> DeclarationContext {
		...
		do {
		 	...
		 	case 2:
		 		...
		 		try match(oncrpcv2Parser.Tokens.IDENTIFIER.rawValue)
		 		setState(108)
		 		try match(oncrpcv2Parser.Tokens.T__10.rawValue)
		 		setState(109)
		 		try value()
		 		setState(110)
		 		try match(oncrpcv2Parser.Tokens.T__11.rawValue)
		 	...
		 	case 3:
		 		...
		 		try match(oncrpcv2Parser.Tokens.IDENTIFIER.rawValue)
		 		setState(114)
		 		try match(oncrpcv2Parser.Tokens.T__12.rawValue)
		 		setState(116)
		 		try _errHandler.sync(self)
		 		_la = try _input.LA(1)
		 		if (//closure
		 		 { () -> Bool in
		 		      let testSet: Bool = {  () -> Bool in
		 		   let testArray: [Int] = [_la, oncrpcv2Parser.Tokens.OCTAL.rawValue,oncrpcv2Parser.Tokens.DECIMAL.rawValue,oncrpcv2Parser.Tokens.HEXADECIMAL.rawValue,oncrpcv2Parser.Tokens.IDENTIFIER.rawValue]
		 		    return  Utils.testBitLeftShiftArray(testArray, 0)
		 		}()
		 		      return testSet
		 		 }()) {
		 		...
		 		setState(118)
		 		try match(oncrpcv2Parser.Tokens.T__13.rawValue)

		 		break
		 	case 4:
		 		try enterOuterAlt(_localctx, 4)
		 		setState(120)
		 		try match(oncrpcv2Parser.Tokens.T__14.rawValue)
		 		setState(121)
		 		try match(oncrpcv2Parser.Tokens.IDENTIFIER.rawValue)
		 		setState(122)
		 		try match(oncrpcv2Parser.Tokens.T__10.rawValue)
		 	...
		 	case 6:
		 		...
		 		setState(133)
		 		try match(oncrpcv2Parser.Tokens.T__15.rawValue)
		 		setState(134)
		 		try match(oncrpcv2Parser.Tokens.IDENTIFIER.rawValue)
		 		setState(135)
		 		try match(oncrpcv2Parser.Tokens.T__12.rawValue)
		 	...
		 	case 7:
		 		...
		 		try typeSpecifier()
		 		setState(141)
		 		try match(oncrpcv2Parser.Tokens.T__16.rawValue)
		 		setState(142)
		 		try match(oncrpcv2Parser.Tokens.IDENTIFIER.rawValue)
	 ...
	 open func constant() throws -> ConstantContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, oncrpcv2Parser.Tokens.OCTAL.rawValue,oncrpcv2Parser.Tokens.DECIMAL.rawValue,oncrpcv2Parser.Tokens.HEXADECIMAL.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	      return testSet
		 	 }())) {
	 ...
	 open func typeSpecifier() throws -> TypeSpecifierContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		if (//closure
		 		 { () -> Bool in
		 		      let testSet: Bool = _la == oncrpcv2Parser.Tokens.T__17.rawValue
		 		      return testSet
		 		 }()) {
		 			setState(153)
		 			try match(oncrpcv2Parser.Tokens.T__17.rawValue)

		 		}

		 		setState(156)
		 		try match(oncrpcv2Parser.Tokens.T__18.rawValue)
		 	...
		 	case 2:
		 		...
		 		setState(160)
		 		try match(oncrpcv2Parser.Tokens.T__19.rawValue)

		 		break
		 	case 3:
		 		try enterOuterAlt(_localctx, 3)
		 		setState(161)
		 		try match(oncrpcv2Parser.Tokens.T__20.rawValue)

		 		break
		 	case 4:
		 		try enterOuterAlt(_localctx, 4)
		 		setState(162)
		 		try match(oncrpcv2Parser.Tokens.T__21.rawValue)

		 		break
		 	case 5:
		 		try enterOuterAlt(_localctx, 5)
		 		setState(163)
		 		try match(oncrpcv2Parser.Tokens.T__22.rawValue)

		 		break
		 	case 6:
		 		try enterOuterAlt(_localctx, 6)
		 		setState(164)
		 		try match(oncrpcv2Parser.Tokens.T__23.rawValue)
	...
	@discardableResult
	 open func enumTypeSpec() throws -> EnumTypeSpecContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(171)
		 	try match(oncrpcv2Parser.Tokens.T__24.rawValue)
		 	setState(172)
		 	try enumBody()
	...
	@discardableResult
	 open func structTypeSpec() throws -> StructTypeSpecContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(190)
		 	try match(oncrpcv2Parser.Tokens.T__25.rawValue)
		 	setState(191)
		 	try structBody()
	 ...
	 open func structBody() throws -> StructBodyContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, oncrpcv2Parser.Tokens.T__9.rawValue,oncrpcv2Parser.Tokens.T__14.rawValue,oncrpcv2Parser.Tokens.T__15.rawValue,oncrpcv2Parser.Tokens.T__17.rawValue,oncrpcv2Parser.Tokens.T__18.rawValue,oncrpcv2Parser.Tokens.T__19.rawValue,oncrpcv2Parser.Tokens.T__20.rawValue,oncrpcv2Parser.Tokens.T__21.rawValue,oncrpcv2Parser.Tokens.T__22.rawValue,oncrpcv2Parser.Tokens.T__23.rawValue,oncrpcv2Parser.Tokens.T__24.rawValue,oncrpcv2Parser.Tokens.T__25.rawValue,oncrpcv2Parser.Tokens.T__26.rawValue,oncrpcv2Parser.Tokens.IDENTIFIER.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	      return testSet
		 	 }()) {
	...
	@discardableResult
	 open func unionTypeSpec() throws -> UnionTypeSpecContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(207)
		 	try match(oncrpcv2Parser.Tokens.T__26.rawValue)
		 	setState(208)
		 	try unionBody()
	...
	@discardableResult
	 open func unionBody() throws -> UnionBodyContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(210)
		 	try match(oncrpcv2Parser.Tokens.T__27.rawValue)
		 	setState(211)
		 	try match(oncrpcv2Parser.Tokens.T__6.rawValue)
		 	setState(212)
		 	try declaration()
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == oncrpcv2Parser.Tokens.T__30.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(216)
		 		try caseSpec()
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == oncrpcv2Parser.Tokens.T__28.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(222)
		 		try match(oncrpcv2Parser.Tokens.T__28.rawValue)
		 		setState(223)
		 		try match(oncrpcv2Parser.Tokens.T__29.rawValue)
		 		setState(224)
		 		try declaration()
		 		setState(225)
		 		try match(oncrpcv2Parser.Tokens.T__4.rawValue)
	...
	@discardableResult
	 open func caseSpec() throws -> CaseSpecContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(231)
		 	try match(oncrpcv2Parser.Tokens.T__30.rawValue)
		 	setState(232)
		 	try value()
		 	setState(233)
		 	try match(oncrpcv2Parser.Tokens.T__29.rawValue)
	...
	@discardableResult
	 open func constantDef() throws -> ConstantDefContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(247)
		 	try match(oncrpcv2Parser.Tokens.T__31.rawValue)
		 	setState(248)
		 	try match(oncrpcv2Parser.Tokens.IDENTIFIER.rawValue)
		 	setState(249)
		 	try match(oncrpcv2Parser.Tokens.T__3.rawValue)
	 ...
	 open func typeDef() throws -> TypeDefContext {
		...
		do {
		 	...
		 	case .T__32:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(253)
		 		try match(oncrpcv2Parser.Tokens.T__32.rawValue)
		 		setState(254)
		 		try declaration()
		 		setState(255)
		 		try match(oncrpcv2Parser.Tokens.T__4.rawValue)
