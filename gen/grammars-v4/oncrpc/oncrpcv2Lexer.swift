...
open class oncrpcv2Lexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            COMMENT=34, OCTAL=35, DECIMAL=36, HEXADECIMAL=37, IDENTIFIER=38, 
            WS=39
	...
	override open
	func getRuleNames() -> [String] { return oncrpcv2Lexer.ruleNames }

	override open
	func getSerializedATN() -> String { return oncrpcv2Lexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return oncrpcv2Lexer.channelNames }

	override open
	func getModeNames() -> [String] { return oncrpcv2Lexer.modeNames }

	override open
	func getATN() -> ATN { return oncrpcv2Lexer._ATN }


	public
	static let _serializedATN: String = oncrpcv2LexerATN().jsonString
