...
open class xdrLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__27=28, T__28=29, T__29=30, T__30=31, COMMENT=32, OCTAL=33, 
            DECIMAL=34, HEXADECIMAL=35, IDENTIFIER=36, WS=37
	...
	override open
	func getRuleNames() -> [String] { return xdrLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return xdrLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return xdrLexer.channelNames }

	override open
	func getModeNames() -> [String] { return xdrLexer.modeNames }

	override open
	func getATN() -> ATN { return xdrLexer._ATN }


	public
	static let _serializedATN: String = xdrLexerATN().jsonString
