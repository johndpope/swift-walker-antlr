...
open class plsqlVisitor<T>: ParseTreeVisitor<T> {
	...
	- returns: the visitor result
	 */
	open func visitCreate_package_body(_ ctx: plsqlParser.Create_package_bodyContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitFunction_body(_ ctx: plsqlParser.Function_bodyContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitProcedure_body(_ ctx: plsqlParser.Procedure_bodyContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitRecord_type_def(_ ctx: plsqlParser.Record_type_defContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitRef_cursor_type_def(_ ctx: plsqlParser.Ref_cursor_type_defContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitType_declaration(_ ctx: plsqlParser.Type_declarationContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitTable_type_def(_ ctx: plsqlParser.Table_type_defContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitTable_ref_aux_internal_one(_ ctx: plsqlParser.Table_ref_aux_internal_oneContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitTable_ref_aux_internal_two(_ ctx: plsqlParser.Table_ref_aux_internal_twoContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitTable_ref_aux_internal_three(_ ctx: plsqlParser.Table_ref_aux_internal_threeContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitString_function(_ ctx: plsqlParser.String_functionContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitNumeric_function_wrapper(_ ctx: plsqlParser.Numeric_function_wrapperContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitNumeric_function(_ ctx: plsqlParser.Numeric_functionContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitOther_function(_ ctx: plsqlParser.Other_functionContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitIdentifier(_ ctx: plsqlParser.IdentifierContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitString_function_name(_ ctx: plsqlParser.String_function_nameContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitNumeric_function_name(_ ctx: plsqlParser.Numeric_function_nameContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
