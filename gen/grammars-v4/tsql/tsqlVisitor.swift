...
open class tsqlVisitor<T>: ParseTreeVisitor<T> {
	...
	- returns: the visitor result
	 */
	open func visitRaiseerror_statementb(_ ctx: tsqlParser.Raiseerror_statementbContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitCreate_queue(_ ctx: tsqlParser.Create_queueContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitQueue_settings(_ ctx: tsqlParser.Queue_settingsContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitAlter_queue(_ ctx: tsqlParser.Alter_queueContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitQueue_action(_ ctx: tsqlParser.Queue_actionContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitQueue_rebuild_options(_ ctx: tsqlParser.Queue_rebuild_optionsContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitCreate_contract(_ ctx: tsqlParser.Create_contractContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitConversation_statement(_ ctx: tsqlParser.Conversation_statementContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitMessage_statement(_ ctx: tsqlParser.Message_statementContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitReceive_statement(_ ctx: tsqlParser.Receive_statementContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitTime(_ ctx: tsqlParser.TimeContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitCreate_certificate(_ ctx: tsqlParser.Create_certificateContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitExisting_keys(_ ctx: tsqlParser.Existing_keysContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitPrivate_key_options(_ ctx: tsqlParser.Private_key_optionsContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitGenerate_new_keys(_ ctx: tsqlParser.Generate_new_keysContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitDate_options(_ ctx: tsqlParser.Date_optionsContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitOpen_key(_ ctx: tsqlParser.Open_keyContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitClose_key(_ ctx: tsqlParser.Close_keyContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitCreate_key(_ ctx: tsqlParser.Create_keyContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitKey_options(_ ctx: tsqlParser.Key_optionsContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitAlgorithm(_ ctx: tsqlParser.AlgorithmContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitEncryption_mechanism(_ ctx: tsqlParser.Encryption_mechanismContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitDecryption_mechanism(_ ctx: tsqlParser.Decryption_mechanismContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitXml_type_definition(_ ctx: tsqlParser.Xml_type_definitionContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitXml_schema_collection(_ ctx: tsqlParser.Xml_schema_collectionContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitAsssignment_operator_expression(_ ctx: tsqlParser.Asssignment_operator_expressionContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitOpen_xml(_ ctx: tsqlParser.Open_xmlContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitSchema_declaration(_ ctx: tsqlParser.Schema_declarationContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitColumn_declaration(_ ctx: tsqlParser.Column_declarationContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitPivot_clause(_ ctx: tsqlParser.Pivot_clauseContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitUnpivot_clause(_ ctx: tsqlParser.Unpivot_clauseContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitFull_column_name_list(_ ctx: tsqlParser.Full_column_name_listContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitXml_data_type_methods(_ ctx: tsqlParser.Xml_data_type_methodsContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitValue_method(_ ctx: tsqlParser.Value_methodContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitQuery_method(_ ctx: tsqlParser.Query_methodContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitExist_method(_ ctx: tsqlParser.Exist_methodContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitModify_method(_ ctx: tsqlParser.Modify_methodContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitNodes_method(_ ctx: tsqlParser.Nodes_methodContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitNull_or_default(_ ctx: tsqlParser.Null_or_defaultContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitBegin_conversation_timer(_ ctx: tsqlParser.Begin_conversation_timerContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitBegin_conversation_dialog(_ ctx: tsqlParser.Begin_conversation_dialogContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitContract_name(_ ctx: tsqlParser.Contract_nameContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitService_name(_ ctx: tsqlParser.Service_nameContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitEnd_conversation(_ ctx: tsqlParser.End_conversationContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitWaitfor_conversation(_ ctx: tsqlParser.Waitfor_conversationContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitGet_conversation(_ ctx: tsqlParser.Get_conversationContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitQueue_id(_ ctx: tsqlParser.Queue_idContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
	...
	- returns: the visitor result
	 */
	open func visitSend_conversation(_ ctx: tsqlParser.Send_conversationContext) -> T{
	 	fatalError(#function + " must be overridden")
	}
