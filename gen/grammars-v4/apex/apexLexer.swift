...
open class apexLexer: Lexer {
	...
	public
	static let SoqlLiteral=1, OVERRIDE=2, VIRTUAL=3, SET=4, GET=5, DATABASE=6, 
            ...
            PRIVATE=37, PROTECTED=38, PUBLIC=39, RETURN=40, SHORT=41, STATIC=42, 
            SUPER=43, SYNCHRONIZED=44, THIS=45, THROW=46, THROWS=47, TRANSIENT=48, 
            TRY=49, VOID=50, VOLATILE=51, WHILE=52, GLOBAL=53, WEBSERVICE=54, 
            APEX_WITH_SHARING=55, APEX_WITHOUT_SHARING=56, SELECT=57, DB_INSERT=58, 
            DB_UPSERT=59, DB_UPDATE=60, DB_DELETE=61, DB_UNDELETE=62, TESTMETHOD=63, 
            IntegerLiteral=64, FloatingPointLiteral=65, BooleanLiteral=66, 
            CharacterLiteral=67, StringLiteral=68, NullLiteral=69, LPAREN=70, 
            RPAREN=71, LBRACE=72, RBRACE=73, LBRACK=74, RBRACK=75, SEMI=76, 
            COMMA=77, DOT=78, ASSIGN=79, GT=80, LT=81, BANG=82, TILDE=83, 
            QUESTION=84, COLON=85, EQUAL=86, LE=87, GE=88, NOTEQUAL=89, 
            AND=90, OR=91, INC=92, DEC=93, ADD=94, SUB=95, MUL=96, DIV=97, 
            ...
            URSHIFT_ASSIGN=112, LAMBDA_LIKE=113, Identifier=114, AT=115, 
            ELLIPSIS=116, WS=117, APEXDOC_COMMENT=118, APEXDOC_COMMENT_START=119, 
	...
	override open
	func getRuleNames() -> [String] { return apexLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return apexLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return apexLexer.channelNames }

	override open
	func getModeNames() -> [String] { return apexLexer.modeNames }

	override open
	func getATN() -> ATN { return apexLexer._ATN }
	...
	public
	static let _serializedATN: String = apexLexerATN().jsonString
