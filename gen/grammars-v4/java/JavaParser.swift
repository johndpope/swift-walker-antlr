...
open class JavaParser: Parser {
	...
	public enum Tokens: Int {
		case EOF = -1, ABSTRACT = 1, ASSERT = 2, BOOLEAN = 3, BREAK = 4, BYTE = 5, 
                 ...
                 CARET = 87, MOD = 88, ADD_ASSIGN = 89, SUB_ASSIGN = 90, 
                 MUL_ASSIGN = 91, DIV_ASSIGN = 92, AND_ASSIGN = 93, OR_ASSIGN = 94, 
                 XOR_ASSIGN = 95, MOD_ASSIGN = 96, LSHIFT_ASSIGN = 97, RSHIFT_ASSIGN = 98, 
	...
	open class CompilationUnitContext:ParserRuleContext {
		open func EOF() -> TerminalNode? { return getToken(JavaParser.Tokens.EOF.rawValue, 0) }
	...
	open func compilationUnit() throws -> CompilationUnitContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.IMPORT.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(205)
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	   ...
		 	   let testArray: [Int] = [_la, JavaParser.Tokens.ABSTRACT.rawValue,JavaParser.Tokens.CLASS.rawValue,JavaParser.Tokens.ENUM.rawValue,JavaParser.Tokens.FINAL.rawValue,JavaParser.Tokens.INTERFACE.rawValue,JavaParser.Tokens.PRIVATE.rawValue,JavaParser.Tokens.PROTECTED.rawValue,JavaParser.Tokens.PUBLIC.rawValue,JavaParser.Tokens.STATIC.rawValue,JavaParser.Tokens.STRICTFP.rawValue,JavaParser.Tokens.SEMI.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || _la == JavaParser.Tokens.AT.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(211)
		 		try typeDeclaration()
	...
	open func packageDeclaration() throws -> PackageDeclarationContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.AT.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(219)
		 		try annotation()
		 	...
		 	setState(225)
		 	try match(JavaParser.Tokens.PACKAGE.rawValue)
		 	setState(226)
		 	try qualifiedName()
		 	setState(227)
		 	try match(JavaParser.Tokens.SEMI.rawValue)
	...
	open func importDeclaration() throws -> ImportDeclarationContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(229)
		 	try match(JavaParser.Tokens.IMPORT.rawValue)
		 	setState(231)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.STATIC.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(230)
		 		try match(JavaParser.Tokens.STATIC.rawValue)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.DOT.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(234)
		 		try match(JavaParser.Tokens.DOT.rawValue)
		 		setState(235)
		 		try match(JavaParser.Tokens.MUL.rawValue)
			...
			var _alt:Int
		 	...
		 	case 1:
		 		...
		 		while (//closure
		 		 { () -> Bool in
		 		      var testSet: Bool = {  () -> Bool in
		 		   let testArray: [Int] = [_la, JavaParser.Tokens.ABSTRACT.rawValue,JavaParser.Tokens.FINAL.rawValue,JavaParser.Tokens.PRIVATE.rawValue,JavaParser.Tokens.PROTECTED.rawValue,JavaParser.Tokens.PUBLIC.rawValue,JavaParser.Tokens.STATIC.rawValue,JavaParser.Tokens.STRICTFP.rawValue]
		 		    return  Utils.testBitLeftShiftArray(testArray, 0)
		 		}()
		 		          testSet = testSet || _la == JavaParser.Tokens.AT.rawValue
		 		      return testSet
		 	...
		 	case .VOLATILE:
		 		...
		 		if (!(//closure
		 		 { () -> Bool in
		 		   ...
		 		   let testArray: [Int] = [_la, JavaParser.Tokens.NATIVE.rawValue,JavaParser.Tokens.SYNCHRONIZED.rawValue,JavaParser.Tokens.TRANSIENT.rawValue,JavaParser.Tokens.VOLATILE.rawValue]
		 		    return  Utils.testBitLeftShiftArray(testArray, 0)
		 		}()
		 		      return testSet
		 		 }())) {
	...
	open func variableModifier() throws -> VariableModifierContext {
		...
		do {
		 	...
		 	case .FINAL:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(279)
		 		try match(JavaParser.Tokens.FINAL.rawValue)
	...
	open class ClassDeclarationContext:ParserRuleContext {
		open func Identifier() -> TerminalNode? { return getToken(JavaParser.Tokens.Identifier.rawValue, 0) }
	...
	open func classDeclaration() throws -> ClassDeclarationContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(283)
		 	try match(JavaParser.Tokens.CLASS.rawValue)
		 	setState(284)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.LT.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(285)
		 		try typeParameters()
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.EXTENDS.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(288)
		 		try match(JavaParser.Tokens.EXTENDS.rawValue)
		 		setState(289)
		 		try typeType()
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.IMPLEMENTS.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(292)
		 		try match(JavaParser.Tokens.IMPLEMENTS.rawValue)
		 		setState(293)
		 		try typeList()
	...
	open func typeParameters() throws -> TypeParametersContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(298)
		 	try match(JavaParser.Tokens.LT.rawValue)
		 	setState(299)
		 	try typeParameter()
		 	setState(304)
		 	try _errHandler.sync(self)
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.COMMA.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(300)
		 		try match(JavaParser.Tokens.COMMA.rawValue)
		 		setState(301)
		 		try typeParameter()
		 	...
		 	setState(307)
		 	try match(JavaParser.Tokens.GT.rawValue)
	...
	open func typeBound() throws -> TypeBoundContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.BITAND.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(315)
		 		try match(JavaParser.Tokens.BITAND.rawValue)
		 		setState(316)
		 		try typeType()
	...
	open class EnumDeclarationContext:ParserRuleContext {
		open func ENUM() -> TerminalNode? { return getToken(JavaParser.Tokens.ENUM.rawValue, 0) }
		open func Identifier() -> TerminalNode? { return getToken(JavaParser.Tokens.Identifier.rawValue, 0) }
		open func typeList() -> TypeListContext? {
			return getRuleContext(TypeListContext.self,0)
		}
	...
	open func enumDeclaration() throws -> EnumDeclarationContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(322)
		 	try match(JavaParser.Tokens.ENUM.rawValue)
		 	setState(323)
		 	try match(JavaParser.Tokens.Identifier.rawValue)
		 	setState(326)
		 	try _errHandler.sync(self)
		 	...
		 	setState(328)
		 	try match(JavaParser.Tokens.LBRACE.rawValue)
		 	setState(330)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.Identifier.rawValue || _la == JavaParser.Tokens.AT.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(329)
		 		try enumConstants()
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.SEMI.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(335)
		 	...
		 	setState(338)
		 	try match(JavaParser.Tokens.RBRACE.rawValue)
	...
	open func enumConstant() throws -> EnumConstantContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.LPAREN.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(355)
		 		try arguments()
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.LBRACE.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(358)
		 		try classBody()
	...
	open func enumBodyDeclarations() throws -> EnumBodyDeclarationsContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, JavaParser.Tokens.ABSTRACT.rawValue,JavaParser.Tokens.BOOLEAN.rawValue,JavaParser.Tokens.BYTE.rawValue,JavaParser.Tokens.CHAR.rawValue,JavaParser.Tokens.CLASS.rawValue,JavaParser.Tokens.DOUBLE.rawValue,JavaParser.Tokens.ENUM.rawValue,JavaParser.Tokens.FINAL.rawValue,JavaParser.Tokens.FLOAT.rawValue,JavaParser.Tokens.INT.rawValue,JavaParser.Tokens.INTERFACE.rawValue,JavaParser.Tokens.LONG.rawValue,JavaParser.Tokens.NATIVE.rawValue,JavaParser.Tokens.PRIVATE.rawValue,JavaParser.Tokens.PROTECTED.rawValue,JavaParser.Tokens.PUBLIC.rawValue,JavaParser.Tokens.SHORT.rawValue,JavaParser.Tokens.STATIC.rawValue,JavaParser.Tokens.STRICTFP.rawValue,JavaParser.Tokens.SYNCHRONIZED.rawValue,JavaParser.Tokens.TRANSIENT.rawValue,JavaParser.Tokens.VOID.rawValue,JavaParser.Tokens.VOLATILE.rawValue,JavaParser.Tokens.LBRACE.rawValue,JavaParser.Tokens.SEMI.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, JavaParser.Tokens.LT.rawValue,JavaParser.Tokens.Identifier.rawValue,JavaParser.Tokens.AT.rawValue]
	...
	open func interfaceDeclaration() throws -> InterfaceDeclarationContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(368)
		 	try match(JavaParser.Tokens.INTERFACE.rawValue)
		 	setState(369)
		 	try match(JavaParser.Tokens.Identifier.rawValue)
		 	setState(371)
		 	try _errHandler.sync(self)
	...
	open func interfaceBody() throws -> InterfaceBodyContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, JavaParser.Tokens.ABSTRACT.rawValue,JavaParser.Tokens.BOOLEAN.rawValue,JavaParser.Tokens.BYTE.rawValue,JavaParser.Tokens.CHAR.rawValue,JavaParser.Tokens.CLASS.rawValue,JavaParser.Tokens.DOUBLE.rawValue,JavaParser.Tokens.ENUM.rawValue,JavaParser.Tokens.FINAL.rawValue,JavaParser.Tokens.FLOAT.rawValue,JavaParser.Tokens.INT.rawValue,JavaParser.Tokens.INTERFACE.rawValue,JavaParser.Tokens.LONG.rawValue,JavaParser.Tokens.NATIVE.rawValue,JavaParser.Tokens.PRIVATE.rawValue,JavaParser.Tokens.PROTECTED.rawValue,JavaParser.Tokens.PUBLIC.rawValue,JavaParser.Tokens.SHORT.rawValue,JavaParser.Tokens.STATIC.rawValue,JavaParser.Tokens.STRICTFP.rawValue,JavaParser.Tokens.SYNCHRONIZED.rawValue,JavaParser.Tokens.TRANSIENT.rawValue,JavaParser.Tokens.VOID.rawValue,JavaParser.Tokens.VOLATILE.rawValue,JavaParser.Tokens.SEMI.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, JavaParser.Tokens.LT.rawValue,JavaParser.Tokens.Identifier.rawValue,JavaParser.Tokens.AT.rawValue]
	...
	open func methodDeclaration() throws -> MethodDeclarationContext {
		...
		do {
		 	...
		 	case .VOID:
		 		setState(431)
		 		try match(JavaParser.Tokens.VOID.rawValue)
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.LBRACK.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(436)
		 		try match(JavaParser.Tokens.LBRACK.rawValue)
		 		setState(437)
		 		try match(JavaParser.Tokens.RBRACK.rawValue)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.THROWS.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(443)
		 		try match(JavaParser.Tokens.THROWS.rawValue)
		 		setState(444)
	...
	open func constantDeclarator() throws -> ConstantDeclaratorContext {
		...
		do {
		 	...
		 	setState(507)
		 	try match(JavaParser.Tokens.ASSIGN.rawValue)
		 	setState(508)
	...
	open func variableDeclarator() throws -> VariableDeclaratorContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.ASSIGN.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(541)
		 		try match(JavaParser.Tokens.ASSIGN.rawValue)
		...
		do {
			var _alt:Int
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, JavaParser.Tokens.BOOLEAN.rawValue,JavaParser.Tokens.BYTE.rawValue,JavaParser.Tokens.CHAR.rawValue,JavaParser.Tokens.DOUBLE.rawValue,JavaParser.Tokens.FLOAT.rawValue,JavaParser.Tokens.INT.rawValue,JavaParser.Tokens.LONG.rawValue,JavaParser.Tokens.NEW.rawValue,JavaParser.Tokens.SHORT.rawValue,JavaParser.Tokens.SUPER.rawValue,JavaParser.Tokens.THIS.rawValue,JavaParser.Tokens.VOID.rawValue,JavaParser.Tokens.IntegerLiteral.rawValue,JavaParser.Tokens.FloatingPointLiteral.rawValue,JavaParser.Tokens.BooleanLiteral.rawValue,JavaParser.Tokens.CharacterLiteral.rawValue,JavaParser.Tokens.StringLiteral.rawValue,JavaParser.Tokens.NullLiteral.rawValue,JavaParser.Tokens.LPAREN.rawValue,JavaParser.Tokens.LBRACE.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, JavaParser.Tokens.LT.rawValue,JavaParser.Tokens.BANG.rawValue,JavaParser.Tokens.TILDE.rawValue,JavaParser.Tokens.INC.rawValue,JavaParser.Tokens.DEC.rawValue,JavaParser.Tokens.ADD.rawValue,JavaParser.Tokens.SUB.rawValue,JavaParser.Tokens.Identifier.rawValue]
		 	              return  Utils.testBitLeftShiftArray(testArray, 68)
		 	          }()
		 	      return testSet
		 	 }()) {
	...
	open class ClassOrInterfaceTypeContext:ParserRuleContext {
		open func Identifier() -> Array<TerminalNode> { return getTokens(JavaParser.Tokens.Identifier.rawValue) }
	...
	open func primitiveType() throws -> PrimitiveTypeContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, JavaParser.Tokens.BOOLEAN.rawValue,JavaParser.Tokens.BYTE.rawValue,JavaParser.Tokens.CHAR.rawValue,JavaParser.Tokens.DOUBLE.rawValue,JavaParser.Tokens.FLOAT.rawValue,JavaParser.Tokens.INT.rawValue,JavaParser.Tokens.LONG.rawValue,JavaParser.Tokens.SHORT.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	      return testSet
		 	 }())) {
	...
	open func typeArgument() throws -> TypeArgumentContext {
		...
		do {
		 	...
		 	case .QUESTION:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(621)
		 		try match(JavaParser.Tokens.QUESTION.rawValue)
		 		setState(624)
		 		try _errHandler.sync(self)
		 		_la = try _input.LA(1)
		 		if (//closure
		 		 { () -> Bool in
		 		      let testSet: Bool = _la == JavaParser.Tokens.EXTENDS.rawValue || _la == JavaParser.Tokens.SUPER.rawValue
		 		      return testSet
		 		 }()) {
		 			setState(622)
		 			_la = try _input.LA(1)
	...
	open func formalParameters() throws -> FormalParametersContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(636)
		 	try match(JavaParser.Tokens.LPAREN.rawValue)
		 	setState(638)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, JavaParser.Tokens.BOOLEAN.rawValue,JavaParser.Tokens.BYTE.rawValue,JavaParser.Tokens.CHAR.rawValue,JavaParser.Tokens.DOUBLE.rawValue,JavaParser.Tokens.FINAL.rawValue,JavaParser.Tokens.FLOAT.rawValue,JavaParser.Tokens.INT.rawValue,JavaParser.Tokens.LONG.rawValue,JavaParser.Tokens.SHORT.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || _la == JavaParser.Tokens.Identifier.rawValue || _la == JavaParser.Tokens.AT.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(637)
		 	...
		 	setState(640)
		 	try match(JavaParser.Tokens.RPAREN.rawValue)
	...
	open func formalParameter() throws -> FormalParameterContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = _la == JavaParser.Tokens.FINAL.rawValue
		 	          testSet = testSet || _la == JavaParser.Tokens.AT.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(657)
	...
	open func lastFormalParameter() throws -> LastFormalParameterContext {
		...
		do {
		 	...
		 	try typeType()
		 	setState(673)
		 	try match(JavaParser.Tokens.ELLIPSIS.rawValue)
		 	setState(674)
		 	try variableDeclaratorId()
	...
	open class LiteralContext:ParserRuleContext {
		open func IntegerLiteral() -> TerminalNode? { return getToken(JavaParser.Tokens.IntegerLiteral.rawValue, 0) }
		open func FloatingPointLiteral() -> TerminalNode? { return getToken(JavaParser.Tokens.FloatingPointLiteral.rawValue, 0) }
		open func CharacterLiteral() -> TerminalNode? { return getToken(JavaParser.Tokens.CharacterLiteral.rawValue, 0) }
		open func StringLiteral() -> TerminalNode? { return getToken(JavaParser.Tokens.StringLiteral.rawValue, 0) }
		open func BooleanLiteral() -> TerminalNode? { return getToken(JavaParser.Tokens.BooleanLiteral.rawValue, 0) }
	...
	open func literal() throws -> LiteralContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, JavaParser.Tokens.IntegerLiteral.rawValue,JavaParser.Tokens.FloatingPointLiteral.rawValue,JavaParser.Tokens.BooleanLiteral.rawValue,JavaParser.Tokens.CharacterLiteral.rawValue,JavaParser.Tokens.StringLiteral.rawValue,JavaParser.Tokens.NullLiteral.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	      return testSet
		 	 }())) {
	...
	open func annotation() throws -> AnnotationContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(690)
		 	try match(JavaParser.Tokens.AT.rawValue)
		 	setState(691)
		 	try annotationName()
		 	setState(698)
		 	try _errHandler.sync(self)
		 	 ...
		 	 { () -> Bool in
		 	   ...
		 	   let testArray: [Int] = [_la, JavaParser.Tokens.BOOLEAN.rawValue,JavaParser.Tokens.BYTE.rawValue,JavaParser.Tokens.CHAR.rawValue,JavaParser.Tokens.DOUBLE.rawValue,JavaParser.Tokens.FLOAT.rawValue,JavaParser.Tokens.INT.rawValue,JavaParser.Tokens.LONG.rawValue,JavaParser.Tokens.NEW.rawValue,JavaParser.Tokens.SHORT.rawValue,JavaParser.Tokens.SUPER.rawValue,JavaParser.Tokens.THIS.rawValue,JavaParser.Tokens.VOID.rawValue,JavaParser.Tokens.IntegerLiteral.rawValue,JavaParser.Tokens.FloatingPointLiteral.rawValue,JavaParser.Tokens.BooleanLiteral.rawValue,JavaParser.Tokens.CharacterLiteral.rawValue,JavaParser.Tokens.StringLiteral.rawValue,JavaParser.Tokens.NullLiteral.rawValue,JavaParser.Tokens.LPAREN.rawValue,JavaParser.Tokens.LBRACE.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	          ...
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, JavaParser.Tokens.LT.rawValue,JavaParser.Tokens.BANG.rawValue,JavaParser.Tokens.TILDE.rawValue,JavaParser.Tokens.INC.rawValue,JavaParser.Tokens.DEC.rawValue,JavaParser.Tokens.ADD.rawValue,JavaParser.Tokens.SUB.rawValue,JavaParser.Tokens.Identifier.rawValue,JavaParser.Tokens.AT.rawValue]
		 	              return  Utils.testBitLeftShiftArray(testArray, 68)
		 	          }()
		 	      return testSet
		 	 }()) {
	...
	open func annotationTypeBody() throws -> AnnotationTypeBodyContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, JavaParser.Tokens.ABSTRACT.rawValue,JavaParser.Tokens.BOOLEAN.rawValue,JavaParser.Tokens.BYTE.rawValue,JavaParser.Tokens.CHAR.rawValue,JavaParser.Tokens.CLASS.rawValue,JavaParser.Tokens.DOUBLE.rawValue,JavaParser.Tokens.ENUM.rawValue,JavaParser.Tokens.FINAL.rawValue,JavaParser.Tokens.FLOAT.rawValue,JavaParser.Tokens.INT.rawValue,JavaParser.Tokens.INTERFACE.rawValue,JavaParser.Tokens.LONG.rawValue,JavaParser.Tokens.NATIVE.rawValue,JavaParser.Tokens.PRIVATE.rawValue,JavaParser.Tokens.PROTECTED.rawValue,JavaParser.Tokens.PUBLIC.rawValue,JavaParser.Tokens.SHORT.rawValue,JavaParser.Tokens.STATIC.rawValue,JavaParser.Tokens.STRICTFP.rawValue,JavaParser.Tokens.SYNCHRONIZED.rawValue,JavaParser.Tokens.TRANSIENT.rawValue,JavaParser.Tokens.VOLATILE.rawValue,JavaParser.Tokens.SEMI.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || _la == JavaParser.Tokens.Identifier.rawValue || _la == JavaParser.Tokens.AT.rawValue
		 	      return testSet
	...
	open func annotationMethodRest() throws -> AnnotationMethodRestContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.DEFAULT.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(788)
		 		try defaultValue()
	...
	open func defaultValue() throws -> DefaultValueContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(793)
		 	try match(JavaParser.Tokens.DEFAULT.rawValue)
		 	setState(794)
		 	try elementValue()
	...
	open func block() throws -> BlockContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, JavaParser.Tokens.ABSTRACT.rawValue,JavaParser.Tokens.ASSERT.rawValue,JavaParser.Tokens.BOOLEAN.rawValue,JavaParser.Tokens.BREAK.rawValue,JavaParser.Tokens.BYTE.rawValue,JavaParser.Tokens.CHAR.rawValue,JavaParser.Tokens.CLASS.rawValue,JavaParser.Tokens.CONTINUE.rawValue,JavaParser.Tokens.DO.rawValue,JavaParser.Tokens.DOUBLE.rawValue,JavaParser.Tokens.ENUM.rawValue,JavaParser.Tokens.FINAL.rawValue,JavaParser.Tokens.FLOAT.rawValue,JavaParser.Tokens.FOR.rawValue,JavaParser.Tokens.IF.rawValue,JavaParser.Tokens.INT.rawValue,JavaParser.Tokens.INTERFACE.rawValue,JavaParser.Tokens.LONG.rawValue,JavaParser.Tokens.NEW.rawValue,JavaParser.Tokens.PRIVATE.rawValue,JavaParser.Tokens.PROTECTED.rawValue,JavaParser.Tokens.PUBLIC.rawValue,JavaParser.Tokens.RETURN.rawValue,JavaParser.Tokens.SHORT.rawValue,JavaParser.Tokens.STATIC.rawValue,JavaParser.Tokens.STRICTFP.rawValue,JavaParser.Tokens.SUPER.rawValue,JavaParser.Tokens.SWITCH.rawValue,JavaParser.Tokens.SYNCHRONIZED.rawValue,JavaParser.Tokens.THIS.rawValue,JavaParser.Tokens.THROW.rawValue,JavaParser.Tokens.TRY.rawValue,JavaParser.Tokens.VOID.rawValue,JavaParser.Tokens.WHILE.rawValue,JavaParser.Tokens.IntegerLiteral.rawValue,JavaParser.Tokens.FloatingPointLiteral.rawValue,JavaParser.Tokens.BooleanLiteral.rawValue,JavaParser.Tokens.CharacterLiteral.rawValue,JavaParser.Tokens.StringLiteral.rawValue,JavaParser.Tokens.NullLiteral.rawValue,JavaParser.Tokens.LPAREN.rawValue,JavaParser.Tokens.LBRACE.rawValue,JavaParser.Tokens.SEMI.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, JavaParser.Tokens.LT.rawValue,JavaParser.Tokens.BANG.rawValue,JavaParser.Tokens.TILDE.rawValue,JavaParser.Tokens.INC.rawValue,JavaParser.Tokens.DEC.rawValue,JavaParser.Tokens.ADD.rawValue,JavaParser.Tokens.SUB.rawValue,JavaParser.Tokens.Identifier.rawValue,JavaParser.Tokens.AT.rawValue]
	...
	open class StatementContext:ParserRuleContext {
		...
		open func ASSERT() -> TerminalNode? { return getToken(JavaParser.Tokens.ASSERT.rawValue, 0) }
		...
		do {
			var _alt:Int
		 	...
		 	case 2:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(823)
		 		try match(JavaParser.Tokens.ASSERT.rawValue)
		 		setState(824)
		 		try expression(0)
		 		setState(827)
		 		try _errHandler.sync(self)
		 		...
		 		if (//closure
		 		 { () -> Bool in
		 		      let testSet: Bool = _la == JavaParser.Tokens.COLON.rawValue
		 		      return testSet
		 		 }()) {
		 			setState(825)
		 			try match(JavaParser.Tokens.COLON.rawValue)
		 			setState(826)
		 			try expression(0)
		 	...
		 	case 3:
		 		try enterOuterAlt(_localctx, 3)
		 		setState(831)
		 		try match(JavaParser.Tokens.IF.rawValue)
		 		setState(832)
		 		try parExpression()
		 		setState(833)
		 		try statement()
		 		...
		 		case 1:
		 			setState(834)
		 			try match(JavaParser.Tokens.ELSE.rawValue)
		 			setState(835)
		 			try statement()
		 	...
		 	case 4:
		 		try enterOuterAlt(_localctx, 4)
		 		setState(838)
		 		try match(JavaParser.Tokens.FOR.rawValue)
		 		setState(839)
		 		try match(JavaParser.Tokens.LPAREN.rawValue)
		 		setState(840)
		 		try forControl()
		 	...
		 	case 5:
		 		try enterOuterAlt(_localctx, 5)
		 		setState(844)
		 		try match(JavaParser.Tokens.WHILE.rawValue)
		 		setState(845)
		 		try parExpression()
		 		setState(846)
		 		try statement()
		 	...
		 	case 6:
		 		try enterOuterAlt(_localctx, 6)
		 		setState(848)
		 		try match(JavaParser.Tokens.DO.rawValue)
		 		setState(849)
		 		try statement()
		 		setState(850)
		 		try match(JavaParser.Tokens.WHILE.rawValue)
		 	...
		 	case 7:
		 		try enterOuterAlt(_localctx, 7)
		 		setState(854)
		 		try match(JavaParser.Tokens.TRY.rawValue)
		 		setState(855)
		 		try block()
		 		setState(865)
		 		try _errHandler.sync(self)
		 		...
		 		case .CATCH:
		 			...
		 			repeat {
		 			 ...
		 			 { () -> Bool in
		 			      let testSet: Bool = _la == JavaParser.Tokens.CATCH.rawValue
		 			      return testSet
		 			 }())
		 			setState(862)
		 			try _errHandler.sync(self)
		 			...
		 			if (//closure
		 			 { () -> Bool in
		 			      let testSet: Bool = _la == JavaParser.Tokens.FINALLY.rawValue
		 			      return testSet
		 			 }()) {
		 				setState(861)
		 				try finallyBlock()
		 	...
		 	case 9:
		 		try enterOuterAlt(_localctx, 9)
		 		setState(879)
		 		try match(JavaParser.Tokens.SWITCH.rawValue)
		 		setState(880)
		 		try parExpression()
		 		setState(881)
		 		try match(JavaParser.Tokens.LBRACE.rawValue)
		 		...
		 		while (//closure
		 		 { () -> Bool in
		 		      let testSet: Bool = _la == JavaParser.Tokens.CASE.rawValue || _la == JavaParser.Tokens.DEFAULT.rawValue
		 		      return testSet
		 		 }()) {
		 			setState(888)
		 			try switchLabel()
		 	...
		 	case 10:
		 		...
		 		setState(896)
		 		try match(JavaParser.Tokens.SYNCHRONIZED.rawValue)
		 		setState(897)
		 		try parExpression()
		 		setState(898)
		 		try block()
		 	...
		 	case 11:
		 		...
		 		setState(900)
		 		try match(JavaParser.Tokens.RETURN.rawValue)
		 		setState(902)
		 		try _errHandler.sync(self)
		 		_la = try _input.LA(1)
		 		if (//closure
		 		 { () -> Bool in
		 		      var testSet: Bool = {  () -> Bool in
		 		   let testArray: [Int] = [_la, JavaParser.Tokens.BOOLEAN.rawValue,JavaParser.Tokens.BYTE.rawValue,JavaParser.Tokens.CHAR.rawValue,JavaParser.Tokens.DOUBLE.rawValue,JavaParser.Tokens.FLOAT.rawValue,JavaParser.Tokens.INT.rawValue,JavaParser.Tokens.LONG.rawValue,JavaParser.Tokens.NEW.rawValue,JavaParser.Tokens.SHORT.rawValue,JavaParser.Tokens.SUPER.rawValue,JavaParser.Tokens.THIS.rawValue,JavaParser.Tokens.VOID.rawValue,JavaParser.Tokens.IntegerLiteral.rawValue,JavaParser.Tokens.FloatingPointLiteral.rawValue,JavaParser.Tokens.BooleanLiteral.rawValue,JavaParser.Tokens.CharacterLiteral.rawValue,JavaParser.Tokens.StringLiteral.rawValue,JavaParser.Tokens.NullLiteral.rawValue,JavaParser.Tokens.LPAREN.rawValue]
		 		    return  Utils.testBitLeftShiftArray(testArray, 0)
		 		}()
		 		          testSet = testSet || {  () -> Bool in
		 		             let testArray: [Int] = [_la, JavaParser.Tokens.LT.rawValue,JavaParser.Tokens.BANG.rawValue,JavaParser.Tokens.TILDE.rawValue,JavaParser.Tokens.INC.rawValue,JavaParser.Tokens.DEC.rawValue,JavaParser.Tokens.ADD.rawValue,JavaParser.Tokens.SUB.rawValue,JavaParser.Tokens.Identifier.rawValue]
		 	...
		 	case 12:
		 		...
		 		setState(905)
		 		try match(JavaParser.Tokens.THROW.rawValue)
		 		setState(906)
		 		try expression(0)
		 		setState(907)
		 		try match(JavaParser.Tokens.SEMI.rawValue)
		 	...
		 	case 13:
		 		...
		 		setState(909)
		 		try match(JavaParser.Tokens.BREAK.rawValue)
		 		setState(911)
		 		try _errHandler.sync(self)
		 		_la = try _input.LA(1)
		 		if (//closure
		 		 { () -> Bool in
		 		      let testSet: Bool = _la == JavaParser.Tokens.Identifier.rawValue
		 		      return testSet
		 		 }()) {
		 			setState(910)
		 			try match(JavaParser.Tokens.Identifier.rawValue)
		 	...
		 	case 14:
		 		...
		 		setState(914)
		 		try match(JavaParser.Tokens.CONTINUE.rawValue)
		 		setState(916)
		 		try _errHandler.sync(self)
		 		_la = try _input.LA(1)
		 		if (//closure
	...
	open func catchClause() throws -> CatchClauseContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(928)
		 	try match(JavaParser.Tokens.CATCH.rawValue)
		 	setState(929)
		 	try match(JavaParser.Tokens.LPAREN.rawValue)
		 	setState(933)
		 	try _errHandler.sync(self)
	...
	open func catchType() throws -> CatchTypeContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == JavaParser.Tokens.BITOR.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(942)
		 		try match(JavaParser.Tokens.BITOR.rawValue)
		 		setState(943)
		 		try qualifiedName()
	...
	open func finallyBlock() throws -> FinallyBlockContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(949)
		 	try match(JavaParser.Tokens.FINALLY.rawValue)
		 	setState(950)
		 	try block()
	...
	open func switchLabel() throws -> SwitchLabelContext {
		...
		do {
		 	...
		 	case 1:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(988)
		 		try match(JavaParser.Tokens.CASE.rawValue)
		 		setState(989)
		...
		do {
		 	...
		 	case 2:
		 		...
		 		if (//closure
		 		 { () -> Bool in
		 		      var testSet: Bool = {  () -> Bool in
		 		   let testArray: [Int] = [_la, JavaParser.Tokens.BOOLEAN.rawValue,JavaParser.Tokens.BYTE.rawValue,JavaParser.Tokens.CHAR.rawValue,JavaParser.Tokens.DOUBLE.rawValue,JavaParser.Tokens.FINAL.rawValue,JavaParser.Tokens.FLOAT.rawValue,JavaParser.Tokens.INT.rawValue,JavaParser.Tokens.LONG.rawValue,JavaParser.Tokens.NEW.rawValue,JavaParser.Tokens.SHORT.rawValue,JavaParser.Tokens.SUPER.rawValue,JavaParser.Tokens.THIS.rawValue,JavaParser.Tokens.VOID.rawValue,JavaParser.Tokens.IntegerLiteral.rawValue,JavaParser.Tokens.FloatingPointLiteral.rawValue,JavaParser.Tokens.BooleanLiteral.rawValue,JavaParser.Tokens.CharacterLiteral.rawValue,JavaParser.Tokens.StringLiteral.rawValue,JavaParser.Tokens.NullLiteral.rawValue,JavaParser.Tokens.LPAREN.rawValue]
		 		    return  Utils.testBitLeftShiftArray(testArray, 0)
		 		}()
		 		          testSet = testSet || {  () -> Bool in
		 		             let testArray: [Int] = [_la, JavaParser.Tokens.LT.rawValue,JavaParser.Tokens.BANG.rawValue,JavaParser.Tokens.TILDE.rawValue,JavaParser.Tokens.INC.rawValue,JavaParser.Tokens.DEC.rawValue,JavaParser.Tokens.ADD.rawValue,JavaParser.Tokens.SUB.rawValue,JavaParser.Tokens.Identifier.rawValue,JavaParser.Tokens.AT.rawValue]
	...
	private func expression(_ _p: Int) throws -> ExpressionContext   {
		...
		do {
			...
			case 2:
				setState(1049)
				try match(JavaParser.Tokens.NEW.rawValue)
				setState(1050)
				try creator()
			...
			case 4:
				...
				if (!(//closure
				 { () -> Bool in
				      let testSet: Bool = {  () -> Bool in
				   let testArray: [Int] = [_la, JavaParser.Tokens.INC.rawValue,JavaParser.Tokens.DEC.rawValue,JavaParser.Tokens.ADD.rawValue,JavaParser.Tokens.SUB.rawValue]
			...
			case 5:
				...
				if (!(//closure
				 { () -> Bool in
				      let testSet: Bool = _la == JavaParser.Tokens.BANG.rawValue || _la == JavaParser.Tokens.TILDE.rawValue
				      return testSet
				 }())) {
				try _errHandler.recoverInline(self)
				}
				...
				if ( _alt==1 ) {
					...
					case 1:
						...
						if (!(//closure
						 { () -> Bool in
						      let testSet: Bool = {  () -> Bool in
						   let testArray: [Int] = [_la, JavaParser.Tokens.MUL.rawValue,JavaParser.Tokens.DIV.rawValue,JavaParser.Tokens.MOD.rawValue]
					...
					case 2:
						...
						if (!(//closure
						 { () -> Bool in
						      let testSet: Bool = _la == JavaParser.Tokens.ADD.rawValue || _la == JavaParser.Tokens.SUB.rawValue
						      return testSet
						 }())) {
						try _errHandler.recoverInline(self)
						}
					...
					case 4:
						...
						if (!(//closure
						 { () -> Bool in
						      let testSet: Bool = {  () -> Bool in
						   let testArray: [Int] = [_la, JavaParser.Tokens.GT.rawValue,JavaParser.Tokens.LT.rawValue,JavaParser.Tokens.LE.rawValue,JavaParser.Tokens.GE.rawValue]
					...
					case 5:
						...
						if (!(//closure
						 { () -> Bool in
						      let testSet: Bool = _la == JavaParser.Tokens.EQUAL.rawValue || _la == JavaParser.Tokens.NOTEQUAL.rawValue
						      return testSet
						 }())) {
						try _errHandler.recoverInline(self)
						}
					...
					case 7:
						...
						setState(1089)
						try match(JavaParser.Tokens.CARET.rawValue)
						setState(1090)
						try expression(7)
					...
					case 9:
						...
						setState(1095)
						try match(JavaParser.Tokens.AND.rawValue)
						setState(1096)
						try expression(5)
					...
					case 10:
						...
						setState(1098)
						try match(JavaParser.Tokens.OR.rawValue)
						setState(1099)
						try expression(4)
					...
					case 12:
						...
						if (!(//closure
						 { () -> Bool in
						      let testSet: Bool = {  () -> Bool in
						   let testArray: [Int] = [_la, JavaParser.Tokens.ASSIGN.rawValue,JavaParser.Tokens.ADD_ASSIGN.rawValue,JavaParser.Tokens.SUB_ASSIGN.rawValue,JavaParser.Tokens.MUL_ASSIGN.rawValue,JavaParser.Tokens.DIV_ASSIGN.rawValue,JavaParser.Tokens.AND_ASSIGN.rawValue,JavaParser.Tokens.OR_ASSIGN.rawValue,JavaParser.Tokens.XOR_ASSIGN.rawValue,JavaParser.Tokens.MOD_ASSIGN.rawValue,JavaParser.Tokens.LSHIFT_ASSIGN.rawValue,JavaParser.Tokens.RSHIFT_ASSIGN.rawValue,JavaParser.Tokens.URSHIFT_ASSIGN.rawValue]
					...
					case 14:
						...
						try match(JavaParser.Tokens.DOT.rawValue)
						setState(1114)
						try match(JavaParser.Tokens.THIS.rawValue)
					...
					case 16:
						...
						try match(JavaParser.Tokens.DOT.rawValue)
						setState(1124)
						try match(JavaParser.Tokens.SUPER.rawValue)
						setState(1125)
						try superSuffix()
					...
					case 20:
						...
						if (!(//closure
						 { () -> Bool in
						      let testSet: Bool = _la == JavaParser.Tokens.INC.rawValue || _la == JavaParser.Tokens.DEC.rawValue
						      return testSet
						 }())) {
						try _errHandler.recoverInline(self)
						}
					...
					case 21:
						...
						setState(1143)
						try match(JavaParser.Tokens.INSTANCEOF.rawValue)
						setState(1144)
						try typeType()
