...
open class modelicaLexer: Lexer {
	...
	override open
	func getRuleNames() -> [String] { return modelicaLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return modelicaLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return modelicaLexer.channelNames }

	override open
	func getModeNames() -> [String] { return modelicaLexer.modeNames }

	override open
	func getATN() -> ATN { return modelicaLexer._ATN }


	public
	static let _serializedATN: String = modelicaLexerATN().jsonString
