...
open class modelicaParser: Parser {
	...
	open class Long_class_specifierContext:ParserRuleContext {
		open func IDENT() -> Array<TerminalNode> { return getTokens(modelicaParser.Tokens.IDENT.rawValue) }
	...
	open class Short_class_specifierContext:ParserRuleContext {
		open func IDENT() -> TerminalNode? { return getToken(modelicaParser.Tokens.IDENT.rawValue, 0) }
	...
	open class Language_specificationContext:ParserRuleContext {
		open func STRING() -> TerminalNode? { return getToken(modelicaParser.Tokens.STRING.rawValue, 0) }
	...
	open class PrimaryContext:ParserRuleContext {
		open func UNSIGNED_NUMBER() -> TerminalNode? { return getToken(modelicaParser.Tokens.UNSIGNED_NUMBER.rawValue, 0) }
		open func STRING() -> TerminalNode? { return getToken(modelicaParser.Tokens.STRING.rawValue, 0) }
		open func function_call_args() -> Function_call_argsContext? {
			return getRuleContext(Function_call_argsContext.self,0)
		}
	...
	open class String_commentContext:ParserRuleContext {
		open func STRING() -> Array<TerminalNode> { return getTokens(modelicaParser.Tokens.STRING.rawValue) }
