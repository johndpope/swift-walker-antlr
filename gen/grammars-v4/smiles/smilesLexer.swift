...
open class smilesLexer: Lexer {

	internal static var _decisionToDFA: [DFA] = {
          var decisionToDFA = [DFA]()
          let length = smilesLexer._ATN.getNumberOfDecisions()
          for i in 0..<length {
          	    decisionToDFA.append(DFA(smilesLexer._ATN.getDecisionState(i)!, i))
          }
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__200=201, T__201=202, T__202=203, T__203=204, DOT=205, LINEFEED=206, 
            CARRIAGE_RETURN=207, SPACE=208, DIGIT=209, NUMBER=210, TAB=211
	...
	required init(_ input: CharStream) {
		...
		super.init(input)
		_interp = LexerATNSimulator(self, smilesLexer._ATN, smilesLexer._decisionToDFA, smilesLexer._sharedContextCache)
	}
	...
	override open
	func getRuleNames() -> [String] { return smilesLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return smilesLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return smilesLexer.channelNames }

	override open
	func getModeNames() -> [String] { return smilesLexer.modeNames }

	override open
	func getATN() -> ATN { return smilesLexer._ATN }


	public
	static let _serializedATN: String = smilesLexerATN().jsonString
