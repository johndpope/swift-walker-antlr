...
open class ATLLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__75=76, T__76=77, T__77=78, T__78=79, T__79=80, STRING=81, 
            INTEGER=82, FLOAT=83, IDENTIFIER=84, WS=85, COMMENT=86, LINE_COMMENT=87
	...
	override open
	func getRuleNames() -> [String] { return ATLLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return ATLLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return ATLLexer.channelNames }

	override open
	func getModeNames() -> [String] { return ATLLexer.modeNames }

	override open
	func getATN() -> ATN { return ATLLexer._ATN }


	public
	static let _serializedATN: String = ATLLexerATN().jsonString
