...
open class IDLLexer: Lexer {
	...
	public
	static let INTEGER_LITERAL=1, OCTAL_LITERAL=2, HEX_LITERAL=3, FLOATING_PT_LITERAL=4, 
            ...
            LEFT_BRACKET=16, RIGHT_BRACKET=17, LEFT_SQUARE_BRACKET=18, RIGHT_SQUARE_BRACKET=19, 
	...
	override open
	func getRuleNames() -> [String] { return IDLLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return IDLLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return IDLLexer.channelNames }

	override open
	func getModeNames() -> [String] { return IDLLexer.modeNames }

	override open
	func getATN() -> ATN { return IDLLexer._ATN }


	public
	static let _serializedATN: String = IDLLexerATN().jsonString
