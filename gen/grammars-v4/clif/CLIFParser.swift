...
open class CLIFParser: Parser {
	...
	open class TermseqContext:ParserRuleContext {
		...
		open func SEQMARK() -> Array<TerminalNode> { return getTokens(CLIFParser.Tokens.SEQMARK.rawValue) }
	...
	open class InterpretednameContext:ParserRuleContext {
		open func NUMERAL() -> TerminalNode? { return getToken(CLIFParser.Tokens.NUMERAL.rawValue, 0) }
		open func QUOTEDSTRING() -> TerminalNode? { return getToken(CLIFParser.Tokens.QUOTEDSTRING.rawValue, 0) }
	...
	open class InterpretablenameContext:ParserRuleContext {
		open func NAMECHARSEQUENCE() -> TerminalNode? { return getToken(CLIFParser.Tokens.NAMECHARSEQUENCE.rawValue, 0) }
		open func ENCLOSEDNAME() -> TerminalNode? { return getToken(CLIFParser.Tokens.ENCLOSEDNAME.rawValue, 0) }
	...
	open class TermContext:ParserRuleContext {
		...
		open func OPEN() -> TerminalNode? { return getToken(CLIFParser.Tokens.OPEN.rawValue, 0) }
		...
		open func CLOSE() -> TerminalNode? { return getToken(CLIFParser.Tokens.CLOSE.rawValue, 0) }
		open func QUOTEDSTRING() -> TerminalNode? { return getToken(CLIFParser.Tokens.QUOTEDSTRING.rawValue, 0) }
	...
	open class AtomContext:ParserRuleContext {
		open func OPEN() -> Array<TerminalNode> { return getTokens(CLIFParser.Tokens.OPEN.rawValue) }
		...
		open func CLOSE() -> Array<TerminalNode> { return getTokens(CLIFParser.Tokens.CLOSE.rawValue) }
