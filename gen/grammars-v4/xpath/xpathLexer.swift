...
open class xpathLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            NodeType=9, Number=10, AxisName=11, PATHSEP=12, ABRPATH=13, 
            LPAR=14, RPAR=15, LBRAC=16, RBRAC=17, MINUS=18, PLUS=19, DOT=20, 
            MUL=21, DOTDOT=22, AT=23, COMMA=24, PIPE=25, LESS=26, MORE_=27, 
            LE=28, GE=29, COLON=30, CC=31, APOS=32, QUOT=33, Literal=34, 
            Whitespace=35, NCName=36
	...
	override open
	func getRuleNames() -> [String] { return xpathLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return xpathLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return xpathLexer.channelNames }

	override open
	func getModeNames() -> [String] { return xpathLexer.modeNames }

	override open
	func getATN() -> ATN { return xpathLexer._ATN }


	public
	static let _serializedATN: String = xpathLexerATN().jsonString
