		...
		do {
		 	...
		 	case 1:
		 		...
		 		if (!(!this.here(ECMAScriptParser.LineTerminator))) {
		 		    throw ANTLRException.recognition(e:FailedPredicateException(self, "!this.here(ECMAScriptParser.LineTerminator)"))
		 		}
		 		setState(249)
		 		try match(ECMAScriptParser.Tokens.Identifier.rawValue)
	 ...
	 open func getter() throws -> GetterContext {
		...
		do {
		 	...
		 	if (!(this._input.LT(1).text.startsWith("get"))) {
		 	    throw ANTLRException.recognition(e:FailedPredicateException(self, "this._input.LT(1).text.startsWith(\"get\")"))
		 	}
		 	setState(606)
		 	try match(ECMAScriptParser.Tokens.Identifier.rawValue)
		 	setState(607)
	 ...
	 open func setter() throws -> SetterContext {
		...
		do {
		 	...
		 	if (!(this._input.LT(1).text.startsWith("set"))) {
		 	    throw ANTLRException.recognition(e:FailedPredicateException(self, "this._input.LT(1).text.startsWith(\"set\")"))
		 	}
		 	setState(610)
		 	try match(ECMAScriptParser.Tokens.Identifier.rawValue)
		 	setState(611)
		...
		do {
		 	...
		 	case 4:
		 		...
		 		if (!(this._input.LT(1).type == ECMAScriptParser.CloseBrace)) {
		 		    throw ANTLRException.recognition(e:FailedPredicateException(self, "this._input.LT(1).type == ECMAScriptParser.CloseBrace"))
		 		}
