...
open class ECMAScriptParser: Parser {
	...
	@discardableResult
	 open func expressionStatement() throws -> ExpressionStatementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(173)
		 	if (!((self._input.LA(1) != ECMAScriptParser.OpenBrace) and (self._input.LA(1) != ECMAScriptParser.Function))) {
		 	    throw ANTLRException.recognition(e:FailedPredicateException(self, "(self._input.LA(1) != ECMAScriptParser.OpenBrace) and (self._input.LA(1) != ECMAScriptParser.Function)"))
		 	}
		 	setState(174)
		...
		do {
		 	...
		 	case 1:
		 		...
		 		if (!(not self.here(ECMAScriptParser.LineTerminator))) {
		 		    throw ANTLRException.recognition(e:FailedPredicateException(self, "not self.here(ECMAScriptParser.LineTerminator)"))
		 		}
		 		setState(251)
		 		try match(ECMAScriptParser.Tokens.Identifier.rawValue)
	 ...
	 open func getter() throws -> GetterContext {
		...
		do {
		 	...
		 	if (!(self._input.LT(1).text == "get")) {
		 	    throw ANTLRException.recognition(e:FailedPredicateException(self, "self._input.LT(1).text == \"get\""))
		 	}
		 	setState(608)
		 	try match(ECMAScriptParser.Tokens.Identifier.rawValue)
		 	setState(609)
	 ...
	 open func setter() throws -> SetterContext {
		...
		do {
		 	...
		 	if (!(self._input.LT(1).text == "set")) {
		 	    throw ANTLRException.recognition(e:FailedPredicateException(self, "self._input.LT(1).text == \"set\""))
		 	}
		 	setState(612)
		 	try match(ECMAScriptParser.Tokens.Identifier.rawValue)
		 	setState(613)
		...
		do {
		 	...
		 	case 4:
		 		...
		 		if (!(self._input.LT(1).type == ECMAScriptParser.CloseBrace)) {
		 		    throw ANTLRException.recognition(e:FailedPredicateException(self, "self._input.LT(1).type == ECMAScriptParser.CloseBrace"))
		 		}
	...
	private func singleExpression_sempred(_ _localctx: SingleExpressionContext!,  _ predIndex: Int) throws -> Bool {
		switch (predIndex) {
		    ...
		    case 24:return not self.here(ECMAScriptParser.LineTerminator)
		    case 25:return precpred(_ctx, 31)
		    case 26:return not self.here(ECMAScriptParser.LineTerminator)
		    default: return true
		}
	}
	private func getter_sempred(_ _localctx: GetterContext!,  _ predIndex: Int) throws -> Bool {
		switch (predIndex) {
		    case 27:return self._input.LT(1).text == "get"
		    default: return true
		}
	}
	private func setter_sempred(_ _localctx: SetterContext!,  _ predIndex: Int) throws -> Bool {
		switch (predIndex) {
		    case 28:return self._input.LT(1).text == "set"
		    default: return true
		}
	}
	private func eos_sempred(_ _localctx: EosContext!,  _ predIndex: Int) throws -> Bool {
		switch (predIndex) {
		    case 29:return self.lineTerminatorAhead()
		    case 30:return self._input.LT(1).type == ECMAScriptParser.CloseBrace
		    default: return true
		}
	}
