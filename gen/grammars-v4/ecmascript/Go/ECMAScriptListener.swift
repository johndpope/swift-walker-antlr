...
public protocol ECMAScriptListener: ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ECMAScriptParser#voidStatement}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func enterVoidStatement(_ ctx: ECMAScriptParser.VoidStatementContext)
	/**
	 * Exit a parse tree produced by {@link ECMAScriptParser#voidStatement}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func exitVoidStatement(_ ctx: ECMAScriptParser.VoidStatementContext)
	/**
