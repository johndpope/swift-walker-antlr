// Generated from ./grammars-v4/java8-ts/Java8.TypeScriptTarget.g4 by ANTLR 4.7.1
import Antlr4
...
open class Java8Lexer: Lexer {
	...
	override open
	func getGrammarFileName() -> String { return "Java8.TypeScriptTarget.g4" }
	...
	private func JavaLetter_sempred(_ _localctx: RuleContext!,  _ predIndex: Int) throws -> Bool {
		switch (predIndex) {
		    case 0:return Java8Lexer.Character_isJavaIdentifierStart(this._input.LA(-1))
		    case 1:return Java8Lexer.Character_isJavaIdentifierStart(Java8Lexer.Character_toCodePoint(this._input.LA(-2), this._input.LA(-1)))
		    default: return true
		}
	}
	private func JavaLetterOrDigit_sempred(_ _localctx: RuleContext!,  _ predIndex: Int) throws -> Bool {
		switch (predIndex) {
		    case 2:return Java8Lexer.Character_isJavaIdentifierPart(this._input.LA(-1))
		    case 3:return Java8Lexer.Character_isJavaIdentifierPart(Java8Lexer.Character_toCodePoint(this._input.LA(-2), this._input.LA(-1)))
		    default: return true
		}
	}
