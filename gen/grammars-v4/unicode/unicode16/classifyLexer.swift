...
open class classifyLexer: Lexer {
	...
	public
	static let CLASSIFY___=1, CLASSIFY_Cc=2, CLASSIFY_Cf=3, CLASSIFY_Cn=4, 
	...
	override open
	func getRuleNames() -> [String] { return classifyLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return classifyLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return classifyLexer.channelNames }

	override open
	func getModeNames() -> [String] { return classifyLexer.modeNames }

	override open
	func getATN() -> ATN { return classifyLexer._ATN }


	public
	static let _serializedATN: String = classifyLexerATN().jsonString
