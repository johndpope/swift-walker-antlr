...
open class MuParserLexer: Lexer {
	...
	public
	static let T__0=1, T__1=2, FUNCTION=3, FUNCTIONMULTI=4, ASSIGN=5, ASSIGNADD=6, 
            ASSIGNSUB=7, ASSIGNMUL=8, ASSIGNDIV=9, AND=10, OR=11, LTEQ=12, 
            GTEQ=13, NEQ=14, EQ=15, LT=16, GT=17, ADD=18, SUB=19, MUL=20, 
            DIV=21, POW=22, NOT=23, QUESTION=24, COLON=25, OPAR=26, CPAR=27, 
            INT=28, FLOAT=29, TRUE=30, FALSE=31, E=32, PI=33, ID=34, SPACE=35
	...
	override open
	func getRuleNames() -> [String] { return MuParserLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return MuParserLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return MuParserLexer.channelNames }

	override open
	func getModeNames() -> [String] { return MuParserLexer.modeNames }

	override open
	func getATN() -> ATN { return MuParserLexer._ATN }


	public
	static let _serializedATN: String = MuParserLexerATN().jsonString
