// Generated from ./grammars-v4/stringtemplate/STLexer.g4 by ANTLR 4.7.1
import Antlr4
...
open class STLexer: LexerAdaptor {
	...
	static let DOC_COMMENT=1, BLOCK_COMMENT=2, LINE_COMMENT=3, TMPL_COMMENT=4, 
            ...
            ENDIF=17, SUPER=18, END=19, TRUE=20, FALSE=21, AT=22, ELLIPSIS=23, 
            DOT=24, COMMA=25, COLON=26, SEMI=27, AND=28, OR=29, LPAREN=30, 
            RPAREN=31, LBRACK=32, RBRACK=33, EQUALS=34, BANG=35, ERR_CHAR=36, 
            ID=37, PIPE=38

	public
	static let OFF_CHANNEL=2
	public
	static let Inside=1, SubTemplate=2
	public
	...
	override open
	func getGrammarFileName() -> String { return "STLexer.g4" }

	override open
	func getRuleNames() -> [String] { return STLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return STLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return STLexer.channelNames }

	override open
	func getModeNames() -> [String] { return STLexer.modeNames }

	override open
	func getATN() -> ATN { return STLexer._ATN }
	...
	public
	static let _serializedATN: String = STLexerATN().jsonString
