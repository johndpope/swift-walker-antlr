// Generated from ./grammars-v4/stringtemplate/STGLexer.g4 by ANTLR 4.7.1
import Antlr4
...
open class STGLexer: Lexer {
	...
	public
	static let DOC_COMMENT=1, BLOCK_COMMENT=2, LINE_COMMENT=3, TMPL_COMMENT=4, 
            HORZ_WS=5, VERT_WS=6, ID=7, STRING=8, BIGSTRING=9, BIGSTRING_NO_NL=10, 
            ANON_TEMPLATE=11, TMPL_ASSIGN=12, ASSIGN=13, DOT=14, COMMA=15, 
            COLON=16, LPAREN=17, RPAREN=18, LBRACK=19, RBRACK=20, AT=21, 
            TRUE=22, FALSE=23, ELLIPSIS=24, DELIMITERS=25, IMPORT=26, DEFAULT=27, 
            KEY=28, VALUE=29, FIRST=30, LAST=31, REST=32, TRUNC=33, STRIP=34, 
            TRIM=35, LENGTH=36, STRLEN=37, REVERSE=38, GROUP=39, WRAP=40, 
	...
	override open
	func getGrammarFileName() -> String { return "STGLexer.g4" }

	override open
	func getRuleNames() -> [String] { return STGLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return STGLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return STGLexer.channelNames }

	override open
	func getModeNames() -> [String] { return STGLexer.modeNames }

	override open
	func getATN() -> ATN { return STGLexer._ATN }
	...
	public
	static let _serializedATN: String = STGLexerATN().jsonString
