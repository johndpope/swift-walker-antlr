...
open class PeopleCodeLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__69=70, T__70=71, DecimalLiteral=72, IntegerLiteral=73, StringLiteral=74, 
            BoolLiteral=75, VAR_ID=76, SYS_VAR_ID=77, GENERIC_ID=78, REM=79, 
	...
	override open
	func getRuleNames() -> [String] { return PeopleCodeLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return PeopleCodeLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return PeopleCodeLexer.channelNames }

	override open
	func getModeNames() -> [String] { return PeopleCodeLexer.modeNames }

	override open
	func getATN() -> ATN { return PeopleCodeLexer._ATN }


	public
	static let _serializedATN: String = PeopleCodeLexerATN().jsonString
