...
open class snobolLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__33=34, T__34=35, COMMA=36, LPAREN=37, RPAREN=38, AMP=39, 
            PLUS=40, MINUS=41, TIMES=42, DIV=43, POW=44, EQ=45, COLON=46, 
            END=47, STRINGLITERAL1=48, STRINGLITERAL2=49, STRING=50, INTEGER=51, 
            REAL=52, COMMENT=53, EOL=54, WS=55
	...
	override open
	func getRuleNames() -> [String] { return snobolLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return snobolLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return snobolLexer.channelNames }

	override open
	func getModeNames() -> [String] { return snobolLexer.modeNames }

	override open
	func getATN() -> ATN { return snobolLexer._ATN }


	public
	static let _serializedATN: String = snobolLexerATN().jsonString
