...
open class PddlParser: Parser {
	...
	open class DomainNameContext:ParserRuleContext {
		open func NAME() -> TerminalNode? { return getToken(PddlParser.Tokens.NAME.rawValue, 0) }
	...
	open class RequireDefContext:ParserRuleContext {
		open func REQUIRE_KEY() -> Array<TerminalNode> { return getTokens(PddlParser.Tokens.REQUIRE_KEY.rawValue) }
	...
	open class TypedNameListContext:ParserRuleContext {
		open func NAME() -> Array<TerminalNode> { return getTokens(PddlParser.Tokens.NAME.rawValue) }
	...
	open class TypedVariableListContext:ParserRuleContext {
		open func VARIABLE() -> Array<TerminalNode> { return getTokens(PddlParser.Tokens.VARIABLE.rawValue) }
	...
	open class TermContext:ParserRuleContext {
		open func NAME() -> TerminalNode? { return getToken(PddlParser.Tokens.NAME.rawValue, 0) }
		open func VARIABLE() -> TerminalNode? { return getToken(PddlParser.Tokens.VARIABLE.rawValue, 0) }
	...
	open class FExpContext:ParserRuleContext {
		open func NUMBER() -> TerminalNode? { return getToken(PddlParser.Tokens.NUMBER.rawValue, 0) }
	...
	open class ConGDContext:ParserRuleContext {
		...
		open func NUMBER() -> Array<TerminalNode> { return getTokens(PddlParser.Tokens.NUMBER.rawValue) }
