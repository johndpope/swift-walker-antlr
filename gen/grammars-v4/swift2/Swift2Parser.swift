...
open class Swift2Parser: Parser {
	...
	open func top_level() throws -> Top_levelContext {
		...
		do {
			var _alt:Int
		 	...
		 	setState(520)
		 	try match(Swift2Parser.Tokens.EOF.rawValue)
	...
	open func statement() throws -> StatementContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		case 1:
		 			setState(523)
		 			try match(Swift2Parser.Tokens.SEMI.rawValue)
	...
	open func for_statement() throws -> For_statementContext {
		...
		do {
		 	...
		 	case 1:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(568)
		 		try match(Swift2Parser.Tokens.T__0.rawValue)
		 		setState(570)
		 		try _errHandler.sync(self)
		 	...
		 	case 2:
		 		...
		 		setState(594)
		 		try match(Swift2Parser.Tokens.RPAREN.rawValue)
		 		setState(595)
		 		try code_block()
	...
	open func for_in_statement() throws -> For_in_statementContext {
		...
		do {
		 	...
		 	case 1:
		 		setState(603)
		 		try match(Swift2Parser.Tokens.T__1.rawValue)
		 	...
		 	try pattern(0)
		 	setState(607)
		 	try match(Swift2Parser.Tokens.T__2.rawValue)
		 	setState(608)
		 	try expression()
		 	setState(610)
		 	try _errHandler.sync(self)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.T__12.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(609)
		 		try where_clause()
	...
	open func while_statement() throws -> While_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(614)
		 	try match(Swift2Parser.Tokens.T__3.rawValue)
		 	setState(615)
	...
	open func condition_clause() throws -> Condition_clauseContext {
		...
		do {
		 	...
		 	case 2:
		 		...
		 		try expression()
		 		setState(620)
		 		try match(Swift2Parser.Tokens.COMMA.rawValue)
		 		setState(621)
		 		try condition_list()
	...
	open func condition_list() throws -> Condition_listContext {
		...
		do {
		 	...
		 	while (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.COMMA.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(631)
		 		try match(Swift2Parser.Tokens.COMMA.rawValue)
	...
	open func condition() throws -> ConditionContext {
		...
		do {
		 	setState(641)
		 	try _errHandler.sync(self)
		 	switch (Swift2Parser.Tokens(rawValue: try _input.LA(1))!) {
		 	case .T__17:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(638)
		 		try availability_condition()
	...
	open func optional_binding_head() throws -> Optional_binding_headContext {
		...
		do {
		 	...
		 	case .T__4:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(656)
		 		try match(Swift2Parser.Tokens.T__4.rawValue)
		 		setState(657)
		 		try pattern(0)
		 		setState(658)
		 		try initializer()
		 	...
		 	case .T__5:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(660)
		 		try match(Swift2Parser.Tokens.T__5.rawValue)
		 		setState(661)
		 		try pattern(0)
		 		setState(662)
		 		try initializer()
	...
	open func repeat_while_statement() throws -> Repeat_while_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(681)
		 	try match(Swift2Parser.Tokens.T__6.rawValue)
		 	setState(682)
		 	try code_block()
		 	setState(683)
		 	try match(Swift2Parser.Tokens.T__3.rawValue)
	...
	open func if_statement() throws -> If_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(691)
		 	try match(Swift2Parser.Tokens.T__7.rawValue)
		 	setState(692)
		 	try condition_clause()
		 	setState(693)
		 	try code_block()
	...
	open func else_clause() throws -> Else_clauseContext {
		...
		do {
		 	...
		 	case 1:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(697)
		 		try match(Swift2Parser.Tokens.T__8.rawValue)
		 		setState(698)
		 		try code_block()
	...
	open func guard_statement() throws -> Guard_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(703)
		 	try match(Swift2Parser.Tokens.T__9.rawValue)
		 	setState(704)
		 	try condition_clause()
		 	setState(705)
		 	try match(Swift2Parser.Tokens.T__8.rawValue)
	...
	open func switch_statement() throws -> Switch_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(708)
		 	try match(Swift2Parser.Tokens.T__10.rawValue)
		 	setState(709)
		 	try expression()
		 	setState(710)
		 	try match(Swift2Parser.Tokens.LCURLY.rawValue)
		 	setState(712)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.T__1.rawValue || _la == Swift2Parser.Tokens.T__11.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(711)
		 		try switch_cases()
		 	...
		 	setState(714)
		 	try match(Swift2Parser.Tokens.RCURLY.rawValue)
	...
	open func case_label() throws -> Case_labelContext {
		...
		do {
		 	...
		 	try case_item_list()
		 	setState(730)
		 	try match(Swift2Parser.Tokens.COLON.rawValue)
	...
	open func default_label() throws -> Default_labelContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(745)
		 	try match(Swift2Parser.Tokens.T__11.rawValue)
		 	setState(746)
		 	try match(Swift2Parser.Tokens.COLON.rawValue)
	...
	open func where_clause() throws -> Where_clauseContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(748)
		 	try match(Swift2Parser.Tokens.T__12.rawValue)
		 	setState(749)
	...
	open func break_statement() throws -> Break_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(776)
		 	try match(Swift2Parser.Tokens.T__13.rawValue)
		 	setState(778)
		 	try _errHandler.sync(self)
	...
	open func continue_statement() throws -> Continue_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(780)
		 	try match(Swift2Parser.Tokens.T__14.rawValue)
		 	setState(782)
		 	try _errHandler.sync(self)
	...
	open func fallthrough_statement() throws -> Fallthrough_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(784)
		 	try match(Swift2Parser.Tokens.T__15.rawValue)
	...
	open func return_statement() throws -> Return_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(786)
		 	try match(Swift2Parser.Tokens.T__16.rawValue)
		 	setState(788)
		 	try _errHandler.sync(self)
	...
	open func availability_condition() throws -> Availability_conditionContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(790)
		 	try match(Swift2Parser.Tokens.T__17.rawValue)
		 	setState(791)
		 	try match(Swift2Parser.Tokens.LPAREN.rawValue)
		 	setState(792)
	...
	open func availability_argument() throws -> Availability_argumentContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.Platform.rawValue || _la == Swift2Parser.Tokens.MUL.rawValue
		 	      return testSet
		 	 }())) {
	...
	open func throw_statement() throws -> Throw_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(805)
		 	try match(Swift2Parser.Tokens.T__18.rawValue)
		 	setState(806)
		 	try expression()
	...
	open func defer_statement() throws -> Defer_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(808)
		 	try match(Swift2Parser.Tokens.T__19.rawValue)
		 	setState(809)
		 	try code_block()
	...
	open func do_statement() throws -> Do_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(811)
		 	try match(Swift2Parser.Tokens.T__20.rawValue)
		 	setState(812)
		 	try code_block()
		 	setState(814)
		 	try _errHandler.sync(self)
	...
	open func catch_clause() throws -> Catch_clauseContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(820)
		 	try match(Swift2Parser.Tokens.T__21.rawValue)
		 	setState(822)
		 	try _errHandler.sync(self)
	...
	open func build_configuration_statement() throws -> Build_configuration_statementContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(833)
		 	try match(Swift2Parser.Tokens.T__22.rawValue)
		 	setState(834)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.T__24.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(838)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.T__25.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(841)
		 	...
		 	setState(844)
		 	try match(Swift2Parser.Tokens.T__23.rawValue)
	...
	open func build_configuration_elseif_clause() throws -> Build_configuration_elseif_clauseContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(850)
		 	try match(Swift2Parser.Tokens.T__24.rawValue)
		 	setState(851)
		 	try build_configuration(0)
		 	setState(853)
		 	try _errHandler.sync(self)
	...
	open func build_configuration_else_clause() throws -> Build_configuration_else_clauseContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(855)
		 	try match(Swift2Parser.Tokens.T__25.rawValue)
		 	setState(857)
		 	try _errHandler.sync(self)
	...
	open func platform_testing_function() throws -> Platform_testing_functionContext {
		...
		do {
		 	...
		 	case .T__26:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(884)
		 		try match(Swift2Parser.Tokens.T__26.rawValue)
		 		setState(885)
		 		try match(Swift2Parser.Tokens.LPAREN.rawValue)
		 		setState(886)
		 	...
		 	case .T__27:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(889)
		 		try match(Swift2Parser.Tokens.T__27.rawValue)
		 		setState(890)
		 		try match(Swift2Parser.Tokens.LPAREN.rawValue)
		 		setState(891)
		 		try architecture()
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	   ...
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__28.rawValue,Swift2Parser.Tokens.T__29.rawValue,Swift2Parser.Tokens.T__30.rawValue,Swift2Parser.Tokens.T__31.rawValue]
	...
	open func architecture() throws -> ArchitectureContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__32.rawValue,Swift2Parser.Tokens.T__33.rawValue,Swift2Parser.Tokens.T__34.rawValue,Swift2Parser.Tokens.T__35.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	      return testSet
		 	 }())) {
	...
	open func line_control_statement() throws -> Line_control_statementContext {
		...
		do {
		 	...
		 	case 1:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(900)
		 		try match(Swift2Parser.Tokens.T__36.rawValue)
	...
	open func file_name() throws -> File_nameContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(909)
		 	try match(Swift2Parser.Tokens.Static_string_literal.rawValue)
	...
	open func generic_parameter_clause() throws -> Generic_parameter_clauseContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(911)
		 	try match(Swift2Parser.Tokens.LT.rawValue)
		 	setState(912)
		 	...
		 	setState(916)
		 	try match(Swift2Parser.Tokens.GT.rawValue)
		...
		do {
		 	...
		 	repeat {
		 	 ...
		 	 { () -> Bool in
		 	   ...
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__4.rawValue,Swift2Parser.Tokens.T__5.rawValue,Swift2Parser.Tokens.T__37.rawValue,Swift2Parser.Tokens.T__38.rawValue,Swift2Parser.Tokens.T__39.rawValue,Swift2Parser.Tokens.T__40.rawValue,Swift2Parser.Tokens.T__41.rawValue,Swift2Parser.Tokens.T__42.rawValue,Swift2Parser.Tokens.T__43.rawValue,Swift2Parser.Tokens.T__44.rawValue,Swift2Parser.Tokens.T__45.rawValue,Swift2Parser.Tokens.T__46.rawValue,Swift2Parser.Tokens.T__47.rawValue,Swift2Parser.Tokens.T__51.rawValue,Swift2Parser.Tokens.T__53.rawValue,Swift2Parser.Tokens.T__54.rawValue,Swift2Parser.Tokens.T__55.rawValue,Swift2Parser.Tokens.T__56.rawValue,Swift2Parser.Tokens.T__57.rawValue,Swift2Parser.Tokens.T__58.rawValue,Swift2Parser.Tokens.T__59.rawValue,Swift2Parser.Tokens.T__60.rawValue,Swift2Parser.Tokens.T__61.rawValue,Swift2Parser.Tokens.T__62.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift2Parser.Tokens.T__63.rawValue,Swift2Parser.Tokens.T__64.rawValue,Swift2Parser.Tokens.T__65.rawValue,Swift2Parser.Tokens.T__66.rawValue,Swift2Parser.Tokens.T__67.rawValue,Swift2Parser.Tokens.T__68.rawValue,Swift2Parser.Tokens.T__69.rawValue,Swift2Parser.Tokens.T__70.rawValue,Swift2Parser.Tokens.T__71.rawValue,Swift2Parser.Tokens.T__72.rawValue,Swift2Parser.Tokens.T__73.rawValue,Swift2Parser.Tokens.T__74.rawValue,Swift2Parser.Tokens.T__75.rawValue,Swift2Parser.Tokens.T__76.rawValue,Swift2Parser.Tokens.T__79.rawValue,Swift2Parser.Tokens.T__80.rawValue,Swift2Parser.Tokens.T__81.rawValue,Swift2Parser.Tokens.T__82.rawValue,Swift2Parser.Tokens.T__96.rawValue,Swift2Parser.Tokens.T__97.rawValue,Swift2Parser.Tokens.Identifier.rawValue,Swift2Parser.Tokens.AT.rawValue]
	...
	open func import_declaration() throws -> Import_declarationContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__44.rawValue,Swift2Parser.Tokens.T__45.rawValue,Swift2Parser.Tokens.T__46.rawValue,Swift2Parser.Tokens.T__47.rawValue,Swift2Parser.Tokens.T__51.rawValue,Swift2Parser.Tokens.T__57.rawValue,Swift2Parser.Tokens.T__58.rawValue,Swift2Parser.Tokens.T__59.rawValue,Swift2Parser.Tokens.T__60.rawValue,Swift2Parser.Tokens.T__61.rawValue,Swift2Parser.Tokens.T__62.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift2Parser.Tokens.T__63.rawValue,Swift2Parser.Tokens.T__64.rawValue,Swift2Parser.Tokens.T__65.rawValue,Swift2Parser.Tokens.T__66.rawValue,Swift2Parser.Tokens.T__67.rawValue,Swift2Parser.Tokens.T__68.rawValue,Swift2Parser.Tokens.T__69.rawValue,Swift2Parser.Tokens.T__70.rawValue,Swift2Parser.Tokens.T__71.rawValue,Swift2Parser.Tokens.T__72.rawValue,Swift2Parser.Tokens.T__73.rawValue,Swift2Parser.Tokens.T__74.rawValue,Swift2Parser.Tokens.T__76.rawValue,Swift2Parser.Tokens.T__79.rawValue,Swift2Parser.Tokens.T__96.rawValue,Swift2Parser.Tokens.T__97.rawValue,Swift2Parser.Tokens.Identifier.rawValue,Swift2Parser.Tokens.AT.rawValue]
		 	              return  Utils.testBitLeftShiftArray(testArray, 64)
		 	          }()
		 	      return testSet
		 	 }()) {
		 	...
		 	setState(1012)
		 	try match(Swift2Parser.Tokens.T__37.rawValue)
		 	setState(1014)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__5.rawValue,Swift2Parser.Tokens.T__38.rawValue,Swift2Parser.Tokens.T__39.rawValue,Swift2Parser.Tokens.T__40.rawValue,Swift2Parser.Tokens.T__41.rawValue,Swift2Parser.Tokens.T__42.rawValue,Swift2Parser.Tokens.T__43.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	      return testSet
		 	 }()) {
	...
	open func constant_declaration() throws -> Constant_declarationContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__40.rawValue,Swift2Parser.Tokens.T__57.rawValue,Swift2Parser.Tokens.T__59.rawValue,Swift2Parser.Tokens.T__60.rawValue,Swift2Parser.Tokens.T__66.rawValue,Swift2Parser.Tokens.T__67.rawValue,Swift2Parser.Tokens.T__68.rawValue,Swift2Parser.Tokens.T__69.rawValue,Swift2Parser.Tokens.T__70.rawValue,Swift2Parser.Tokens.T__71.rawValue,Swift2Parser.Tokens.T__72.rawValue,Swift2Parser.Tokens.T__73.rawValue,Swift2Parser.Tokens.T__74.rawValue,Swift2Parser.Tokens.T__75.rawValue,Swift2Parser.Tokens.T__76.rawValue,Swift2Parser.Tokens.T__79.rawValue,Swift2Parser.Tokens.T__80.rawValue,Swift2Parser.Tokens.T__81.rawValue,Swift2Parser.Tokens.T__82.rawValue]
	...
	open func getter_clause() throws -> Getter_clauseContext {
		...
		do {
		 	...
		 	setState(1119)
		 	try match(Swift2Parser.Tokens.T__44.rawValue)
		 	setState(1120)
		 	try code_block()
	...
	open func setter_clause() throws -> Setter_clauseContext {
		...
		do {
		 	...
		 	setState(1125)
		 	try match(Swift2Parser.Tokens.T__45.rawValue)
		 	setState(1127)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.LPAREN.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(1126)
		 		try setter_name()
	...
	open func willSet_clause() throws -> WillSet_clauseContext {
		...
		do {
		 	...
		 	setState(1176)
		 	try match(Swift2Parser.Tokens.T__46.rawValue)
		 	setState(1178)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
	...
	open func didSet_clause() throws -> DidSet_clauseContext {
		...
		do {
		 	...
		 	setState(1185)
		 	try match(Swift2Parser.Tokens.T__47.rawValue)
		 	setState(1187)
		 	try _errHandler.sync(self)
		 	_la = try _input.LA(1)
		 	if (//closure
	...
	open func typealias_head() throws -> Typealias_headContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__80.rawValue,Swift2Parser.Tokens.T__81.rawValue,Swift2Parser.Tokens.T__82.rawValue]
		 	...
		 	setState(1200)
		 	try match(Swift2Parser.Tokens.T__38.rawValue)
		 	setState(1201)
		 	try typealias_name()
	...
	open func function_declaration() throws -> Function_declarationContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.LT.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(1210)
	...
	open func function_head() throws -> Function_headContext {
		...
		do {
		 	...
		 	setState(1223)
		 	try match(Swift2Parser.Tokens.T__43.rawValue)
	...
	open func function_signature() throws -> Function_signatureContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		case 1:
		 			setState(1230)
		 			try match(Swift2Parser.Tokens.T__48.rawValue)
	...
	open func parameter() throws -> ParameterContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		if (//closure
		 		 { () -> Bool in
		 		      let testSet: Bool = _la == Swift2Parser.Tokens.T__4.rawValue
		 		      return testSet
		 		 }()) {
		 			setState(1271)
		 			try match(Swift2Parser.Tokens.T__4.rawValue)
		 	...
		 	case 3:
		 		try enterOuterAlt(_localctx, 3)
		 		setState(1295)
		 		try match(Swift2Parser.Tokens.T__50.rawValue)
		 		setState(1297)
		 		try _errHandler.sync(self)
	...
	open func external_parameter_name() throws -> External_parameter_nameContext {
		...
		do {
		 	...
		 	case .UNDERSCORE:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(1312)
		 		try match(Swift2Parser.Tokens.UNDERSCORE.rawValue)
	...
	open func union_style_enum() throws -> Union_style_enumContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.T__51.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(1338)
		 		try match(Swift2Parser.Tokens.T__51.rawValue)

		 	}

		 	setState(1341)
		 	try match(Swift2Parser.Tokens.T__41.rawValue)
		 	setState(1342)
		 	try enum_name()
		 	setState(1344)
		 	try _errHandler.sync(self)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.COLON.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(1346)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__1.rawValue,Swift2Parser.Tokens.T__4.rawValue,Swift2Parser.Tokens.T__5.rawValue,Swift2Parser.Tokens.T__37.rawValue,Swift2Parser.Tokens.T__38.rawValue,Swift2Parser.Tokens.T__39.rawValue,Swift2Parser.Tokens.T__40.rawValue,Swift2Parser.Tokens.T__41.rawValue,Swift2Parser.Tokens.T__42.rawValue,Swift2Parser.Tokens.T__43.rawValue,Swift2Parser.Tokens.T__44.rawValue,Swift2Parser.Tokens.T__45.rawValue,Swift2Parser.Tokens.T__46.rawValue,Swift2Parser.Tokens.T__47.rawValue,Swift2Parser.Tokens.T__51.rawValue,Swift2Parser.Tokens.T__53.rawValue,Swift2Parser.Tokens.T__54.rawValue,Swift2Parser.Tokens.T__55.rawValue,Swift2Parser.Tokens.T__56.rawValue,Swift2Parser.Tokens.T__57.rawValue,Swift2Parser.Tokens.T__58.rawValue,Swift2Parser.Tokens.T__59.rawValue,Swift2Parser.Tokens.T__60.rawValue,Swift2Parser.Tokens.T__61.rawValue,Swift2Parser.Tokens.T__62.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift2Parser.Tokens.T__63.rawValue,Swift2Parser.Tokens.T__64.rawValue,Swift2Parser.Tokens.T__65.rawValue,Swift2Parser.Tokens.T__66.rawValue,Swift2Parser.Tokens.T__67.rawValue,Swift2Parser.Tokens.T__68.rawValue,Swift2Parser.Tokens.T__69.rawValue,Swift2Parser.Tokens.T__70.rawValue,Swift2Parser.Tokens.T__71.rawValue,Swift2Parser.Tokens.T__72.rawValue,Swift2Parser.Tokens.T__73.rawValue,Swift2Parser.Tokens.T__74.rawValue,Swift2Parser.Tokens.T__75.rawValue,Swift2Parser.Tokens.T__76.rawValue,Swift2Parser.Tokens.T__79.rawValue,Swift2Parser.Tokens.T__80.rawValue,Swift2Parser.Tokens.T__81.rawValue,Swift2Parser.Tokens.T__82.rawValue,Swift2Parser.Tokens.T__96.rawValue,Swift2Parser.Tokens.T__97.rawValue,Swift2Parser.Tokens.Identifier.rawValue,Swift2Parser.Tokens.AT.rawValue]
	...
	open func struct_declaration() throws -> Struct_declarationContext {
		...
		do {
		 	...
		 	setState(1436)
		 	try match(Swift2Parser.Tokens.T__39.rawValue)
		 	setState(1437)
		 	try struct_name()
		 	setState(1439)
		 	try _errHandler.sync(self)
	...
	open func class_declaration() throws -> Class_declarationContext {
		...
		do {
		 	...
		 	setState(1460)
		 	try match(Swift2Parser.Tokens.T__40.rawValue)
		 	setState(1461)
		 	try class_name()
		 	setState(1463)
		 	try _errHandler.sync(self)
	...
	open func protocol_declaration() throws -> Protocol_declarationContext {
		...
		do {
		 	...
		 	setState(1484)
		 	try match(Swift2Parser.Tokens.T__42.rawValue)
		 	setState(1485)
		 	try protocol_name()
		 	setState(1487)
		 	try _errHandler.sync(self)
	...
	open func protocol_body() throws -> Protocol_bodyContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__5.rawValue,Swift2Parser.Tokens.T__40.rawValue,Swift2Parser.Tokens.T__43.rawValue,Swift2Parser.Tokens.T__44.rawValue,Swift2Parser.Tokens.T__45.rawValue,Swift2Parser.Tokens.T__46.rawValue,Swift2Parser.Tokens.T__47.rawValue,Swift2Parser.Tokens.T__51.rawValue,Swift2Parser.Tokens.T__52.rawValue,Swift2Parser.Tokens.T__53.rawValue,Swift2Parser.Tokens.T__56.rawValue,Swift2Parser.Tokens.T__57.rawValue,Swift2Parser.Tokens.T__58.rawValue,Swift2Parser.Tokens.T__59.rawValue,Swift2Parser.Tokens.T__60.rawValue,Swift2Parser.Tokens.T__61.rawValue,Swift2Parser.Tokens.T__62.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift2Parser.Tokens.T__63.rawValue,Swift2Parser.Tokens.T__64.rawValue,Swift2Parser.Tokens.T__65.rawValue,Swift2Parser.Tokens.T__66.rawValue,Swift2Parser.Tokens.T__67.rawValue,Swift2Parser.Tokens.T__68.rawValue,Swift2Parser.Tokens.T__69.rawValue,Swift2Parser.Tokens.T__70.rawValue,Swift2Parser.Tokens.T__71.rawValue,Swift2Parser.Tokens.T__72.rawValue,Swift2Parser.Tokens.T__73.rawValue,Swift2Parser.Tokens.T__74.rawValue,Swift2Parser.Tokens.T__75.rawValue,Swift2Parser.Tokens.T__76.rawValue,Swift2Parser.Tokens.T__79.rawValue,Swift2Parser.Tokens.T__80.rawValue,Swift2Parser.Tokens.T__81.rawValue,Swift2Parser.Tokens.T__82.rawValue,Swift2Parser.Tokens.T__96.rawValue,Swift2Parser.Tokens.T__97.rawValue,Swift2Parser.Tokens.Identifier.rawValue,Swift2Parser.Tokens.AT.rawValue]
	...
	open func protocol_initializer_declaration() throws -> Protocol_initializer_declarationContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		if (//closure
		 		 { () -> Bool in
		 		      let testSet: Bool = _la == Swift2Parser.Tokens.T__48.rawValue
		 		      return testSet
		 		 }()) {
		 			setState(1527)
		 			try match(Swift2Parser.Tokens.T__48.rawValue)
	...
	open func protocol_associated_type_declaration() throws -> Protocol_associated_type_declarationContext {
		...
		do {
		 	...
		 	setState(1549)
		 	try match(Swift2Parser.Tokens.T__52.rawValue)
		 	setState(1550)
		 	try typealias_name()
		 	setState(1552)
		 	try _errHandler.sync(self)
	...
	open func initializer_head() throws -> Initializer_headContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		setState(1583)
		 		try match(Swift2Parser.Tokens.T__53.rawValue)
	...
	open func deinitializer_declaration() throws -> Deinitializer_declarationContext {
		...
		do {
		 	...
		 	setState(1607)
		 	try match(Swift2Parser.Tokens.T__54.rawValue)
		 	setState(1608)
		 	try code_block()
	...
	open func extension_declaration() throws -> Extension_declarationContext {
		...
		do {
		 	...
		 	setState(1613)
		 	try match(Swift2Parser.Tokens.T__55.rawValue)
		 	setState(1614)
		 	try type_identifier()
		 	setState(1616)
		 	try _errHandler.sync(self)
	...
	open func subscript_head() throws -> Subscript_headContext {
		...
		do {
		 	...
		 	setState(1646)
		 	try match(Swift2Parser.Tokens.T__56.rawValue)
		 	setState(1647)
		 	try parameter_clause()
	...
	open func prefix_operator_declaration() throws -> Prefix_operator_declarationContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(1660)
		 	try match(Swift2Parser.Tokens.T__57.rawValue)
		 	setState(1661)
		 	try match(Swift2Parser.Tokens.T__58.rawValue)
		 	setState(1662)
		 	try operator()
		 	setState(1663)
		 	try match(Swift2Parser.Tokens.LCURLY.rawValue)
	...
	open func postfix_operator_declaration() throws -> Postfix_operator_declarationContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(1666)
		 	try match(Swift2Parser.Tokens.T__59.rawValue)
		 	setState(1667)
		 	try match(Swift2Parser.Tokens.T__58.rawValue)
		 	setState(1668)
		 	try operator()
	...
	open func infix_operator_declaration() throws -> Infix_operator_declarationContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(1672)
		 	try match(Swift2Parser.Tokens.T__60.rawValue)
		 	setState(1673)
		 	try match(Swift2Parser.Tokens.T__58.rawValue)
		 	setState(1674)
		 	try operator()
	...
	open func infix_operator_attributes() throws -> Infix_operator_attributesContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.T__61.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(1679)
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.T__62.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(1682)
	...
	open func precedence_clause() throws -> Precedence_clauseContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(1685)
		 	try match(Swift2Parser.Tokens.T__61.rawValue)
		 	setState(1686)
	...
	open func associativity_clause() throws -> Associativity_clauseContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(1690)
		 	try match(Swift2Parser.Tokens.T__62.rawValue)
		 	setState(1691)
		 	try associativity()
	...
	open func associativity() throws -> AssociativityContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__63.rawValue,Swift2Parser.Tokens.T__64.rawValue,Swift2Parser.Tokens.T__65.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 64)
		 	}()
		 	      return testSet
		 	 }())) {
	...
	open func declaration_modifier() throws -> Declaration_modifierContext {
		...
		do {
		 	...
		 	case 2:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(1696)
		 		try match(Swift2Parser.Tokens.T__66.rawValue)

		 		break
		 	case 3:
		 		try enterOuterAlt(_localctx, 3)
		 		setState(1697)
		 		try match(Swift2Parser.Tokens.T__67.rawValue)

		 		break
		 	case 4:
		 		try enterOuterAlt(_localctx, 4)
		 		setState(1698)
		 		try match(Swift2Parser.Tokens.T__68.rawValue)
		 	...
		 	case 6:
		 		try enterOuterAlt(_localctx, 6)
		 		setState(1700)
		 		try match(Swift2Parser.Tokens.T__69.rawValue)

		 		break
		 	case 7:
		 		try enterOuterAlt(_localctx, 7)
		 		setState(1701)
		 		try match(Swift2Parser.Tokens.T__70.rawValue)

		 		break
		 	case 8:
		 		try enterOuterAlt(_localctx, 8)
		 		setState(1702)
		 		try match(Swift2Parser.Tokens.T__71.rawValue)

		 		break
		 	case 9:
		 		try enterOuterAlt(_localctx, 9)
		 		setState(1703)
		 		try match(Swift2Parser.Tokens.T__72.rawValue)

		 		break
		 	case 10:
		 		try enterOuterAlt(_localctx, 10)
		 		setState(1704)
		 		try match(Swift2Parser.Tokens.T__73.rawValue)
		 	...
		 	case 13:
		 		try enterOuterAlt(_localctx, 13)
		 		setState(1707)
		 		try match(Swift2Parser.Tokens.T__74.rawValue)

		 		break
		 	case 14:
		 		try enterOuterAlt(_localctx, 14)
		 		setState(1708)
		 		try match(Swift2Parser.Tokens.T__75.rawValue)

		 		break
		 	case 15:
		 		try enterOuterAlt(_localctx, 15)
		 		setState(1709)
		 		try match(Swift2Parser.Tokens.T__76.rawValue)
		 	...
		 	case 16:
		 		...
		 		try match(Swift2Parser.Tokens.LPAREN.rawValue)
		 		setState(1712)
		 		try match(Swift2Parser.Tokens.T__77.rawValue)
		 		setState(1713)
		 		try match(Swift2Parser.Tokens.RPAREN.rawValue)
		 	...
		 	case 17:
		 		...
		 		try match(Swift2Parser.Tokens.LPAREN.rawValue)
		 		setState(1716)
		 		try match(Swift2Parser.Tokens.T__78.rawValue)
		 		setState(1717)
		 		try match(Swift2Parser.Tokens.RPAREN.rawValue)
		 	...
		 	case 18:
		 		...
		 		setState(1718)
		 		try match(Swift2Parser.Tokens.T__79.rawValue)
	...
	open func access_level_modifier() throws -> Access_level_modifierContext {
		...
		do {
		 	...
		 	case 1:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(1726)
		 		try match(Swift2Parser.Tokens.T__80.rawValue)
		 	...
		 	case 3:
		 		try enterOuterAlt(_localctx, 3)
		 		setState(1731)
		 		try match(Swift2Parser.Tokens.T__81.rawValue)
		 	...
		 	case 5:
		 		try enterOuterAlt(_localctx, 5)
		 		setState(1736)
		 		try match(Swift2Parser.Tokens.T__82.rawValue)
	...
	private func pattern(_ _p: Int) throws -> PatternContext   {
		...
		do {
			...
			case 7:
				setState(1759)
				try match(Swift2Parser.Tokens.T__83.rawValue)
				setState(1760)
				try type(0)
	...
	open func enum_case_pattern() throws -> Enum_case_patternContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__44.rawValue,Swift2Parser.Tokens.T__45.rawValue,Swift2Parser.Tokens.T__46.rawValue,Swift2Parser.Tokens.T__47.rawValue,Swift2Parser.Tokens.T__51.rawValue,Swift2Parser.Tokens.T__57.rawValue,Swift2Parser.Tokens.T__58.rawValue,Swift2Parser.Tokens.T__59.rawValue,Swift2Parser.Tokens.T__60.rawValue,Swift2Parser.Tokens.T__61.rawValue,Swift2Parser.Tokens.T__62.rawValue,Swift2Parser.Tokens.T__63.rawValue,Swift2Parser.Tokens.T__64.rawValue,Swift2Parser.Tokens.T__65.rawValue,Swift2Parser.Tokens.T__66.rawValue,Swift2Parser.Tokens.T__67.rawValue,Swift2Parser.Tokens.T__68.rawValue,Swift2Parser.Tokens.T__69.rawValue,Swift2Parser.Tokens.T__70.rawValue,Swift2Parser.Tokens.T__71.rawValue,Swift2Parser.Tokens.T__72.rawValue,Swift2Parser.Tokens.T__73.rawValue,Swift2Parser.Tokens.T__74.rawValue,Swift2Parser.Tokens.T__76.rawValue,Swift2Parser.Tokens.T__79.rawValue,Swift2Parser.Tokens.T__96.rawValue,Swift2Parser.Tokens.T__97.rawValue,Swift2Parser.Tokens.Identifier.rawValue]
	...
	open func attribute() throws -> AttributeContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.AT.rawValue
		 	      return testSet
		 	 }()) {
		 		setState(1811)
		 		try match(Swift2Parser.Tokens.AT.rawValue)
	...
	open func balanced_token() throws -> Balanced_tokenContext {
		...
		do {
		 	...
		 	case 2:
		 		...
		 		setState(1845)
		 		try match(Swift2Parser.Tokens.RBRACK.rawValue)
	...
	open func try_operator() throws -> Try_operatorContext {
		...
		do {
		 	...
		 	case 1:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(1883)
		 		try match(Swift2Parser.Tokens.T__85.rawValue)
		 		setState(1884)
		 		try match(Swift2Parser.Tokens.QUESTION.rawValue)
	...
	open func literal_expression() throws -> Literal_expressionContext {
		...
		do {
		 	...
		 	case 4:
		 		try enterOuterAlt(_localctx, 4)
		 		setState(1946)
		 		try match(Swift2Parser.Tokens.T__86.rawValue)

		 		break
		 	case 5:
		 		try enterOuterAlt(_localctx, 5)
		 		setState(1947)
		 		try match(Swift2Parser.Tokens.T__87.rawValue)

		 		break
		 	case 6:
		 		try enterOuterAlt(_localctx, 6)
		 		setState(1948)
		 		try match(Swift2Parser.Tokens.T__88.rawValue)

		 		break
		 	case 7:
		 		try enterOuterAlt(_localctx, 7)
		 		setState(1949)
		 		try match(Swift2Parser.Tokens.T__89.rawValue)
	...
	open func self_expression() throws -> Self_expressionContext {
		...
		do {
		 	...
		 	case 1:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(1995)
		 		try match(Swift2Parser.Tokens.T__90.rawValue)
	...
	open func superclass_method_expression() throws -> Superclass_method_expressionContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(2014)
		 	try match(Swift2Parser.Tokens.T__91.rawValue)
		 	setState(2015)
		 	try match(Swift2Parser.Tokens.DOT.rawValue)
		 	setState(2016)
		 	try identifier()
	...
	open func capture_specifier() throws -> Capture_specifierContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__76.rawValue,Swift2Parser.Tokens.T__79.rawValue,Swift2Parser.Tokens.T__92.rawValue,Swift2Parser.Tokens.T__93.rawValue]
	...
	open func selector_expression() throws -> Selector_expressionContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(2109)
		 	try match(Swift2Parser.Tokens.T__94.rawValue)
		 	setState(2110)
		 	try match(Swift2Parser.Tokens.LPAREN.rawValue)
		 	setState(2111)
		 	try expression()
			...
			while (_alt != 2 && _alt != ATN.INVALID_ALT_NUMBER) {
				if ( _alt==1 ) {
					...
					case 6:
						...
						try match(Swift2Parser.Tokens.DOT.rawValue)
						setState(2138)
						try match(Swift2Parser.Tokens.Pure_decimal_digits.rawValue)
					...
					case 11:
						...
						try match(Swift2Parser.Tokens.DOT.rawValue)
						setState(2162)
						try match(Swift2Parser.Tokens.T__95.rawValue)
			...
			while (_alt != 2 && _alt != ATN.INVALID_ALT_NUMBER) {
				if ( _alt==1 ) {
					...
					case 5:
						...
						try match(Swift2Parser.Tokens.DOT.rawValue)
						setState(2216)
						try match(Swift2Parser.Tokens.T__96.rawValue)
					...
					case 6:
						...
						try match(Swift2Parser.Tokens.DOT.rawValue)
						setState(2219)
						try match(Swift2Parser.Tokens.T__97.rawValue)
	...
	open func tuple_type() throws -> Tuple_typeContext {
		...
		do {
		 	...
		 	if (//closure
		 	 { () -> Bool in
		 	      var testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__42.rawValue,Swift2Parser.Tokens.T__44.rawValue,Swift2Parser.Tokens.T__45.rawValue,Swift2Parser.Tokens.T__46.rawValue,Swift2Parser.Tokens.T__47.rawValue,Swift2Parser.Tokens.T__50.rawValue,Swift2Parser.Tokens.T__51.rawValue,Swift2Parser.Tokens.T__57.rawValue,Swift2Parser.Tokens.T__58.rawValue,Swift2Parser.Tokens.T__59.rawValue,Swift2Parser.Tokens.T__60.rawValue,Swift2Parser.Tokens.T__61.rawValue,Swift2Parser.Tokens.T__62.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	}()
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift2Parser.Tokens.T__63.rawValue,Swift2Parser.Tokens.T__64.rawValue,Swift2Parser.Tokens.T__65.rawValue,Swift2Parser.Tokens.T__66.rawValue,Swift2Parser.Tokens.T__67.rawValue,Swift2Parser.Tokens.T__68.rawValue,Swift2Parser.Tokens.T__69.rawValue,Swift2Parser.Tokens.T__70.rawValue,Swift2Parser.Tokens.T__71.rawValue,Swift2Parser.Tokens.T__72.rawValue,Swift2Parser.Tokens.T__73.rawValue,Swift2Parser.Tokens.T__74.rawValue,Swift2Parser.Tokens.T__76.rawValue,Swift2Parser.Tokens.T__79.rawValue,Swift2Parser.Tokens.T__96.rawValue,Swift2Parser.Tokens.T__97.rawValue,Swift2Parser.Tokens.Identifier.rawValue,Swift2Parser.Tokens.LPAREN.rawValue,Swift2Parser.Tokens.LBRACK.rawValue,Swift2Parser.Tokens.AT.rawValue]
		 	              return  Utils.testBitLeftShiftArray(testArray, 64)
		 	          }()
		 	      return testSet
		 	 }()) {
	...
	open func tuple_type_element() throws -> Tuple_type_elementContext {
		...
		do {
		 	...
		 	case 1:
		 		...
		 		if (//closure
		 		 { () -> Bool in
		 		      let testSet: Bool = _la == Swift2Parser.Tokens.T__50.rawValue
		 		      return testSet
		 		 }()) {
		 			setState(2266)
		 			try match(Swift2Parser.Tokens.T__50.rawValue)
		 	 ...
		 	 { () -> Bool in
		 	   ...
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__44.rawValue,Swift2Parser.Tokens.T__45.rawValue,Swift2Parser.Tokens.T__46.rawValue,Swift2Parser.Tokens.T__47.rawValue,Swift2Parser.Tokens.T__51.rawValue,Swift2Parser.Tokens.T__57.rawValue,Swift2Parser.Tokens.T__58.rawValue,Swift2Parser.Tokens.T__59.rawValue,Swift2Parser.Tokens.T__60.rawValue,Swift2Parser.Tokens.T__61.rawValue,Swift2Parser.Tokens.T__62.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 0)
		 	          ...
		 	          testSet = testSet || {  () -> Bool in
		 	             let testArray: [Int] = [_la, Swift2Parser.Tokens.T__63.rawValue,Swift2Parser.Tokens.T__64.rawValue,Swift2Parser.Tokens.T__65.rawValue,Swift2Parser.Tokens.T__66.rawValue,Swift2Parser.Tokens.T__67.rawValue,Swift2Parser.Tokens.T__68.rawValue,Swift2Parser.Tokens.T__69.rawValue,Swift2Parser.Tokens.T__70.rawValue,Swift2Parser.Tokens.T__71.rawValue,Swift2Parser.Tokens.T__72.rawValue,Swift2Parser.Tokens.T__73.rawValue,Swift2Parser.Tokens.T__74.rawValue,Swift2Parser.Tokens.T__76.rawValue,Swift2Parser.Tokens.T__79.rawValue,Swift2Parser.Tokens.T__96.rawValue,Swift2Parser.Tokens.T__97.rawValue,Swift2Parser.Tokens.Identifier.rawValue,Swift2Parser.Tokens.COMMA.rawValue]
		 	              return  Utils.testBitLeftShiftArray(testArray, 64)
		 	          }()
		 	      return testSet
		 	 }()) {
	...
	open func identifier() throws -> IdentifierContext {
		...
		do {
		 	...
		 	case .Identifier:
		 		try enterOuterAlt(_localctx, 1)
		 		setState(2318)
		 		try match(Swift2Parser.Tokens.Identifier.rawValue)
	...
	open func context_sensitive_keyword() throws -> Context_sensitive_keywordContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.T__44.rawValue,Swift2Parser.Tokens.T__45.rawValue,Swift2Parser.Tokens.T__46.rawValue,Swift2Parser.Tokens.T__47.rawValue,Swift2Parser.Tokens.T__51.rawValue,Swift2Parser.Tokens.T__57.rawValue,Swift2Parser.Tokens.T__58.rawValue,Swift2Parser.Tokens.T__59.rawValue,Swift2Parser.Tokens.T__60.rawValue,Swift2Parser.Tokens.T__61.rawValue,Swift2Parser.Tokens.T__62.rawValue,Swift2Parser.Tokens.T__63.rawValue,Swift2Parser.Tokens.T__64.rawValue,Swift2Parser.Tokens.T__65.rawValue,Swift2Parser.Tokens.T__66.rawValue,Swift2Parser.Tokens.T__67.rawValue,Swift2Parser.Tokens.T__68.rawValue,Swift2Parser.Tokens.T__69.rawValue,Swift2Parser.Tokens.T__70.rawValue,Swift2Parser.Tokens.T__71.rawValue,Swift2Parser.Tokens.T__72.rawValue,Swift2Parser.Tokens.T__73.rawValue,Swift2Parser.Tokens.T__74.rawValue,Swift2Parser.Tokens.T__76.rawValue,Swift2Parser.Tokens.T__79.rawValue,Swift2Parser.Tokens.T__96.rawValue,Swift2Parser.Tokens.T__97.rawValue]
		 	    return  Utils.testBitLeftShiftArray(testArray, 45)
		 	}()
		 	      return testSet
		 	 }())) {
	...
	open func operator_character() throws -> Operator_characterContext {
		...
		do {
		 	...
		 	case .Operator_following_character:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(2387)
		 		try match(Swift2Parser.Tokens.Operator_following_character.rawValue)
		...
		do {
		 	...
		 	case .TILDE:
		 		...
		 		if (!(//closure
		 		 { () -> Bool in
		 		      let testSet: Bool = {  () -> Bool in
		 		   let testArray: [Int] = [_la, Swift2Parser.Tokens.LT.rawValue,Swift2Parser.Tokens.GT.rawValue,Swift2Parser.Tokens.BANG.rawValue,Swift2Parser.Tokens.QUESTION.rawValue,Swift2Parser.Tokens.AND.rawValue,Swift2Parser.Tokens.SUB.rawValue,Swift2Parser.Tokens.EQUAL.rawValue,Swift2Parser.Tokens.OR.rawValue,Swift2Parser.Tokens.DIV.rawValue,Swift2Parser.Tokens.ADD.rawValue,Swift2Parser.Tokens.MUL.rawValue,Swift2Parser.Tokens.MOD.rawValue,Swift2Parser.Tokens.CARET.rawValue,Swift2Parser.Tokens.TILDE.rawValue]
		 	...
		 	case .Operator_head_other:
		 		try enterOuterAlt(_localctx, 2)
		 		setState(2391)
		 		try match(Swift2Parser.Tokens.Operator_head_other.rawValue)
	...
	open func numeric_literal() throws -> Numeric_literalContext {
		...
		do {
		 	...
		 	case 2:
		 		...
		 		setState(2414)
		 		try match(Swift2Parser.Tokens.Floating_point_literal.rawValue)
	...
	open func boolean_literal() throws -> Boolean_literalContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.T__98.rawValue || _la == Swift2Parser.Tokens.T__99.rawValue
		 	      return testSet
		 	 }())) {
		 	try _errHandler.recoverInline(self)
		 	}
	...
	open func nil_literal() throws -> Nil_literalContext {
		...
		do {
		 	try enterOuterAlt(_localctx, 1)
		 	setState(2419)
		 	try match(Swift2Parser.Tokens.T__100.rawValue)
	...
	open func integer_literal() throws -> Integer_literalContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = {  () -> Bool in
		 	   let testArray: [Int] = [_la, Swift2Parser.Tokens.Binary_literal.rawValue,Swift2Parser.Tokens.Octal_literal.rawValue,Swift2Parser.Tokens.Decimal_literal.rawValue,Swift2Parser.Tokens.Pure_decimal_digits.rawValue,Swift2Parser.Tokens.Hexadecimal_literal.rawValue]
	...
	open func string_literal() throws -> String_literalContext {
		...
		do {
		 	...
		 	if (!(//closure
		 	 { () -> Bool in
		 	      let testSet: Bool = _la == Swift2Parser.Tokens.Static_string_literal.rawValue || _la == Swift2Parser.Tokens.Interpolated_string_literal.rawValue
		 	      return testSet
		 	 }())) {
		 	try _errHandler.recoverInline(self)
		 	}
