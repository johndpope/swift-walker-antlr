...
open class Swift2Lexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__99=100, T__100=101, Platform=102, Identifier=103, DOT=104, 
            LCURLY=105, LPAREN=106, LBRACK=107, RCURLY=108, RPAREN=109, 
            RBRACK=110, COMMA=111, COLON=112, SEMI=113, LT=114, GT=115, 
            UNDERSCORE=116, BANG=117, QUESTION=118, AT=119, AND=120, SUB=121, 
            EQUAL=122, OR=123, DIV=124, ADD=125, MUL=126, MOD=127, CARET=128, 
            TILDE=129, Operator_head_other=130, Operator_following_character=131, 
            ...
            Floating_point_literal=138, Static_string_literal=139, Interpolated_string_literal=140, 
	...
	override open
	func getRuleNames() -> [String] { return Swift2Lexer.ruleNames }

	override open
	func getSerializedATN() -> String { return Swift2Lexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return Swift2Lexer.channelNames }

	override open
	func getModeNames() -> [String] { return Swift2Lexer.modeNames }

	override open
	func getATN() -> ATN { return Swift2Lexer._ATN }


	public
	static let _serializedATN: String = Swift2LexerATN().jsonString
